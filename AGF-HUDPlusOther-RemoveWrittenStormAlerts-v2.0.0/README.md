...
7d2d Version 2  
**Version:** 2.0.0  
[Download](https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/_zip/AGF-HUDPlusOther-RemoveWrittenStormAlerts.zip)
...
- "AGF HUD Plus - Removes Written Storm Alerts" is SAFE to install on an existing game.
- "AGF HUD Plus - Removes Written Storm Alerts" is SAFE to remove from an existing game.
- Unique Details: None
