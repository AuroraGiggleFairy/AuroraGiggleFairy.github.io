...
- "AGF-HUDPlus-RemoveEnteringPopUp" is MISSINGDATA to install on an existing game.
- "AGF-HUDPlus-RemoveEnteringPopUp" is MISSINGDATA to remove from an existing game.
- Unique Details: 
