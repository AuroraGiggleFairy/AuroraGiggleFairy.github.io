...
- "AGF-VP-StayLongerZombieLoot" is MISSINGDATA to install on an existing game.
- "AGF-VP-StayLongerZombieLoot" is MISSINGDATA to remove from an existing game.
- Unique Details: 
