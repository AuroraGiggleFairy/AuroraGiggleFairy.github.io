...
- "AGF-VP-BuyTraderVendingMachines" is MISSINGDATA to install on an existing game.
- "AGF-VP-BuyTraderVendingMachines" is MISSINGDATA to remove from an existing game.
- Unique Details: 
