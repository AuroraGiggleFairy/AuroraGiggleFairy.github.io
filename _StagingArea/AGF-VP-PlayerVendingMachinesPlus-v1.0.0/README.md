...
- "AGF-VP-PlayerVendingMachinesPlus" is MISSINGDATA to install on an existing game.
- "AGF-VP-PlayerVendingMachinesPlus" is MISSINGDATA to remove from an existing game.
- Unique Details: 
