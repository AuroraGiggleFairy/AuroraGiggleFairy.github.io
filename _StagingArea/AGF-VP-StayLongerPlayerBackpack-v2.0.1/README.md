...
- "AGF-VP-StayLongerPlayerBackpack" is MISSINGDATA to install on an existing game.
- "AGF-VP-StayLongerPlayerBackpack" is MISSINGDATA to remove from an existing game.
- Unique Details: 
