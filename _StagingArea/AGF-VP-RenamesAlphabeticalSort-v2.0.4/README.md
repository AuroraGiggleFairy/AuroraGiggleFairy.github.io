...
- "AGF-VP-RenamesAlphabeticalSort" is MISSINGDATA to install on an existing game.
- "AGF-VP-RenamesAlphabeticalSort" is MISSINGDATA to remove from an existing game.
- Unique Details: 
