# AGF-VP-XPDeathPenaltyReduction
7d2d Version 2  
**Version:** 2.0.0  
...
- "AGF-VP-XPDeathPenaltyReduction" is MISSINGDATA to install on an existing game.
- "AGF-VP-XPDeathPenaltyReduction" is MISSINGDATA to remove from an existing game.
- Unique Details: 
