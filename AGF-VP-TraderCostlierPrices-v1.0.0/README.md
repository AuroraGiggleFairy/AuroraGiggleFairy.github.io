VanillaPlus - TraderCostlierPrices
...
3.  INSTALLATION and REMOVAL NOTES
	*First, if you run into any conflicts, you may contact AuroraGiggleFairy via discord: https://discord.gg/Vm5eyW6N4r
	...
	-TraderCostlierPrices is SAFE to install on new game or existing game.
	-TraderCostlierPrices is SAFE to remove from an existing game.
