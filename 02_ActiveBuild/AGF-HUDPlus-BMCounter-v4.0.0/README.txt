...
------------------------------------------------------------------------
  ...
  - Tracks the next Blood Moon day with any frequency and range
    settings.
  - To stop using it, delete this mod folder. Safe to remove.
...
v4.0.0
    ...
    - Complete code overhaul to handle sandbox options better.
    - Now live tracks days till next blood moon regardless of settings.
    - No longer requires localization for each frequency.
