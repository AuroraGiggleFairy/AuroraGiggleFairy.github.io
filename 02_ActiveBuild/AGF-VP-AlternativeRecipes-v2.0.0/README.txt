...
------------------------------------------------------------------------
  ...
  - Vanilla recipes stay in place.
  - Cobblestone blocks can use clay and small stone directly instead of
    cobblestone.
  - First Aid Bandage and Kit can use cloth directly instead of
    bandages.
