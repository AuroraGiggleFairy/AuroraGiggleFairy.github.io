...
------------------------------------------------------------------------
  ...
  - You can now pick up lanterns, flashlights, burning barrels, and
    jack-o-lanterns.
  - Picking up any lantern or flashlight gives one block with all
    lantern and flashlight variants as shape options.
  - Lanterns are removed from loot and trader lists since you can pick
    them up.
...
v1.2.0
    ...
    - Updated the lantern varient block localization to include
    - "flashlights" in all languages.
