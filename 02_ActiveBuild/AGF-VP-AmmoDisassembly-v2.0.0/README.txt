...
------------------------------------------------------------------------
  ...
  - Scrap bullets, arrows, rockets, thrown explosives, and more into
    ingredient bundles (vanilla craft amounts).
  - Combine bundles into x100 or x1000 packs for faster batch opening.
  - Optional: pairs well with the client-side OpensAllButton mod.
