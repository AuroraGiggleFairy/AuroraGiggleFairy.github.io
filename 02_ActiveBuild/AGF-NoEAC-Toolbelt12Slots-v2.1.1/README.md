...
7d2d Version 3
**Version:** 2.1.1  
[Download](https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/04_DownloadZips/AGF-NoEAC-Toolbelt12Slots.zip)
...
- "AGF-NoEAC-Toolbelt12Slots" is SAFE to install on an existing game.
- "AGF-NoEAC-Toolbelt12Slots" is DANGEROUS to remove from an existing game.
- Unique Details: None
...
- Adds in-game key rebinding for the two extra slots (default keys: - and =).
...
- Works standalone.
- Expands the toolbelt from 10 slots to 12.
- Default hotkeys are 1 through 0, then - and =.
- The two extra slot keys are reconfigurable in the in-game Controls menu.
- Rebound keys persist after closing and reopening the game.
- In Edit Mode (two-row toolbelt), holding Shift correctly selects second-row slots.
- Changes apply to the installing player's local toolbelt and input behavior only.
...
<!-- CHANGELOG START -->
v2.1.1
- Just a dumb error that needed to be fixed. LOL!

v2.1.0
- Added menu customization hotkey for keyboard and controller for slots 11 and 12.
- Restructed and cleaned the .dll code to work smoothly with vanilla function.
...
v1.0.2
- Fixed a "god mode" / vehicle exiting bug.
