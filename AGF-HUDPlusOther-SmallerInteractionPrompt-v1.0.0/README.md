...
- "AGF HUD Plus - SmallerInteractionPrompt" is SAFE to install on an existing game.
- "AGF HUD Plus - SmallerInteractionPrompt" is SAFE to remove from an existing game.
- Unique Details: None
