...
- "AGF Configurable console background opacity" is SAFE to install on an existing game.
- "AGF Configurable console background opacity" is UNKNOWN to remove from an existing game.
- Unique Details: None
