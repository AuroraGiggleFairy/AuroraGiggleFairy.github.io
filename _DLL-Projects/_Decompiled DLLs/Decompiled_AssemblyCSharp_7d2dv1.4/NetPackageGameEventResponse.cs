...
public class NetPackageGameEventResponse : NetPackage
{
	...
	public NetPackageGameEventResponse Setup(string _event, int _targetEntityID, string _extraData, string _tag, ResponseTypes _responseType, int _entitySpawnedID = -1, int _index = -1, bool _isDespawn = false)
	{
		eventName = _event;
	...
	public override void ProcessPackage(World _world, GameManager _callbacks)
	{
		if (_world != null)
		{
			...
			case ResponseTypes.ClientSequenceAction:
				GameEventManager.Current.HandleGameEventSequenceItemForClient(eventName, index);
				break;
