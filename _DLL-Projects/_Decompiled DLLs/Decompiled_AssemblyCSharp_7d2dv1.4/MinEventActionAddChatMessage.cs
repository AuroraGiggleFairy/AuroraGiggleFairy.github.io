...
public class MinEventActionAddChatMessage : MinEventActionTargetedBase
{
	...
	public override void Execute(MinEventParams _params)
	{
		for (int i = 0; i < targets.Count; i++)
		{
			...
			{
				XUiC_ChatOutput.AddMessage(LocalPlayerUI.GetUIForPlayer(entityPlayer).xui, EnumGameMessages.PlainTextLocal, EChatType.Global, message, -1, EMessageSender.Server);
			}
		}
	}
