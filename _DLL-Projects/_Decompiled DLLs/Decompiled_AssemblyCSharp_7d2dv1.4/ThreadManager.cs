...
public static class ThreadManager
{
	public class ThreadInfo
	{
		...
		{
			RequestTermination();
			if (!evStopped.WaitOne(30000))
			{
				Log.Error("Thread " + name + " did not finish within " + 30 + "s. Request trace: " + StackTraceUtility.ExtractStackTrace());
				thread?.Abort();
			}
		}
	}
	...
	[PublicizedFrom(EAccessModifier.Private)]
	public static ThreadInfo startThread(string _name, ThreadFunctionDelegate _threadDelegate, ThreadFunctionDelegate _threadInit, ThreadFunctionLoopDelegate _threadLoop, ThreadFunctionEndDelegate _threadEnd, System.Threading.ThreadPriority _threadPriority, object _parameter, ExitCallbackThread _exitCallback, bool _useRealThread = false, bool _isSilent = false)
	{
	...
	public static ThreadInfo StartThread(ThreadFunctionDelegate _threadStart, System.Threading.ThreadPriority _threadPriority, object _parameter = null, ExitCallbackThread _exitCallback = null, bool _useRealThread = false, bool _isSilent = false)
	{
		return StartThread(_threadStart.Method.Name, _threadStart, _threadPriority, _parameter, _exitCallback, _useRealThread, _isSilent);
	}

	public static ThreadInfo StartThread(string _name, ThreadFunctionDelegate _threadDelegate, System.Threading.ThreadPriority _threadPriority, object _parameter = null, ExitCallbackThread _exitCallback = null, bool _useRealThread = false, bool _isSilent = false)
	{
		return startThread(_name, _threadDelegate, null, null, null, _threadPriority, _parameter, _exitCallback, _useRealThread, _isSilent);
	}

	public static ThreadInfo StartThread(string _name, ThreadFunctionDelegate _threadInit, ThreadFunctionLoopDelegate _threadLoop, ThreadFunctionEndDelegate _threadEnd, System.Threading.ThreadPriority _threadPriority = System.Threading.ThreadPriority.Normal, object _parameter = null, ExitCallbackThread _exitCallback = null, bool _useRealThread = false, bool _isSilent = false)
	{
		return startThread(_name, null, _threadInit, _threadLoop, _threadEnd, _threadPriority, _parameter, _exitCallback, _useRealThread, _isSilent);
	}
