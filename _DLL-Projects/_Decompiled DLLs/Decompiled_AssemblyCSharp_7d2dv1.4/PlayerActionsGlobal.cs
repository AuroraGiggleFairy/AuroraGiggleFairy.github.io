...
public class PlayerActionsGlobal : PlayerActionsBase
{
	...
	public override void CreateActions()
	{
		...
		SwitchView = CreatePlayerAction("TVP");
		SwitchView.UserData = new PlayerActionData.ActionUserData("inpActSwitchViewName", null, PlayerActionData.GroupGlobalFunctions, PlayerActionData.EAppliesToInputType.KbdMouseOnly, _allowRebind: false);
	...
	public override void CreateDefaultKeyboardBindings()
	{
		if (!Submission.Enabled)
		{
			...
			SwitchView.AddDefaultBinding(Key.F5);
