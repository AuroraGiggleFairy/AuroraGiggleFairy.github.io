...
public class BaseItemActionEntry
{
	...
	public BaseItemActionEntry(string actionName, string spriteName, XUiController itemController, GamepadShortCut shortcut = GamepadShortCut.None, string soundName = "crafting/craft_click_craft", string disabledSoundName = "ui/ui_denied")
	{
		ItemController = itemController;
