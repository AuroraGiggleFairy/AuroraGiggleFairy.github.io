...
public abstract class ChunkProviderGenerateWorld : ChunkProviderAbstract
{
	...
	public override IEnumerator Init(World _world)
	{
		...
		if (!bClientMode)
		{
			threadInfo = ThreadManager.StartThread("GenerateChunks", null, GenerateChunksThread, null, System.Threading.ThreadPriority.Lowest, null, null, _useRealThread: true);
		}
		yield return null;
	}
