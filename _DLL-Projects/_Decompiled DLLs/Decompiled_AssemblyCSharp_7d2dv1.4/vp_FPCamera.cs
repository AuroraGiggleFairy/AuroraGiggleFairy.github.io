...
public class vp_FPCamera : vp_Component
{
	...
	public override void Awake()
	{
		...
		GetComponent<Camera>().fieldOfView = Constants.cDefaultCameraFieldOfView;
	...
	public void Update3rdPerson()
	{
		...
		if (Player.IsFirstPerson.Get() || !FPController.enabled)
		{
		...
		if (!Player.Driving.Active && base.Transform.localPosition.z > -0.2f)
		{
