...
public class AIDirectorChunkEventComponent : AIDirectorHordeComponent
{
	...
	[PublicizedFrom(EAccessModifier.Private)]
	public static int[] neighbors = new int[8] { -1, 0, 1, 0, 0, -1, 0, 1 };
	...
	public void CheckToSpawn(AIDirectorChunkData _chunkData)
	{
		...
		{
			StartCooldownOnNeighbors(aIDirectorChunkEvent.Position);
			if (Director.random.RandomFloat < 0.2f && !GameUtils.IsPlaytesting())
			{
