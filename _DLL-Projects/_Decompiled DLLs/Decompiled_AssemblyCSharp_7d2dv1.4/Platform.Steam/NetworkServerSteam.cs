...
public class NetworkServerSteam : IPlatformNetworkServer, INetworkServer
{
	...
	public NetworkConnectionError StartServer(int _basePort, string _password)
	{
		...
		handlerThread = ThreadManager.StartThread("SteamNetworkingServer", threadHandlerMethod, System.Threading.ThreadPriority.Normal, null, null, _useRealThread: true);
