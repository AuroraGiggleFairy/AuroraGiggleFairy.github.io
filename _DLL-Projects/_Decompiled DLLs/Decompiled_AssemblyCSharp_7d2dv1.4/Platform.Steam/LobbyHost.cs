...
public class LobbyHost : ILobbyHost
{
	...
	public void Lobby_JoinRequested(GameLobbyJoinRequested_t _val)
	{
		...
		if (PlatformManager.MultiPlatform.JoinSessionGameInviteListener is JoinSessionGameInviteListener joinSessionGameInviteListener)
		{
			joinSessionGameInviteListener.SetLobby(_val);
		}
		else if (!XUiC_MainMenu.openedOnce)
		{
		...
		{
			JoinLobby(_val.m_steamIDLobby.m_SteamID);
		}
	}
