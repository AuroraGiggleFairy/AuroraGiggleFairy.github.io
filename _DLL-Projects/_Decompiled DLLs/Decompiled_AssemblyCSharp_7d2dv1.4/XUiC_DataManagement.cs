...
public class XUiC_DataManagement : XUiController
{
	...
	public override void Init()
	{
		...
		btnDeleteWorld.Button.Controller.OnHover += BtnDeleteWorld_OnHover;
		btnDeleteSave.OnPressed += BtnDeleteSave_OnPressed;
		btnDeleteSave.Button.Controller.OnHover += BtnDeleteSave_OnHover;
		btnArchiveSave.OnPressed += BtnArchiveSave_OnPressed;
		btnArchiveSave.Button.Controller.OnHover += BtnArchiveSave_OnHover;
		btnDeletePlayer.OnPressed += BtnDeletePlayer_OnPressed;
		btnDeletePlayer.Button.Controller.OnHover += BtnDeletePlayer_OnHover;
		btnDeleteBlockedPlayers.OnPressed += BtnDeleteBlockedPlayers_OnPressed;
		btnDeleteBlockedPlayers.Button.Controller.OnHover += BtnDeleteBlockedPlayers_OnHover;
