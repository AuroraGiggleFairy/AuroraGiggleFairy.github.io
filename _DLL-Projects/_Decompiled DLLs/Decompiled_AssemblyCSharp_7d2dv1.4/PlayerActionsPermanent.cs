...
public class PlayerActionsPermanent : PlayerActionsBase
{
	...
	public override void CreateActions()
	{
		...
		Inventory.UserData = new PlayerActionData.ActionUserData("inpActInventoryName", null, PlayerActionData.GroupDialogs, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		Character = CreatePlayerAction("Character");
		Character.UserData = new PlayerActionData.ActionUserData("inpActCharacterName", null, PlayerActionData.GroupDialogs, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		Map = CreatePlayerAction("Map");
		Map.UserData = new PlayerActionData.ActionUserData("inpActMapName", null, PlayerActionData.GroupDialogs, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		Skills = CreatePlayerAction("Skills");
		Skills.UserData = new PlayerActionData.ActionUserData("inpActSkillsName", null, PlayerActionData.GroupDialogs, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		Quests = CreatePlayerAction("Quests");
		Quests.UserData = new PlayerActionData.ActionUserData("inpActQuestsName", null, PlayerActionData.GroupDialogs, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		Challenges = CreatePlayerAction("Challenges");
		Challenges.UserData = new PlayerActionData.ActionUserData("inpActChallengesName", null, PlayerActionData.GroupDialogs, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		Scoreboard = CreatePlayerAction("Scoreboard");
		Scoreboard.UserData = new PlayerActionData.ActionUserData("inpActScoreboardName", null, PlayerActionData.GroupDialogs, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		Creative = CreatePlayerAction("Creative");
		Creative.UserData = new PlayerActionData.ActionUserData("inpActCreativeName", null, PlayerActionData.GroupDialogs, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		...
		PageTipsForward.UserData = new PlayerActionData.ActionUserData("inpActPageTipsForward", null, PlayerActionData.GroupAdmin, PlayerActionData.EAppliesToInputType.Both, _allowRebind: false, _allowMultipleRebindings: false, _doNotDisplay: true);
		PageTipsBack = CreatePlayerAction("PageTipsBack");
		PageTipsBack.UserData = new PlayerActionData.ActionUserData("inpActPageTipsBack", null, PlayerActionData.GroupAdmin, PlayerActionData.EAppliesToInputType.Both, _allowRebind: false, _allowMultipleRebindings: false, _doNotDisplay: true);
	}
