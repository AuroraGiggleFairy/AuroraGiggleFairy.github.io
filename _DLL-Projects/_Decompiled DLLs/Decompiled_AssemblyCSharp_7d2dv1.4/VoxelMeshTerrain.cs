...
public class VoxelMeshTerrain : VoxelMesh
{
	...
	public override void GetColorForTextureId(int _subMeshIdx, int _fullTexId, bool _bTopSoil, out Color _color, out Vector2 _uv, out Vector2 _uv2, out Vector2 _uv3, out Vector2 _uv4)
	{
		...
		{
			_uv = (_uv2 = (_uv3 = (_uv4 = cUvEmpty)));
			_color = submeshes[_subMeshIdx].GetColorForTextureId(_fullTexId);
		}
		else
		{
			int texId = DecodeMainTexId(_fullTexId);
			GetColorForTextureId(texId, _bTopSoil, out _color, out _uv, out _uv2, out _uv3, out _uv4);
		}
	}
	...
	public void GetColorForTextureId(int _texId, bool _bTopSoil, out Color _color, out Vector2 _uv, out Vector2 _uv2, out Vector2 _uv3, out Vector2 _uv4)
	{
		...
		default:
			...
			break;
		case 2:
			_color = cColUnderTerrain1;
			break;
		case 11:
			_color = cColUnderTerrain2;
			break;
		case 34:
			_color = cColUnderTerrain3;
			break;
		case 10:
			_uv = cUvUnderTerrain1_0;
			break;
		case 33:
			_uv = cUvUnderTerrain0_1;
			break;
		case 300:
			_uv2 = cUvUnderTerrain1_0;
			break;
		case 1:
			_uv2 = cUvUnderTerrain0_1;
			break;
		case 184:
			_uv3 = cUvUnderTerrain1_0;
			break;
		case 440:
			_uv3 = cUvUnderTerrain0_1;
			break;
		case 316:
			_uv4 = cUvUnderTerrain1_0;
			break;
		case 438:
			_uv4 = cUvUnderTerrain0_1;
			break;
		}
	}
