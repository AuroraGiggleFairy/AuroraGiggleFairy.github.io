...
public class PlayerActionsLocal : PlayerActionsBase
{
	...
	public override void CreateActions()
	{
		...
		ScrollUp.UserData = new PlayerActionData.ActionUserData("inpActScopeZoomInName", null, PlayerActionData.GroupPlayerControl, PlayerActionData.EAppliesToInputType.Both, _allowRebind: true, _allowMultipleRebindings: true);
		ScrollDown = CreatePlayerAction("ScrollDown");
		ScrollDown.UserData = new PlayerActionData.ActionUserData("inpActScopeZoomOutName", null, PlayerActionData.GroupPlayerControl, PlayerActionData.EAppliesToInputType.Both, _allowRebind: true, _allowMultipleRebindings: true);
		...
		InventorySlot4.UserData = new PlayerActionData.ActionUserData("inpActInventorySlot4Name", null, PlayerActionData.GroupToolbelt, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		InventorySlot5 = CreatePlayerAction("Inventory5");
		InventorySlot5.UserData = new PlayerActionData.ActionUserData("inpActInventorySlot5Name", null, PlayerActionData.GroupToolbelt, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		InventorySlot6 = CreatePlayerAction("Inventory6");
		InventorySlot6.UserData = new PlayerActionData.ActionUserData("inpActInventorySlot6Name", null, PlayerActionData.GroupToolbelt, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		InventorySlot7 = CreatePlayerAction("Inventory7");
		InventorySlot7.UserData = new PlayerActionData.ActionUserData("inpActInventorySlot7Name", null, PlayerActionData.GroupToolbelt, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		InventorySlot8 = CreatePlayerAction("Inventory8");
		InventorySlot8.UserData = new PlayerActionData.ActionUserData("inpActInventorySlot8Name", null, PlayerActionData.GroupToolbelt, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		InventorySlot9 = CreatePlayerAction("Inventory9");
		InventorySlot9.UserData = new PlayerActionData.ActionUserData("inpActInventorySlot9Name", null, PlayerActionData.GroupToolbelt, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		InventorySlot10 = CreatePlayerAction("Inventory10");
		InventorySlot10.UserData = new PlayerActionData.ActionUserData("inpActInventorySlot10Name", null, PlayerActionData.GroupToolbelt, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		...
		CameraChange.UserData = new PlayerActionData.ActionUserData("inpActCameraChangeName", null, PlayerActionData.GroupEditCamera, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
	...
	public override void CreateDefaultJoystickBindings()
	{
		...
		ToggleFlashlight.AddDefaultBinding(InputControlType.DPadUp);
		Drop.AddDefaultBinding(InputControlType.DPadDown);
	...
	public override void CreateDefaultKeyboardBindings()
	{
		...
		CameraChange.AddDefaultBinding(Key.LeftAlt);
