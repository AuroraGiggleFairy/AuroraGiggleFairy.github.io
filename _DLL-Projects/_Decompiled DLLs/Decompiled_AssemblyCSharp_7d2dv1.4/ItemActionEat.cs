...
public class ItemActionEat : ItemAction
{
	...
	public override void ExecuteAction(ItemActionData _actionData, bool _bReleased)
	{
		...
		if (UseAnimation)
		{
			...
			{
				holdingEntity.emodel.avatarController.UpdateFloat("MeleeAttackSpeed", 1f);
			}
	...
	{
		MyInventoryData myInventoryData = (MyInventoryData)_actionData;
		if (myInventoryData.bEatingStarted && Time.time - myInventoryData.lastUseTime < 2f * AnimationDelayData.AnimationDelay[myInventoryData.invData.item.HoldType.Value].RayCast)
		{
			return true;
		}
