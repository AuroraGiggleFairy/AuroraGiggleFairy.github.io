...
public class BlockedPlayerList : IRemotePlayerStorageObject
{
	...
	public static BlockedPlayerList Instance => instance ?? (instance = ((PlatformManager.MultiPlatform.RemotePlayerFileStorage != null) ? new BlockedPlayerList() : null));

	public BlockedPlayerList()
	{
		PlayerInteractions.OnNewPlayerInteraction += OnPlayerInteraction;
	}
