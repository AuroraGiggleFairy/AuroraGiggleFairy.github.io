...
public class TurretTracker
{
	...
	public void Save()
	{
		if (saveThread == null || !ThreadManager.ActiveThreads.ContainsKey("turretDataSave"))
		{
			...
			saveThread = ThreadManager.StartThread("turretDataSave", null, SaveThread, null, System.Threading.ThreadPriority.Normal, pooledExpandableMemoryStream, null, _useRealThread: false, _isSilent: true);
		}
	}
