...
public class XUiC_BugReportWindow : XUiController
{
	...
	public void CheckCanSubmit()
	{
		...
		{
			btnSubmit.Enabled = canSubmit && txtDescription.Text.Length > 0 && (!attachSave || (attachSave && selectedSaveInfo != null));
		}
	}
	...
	public IEnumerator SubmitRoutine()
	{
		...
		BacktraceUtils.SendBugReport(txtDescription.Text, screenshotPath, selectedSaveInfo, BugReportCallBack);
	}
