...
public class LocalPlayerUI : MonoBehaviour
{
	...
	public void Update()
	{
		...
		if (playerActionsLocal == null || playerActionsLocal.GUIActions.Inspect.IsPressed || xui.playerUI.CursorController.Locked || (playerInput.GUIActions.BackButton.WasPressed && TryItemStackGridNavigation()))
		{
			return;
		}
