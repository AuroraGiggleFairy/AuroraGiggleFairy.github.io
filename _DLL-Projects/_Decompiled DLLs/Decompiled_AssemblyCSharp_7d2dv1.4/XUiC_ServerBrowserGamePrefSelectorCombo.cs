...
public class XUiC_ServerBrowserGamePrefSelectorCombo : XUiController, IServerBrowserFilterControl
{
	...
	public override void Init()
	{
		...
		txtValueString.OnScroll += controlCombo.ScrollEvent;
