...
public class XUiC_SkillEntry : XUiController
{
	...
	public override void Update(float _dt)
	{
		if (currentSkill != null)
		{
			...
			{
				groupIcon.UiTransform.localPosition = ogIconPos + new Vector3(32f, -4f, 0f);
				groupIcon.Size = ogIconSize;
				base.ViewComponent.IsNavigatable = false;
			}
			else if (currentSkill.ProgressionClass.IsPerk)
			{
				groupIcon.UiTransform.localPosition = ogIconPos + new Vector3(64f, -4f, 0f);
				groupIcon.Size = ogIconSize;
		...
		if (currentSkill != null)
		{
			...
			{
				groupName.UiTransform.localPosition = ogNamePos + new Vector3(32f, 0f, 0f);
				base.ViewComponent.IsNavigatable = false;
			}
			else if (currentSkill.ProgressionClass.IsPerk)
			{
				groupName.UiTransform.localPosition = ogNamePos + new Vector3(64f, 0f, 0f);
				base.ViewComponent.IsNavigatable = true;
			}
			else
			{
