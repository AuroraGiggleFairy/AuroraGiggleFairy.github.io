...
public class ActionAddChatMessage : ActionBaseClientAction
{
	...
	public override void OnClientPerform(Entity target)
	{
		...
		{
			XUiC_ChatOutput.AddMessage(LocalPlayerUI.GetUIForPlayer(entityPlayer).xui, EnumGameMessages.PlainTextLocal, EChatType.Global, text, -1, EMessageSender.Server);
		}
	}
