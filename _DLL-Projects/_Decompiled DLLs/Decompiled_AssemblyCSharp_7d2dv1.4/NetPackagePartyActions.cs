	...
	public override void ProcessPackage(World _world, GameManager _callbacks)
	{
		...
		case PartyActions.SendInvite:
			if (!entityPlayer.IsInParty())
			{
				...
				{
					GameManager.ShowTooltip(player, string.Format(Localization.Get("ttPartyInviteReceived"), entityPlayer2.PlayerDisplayName), (string)null, "party_invite_receive", (ToolTipEvent)null, false);
				}
			}
			break;
