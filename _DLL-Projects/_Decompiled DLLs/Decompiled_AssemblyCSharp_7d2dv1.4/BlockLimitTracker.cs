...
public class BlockLimitTracker
{
	...
	public void Save()
	{
		if (SingletonMonoBehaviour<ConnectionManager>.Instance.IsServer && (saveThread == null || !ThreadManager.ActiveThreads.ContainsKey("blockLimitSaveData")))
		{
			...
			saveThread = ThreadManager.StartThread("blockLimitSaveData", null, SaveThread, null, ThreadPriority.Normal, pooledExpandableMemoryStream, null, _useRealThread: false, _isSilent: true);
		}
	}
