...
public class XUiC_PrefabGroupList : XUiC_List<XUiC_PrefabGroupList.PrefabGroupEntry>
{
	...
	public class PrefabGroupEntry : XUiListEntry
	{
		...
		{
			if (!(_otherEntry is PrefabGroupEntry))
			{
				return 1;
			}
			return string.Compare(name, ((PrefabGroupEntry)_otherEntry).name, StringComparison.OrdinalIgnoreCase);
		}
	...
	public override void OnOpen()
	{
		...
		bool flag = false;
		groupsResult.Clear();
		GameManager.Instance.prefabEditModeManager.GetAllGroups(groupsResult);
