...
public class XUiC_PlayersListEntry : XUiController
{
	...
	public void oniconAllyIconPress(XUiController _sender, int _mouseButton)
	{
		...
		case EnumAllyInviteStatus.Sent:
		{
			...
			menuItemEntry.IconName = "ui_game_symbol_x";
			menuItemEntry.Text = Localization.Get("lblRemove");
			menuItemEntry.IsEnabled = true;
			menuItemEntry.Tag = new object[0];
			MenuItemEntry menuItemEntry2 = menuItemEntry;
			menuItemEntry2.ItemClicked += RemoveAlly_ItemClicked;
			list.Add(menuItemEntry2);
			base.xui.currentPopupMenu.SetupItems(list, new Vector2i(0, -26), buttonAllyIcon);
			break;
		}
		}
	}
	...
	public void oniconPartyIconPress(XUiController _sender, int _mouseButton)
	{
		...
		case EnumPartyStatus.LocalPlayer_InParty:
		{
			...
			MenuItemEntry menuItemEntry = new MenuItemEntry();
			menuItemEntry.IconName = "ui_game_symbol_x";
			menuItemEntry.Text = Localization.Get("lblLeave");
			menuItemEntry.IsEnabled = true;
			menuItemEntry.Tag = new object[0];
			MenuItemEntry menuItemEntry3 = menuItemEntry;
			menuItemEntry3.ItemClicked += LeaveParty_ItemClicked;
			list2.Add(menuItemEntry3);
			base.xui.currentPopupMenu.SetupItems(list2, new Vector2i(0, -26), buttonPartyIcon);
			break;
		}
		case EnumPartyStatus.LocalPlayer_InPartyAsLead:
		{
			...
			menuItemEntry.Tag = new object[0];
			MenuItemEntry menuItemEntry2 = menuItemEntry;
			menuItemEntry2.ItemClicked += LeaveParty_ItemClicked;
			list.Add(menuItemEntry2);
			base.xui.currentPopupMenu.SetupItems(list, new Vector2i(0, -26), buttonPartyIcon);
			break;
		}
		case EnumPartyStatus.OtherPlayer_InPartyAsLead:
		{
			...
			MenuItemEntry menuItemEntry = new MenuItemEntry();
			menuItemEntry.IconName = "ui_game_symbol_x";
			menuItemEntry.Text = Localization.Get("lblKick");
			menuItemEntry.IsEnabled = true;
			menuItemEntry.Tag = new object[0];
			MenuItemEntry menuItemEntry4 = menuItemEntry;
			menuItemEntry4.ItemClicked += KickParty_ItemClicked;
			list3.Add(menuItemEntry4);
			menuItemEntry = new MenuItemEntry();
			menuItemEntry.IconName = "server_favorite";
			menuItemEntry.Text = Localization.Get("lblMakeLeader");
			menuItemEntry.IsEnabled = true;
			menuItemEntry.Tag = new object[0];
			menuItemEntry4 = menuItemEntry;
			menuItemEntry4.ItemClicked += MakeLeader_ItemClicked;
			list3.Add(menuItemEntry4);
			base.xui.currentPopupMenu.SetupItems(list3, new Vector2i(0, -26), buttonPartyIcon);
			break;
		}
