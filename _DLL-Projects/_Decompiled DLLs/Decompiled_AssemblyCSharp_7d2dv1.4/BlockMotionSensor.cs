...
public class BlockMotionSensor : BlockPowered
{
	...
	public override void PlaceBlock(WorldBase _world, BlockPlacement.Result _result, EntityAlive _ea)
	{
		...
		if (_world.GetTileEntity(_result.clrIdx, _result.blockPos) is TileEntityPoweredTrigger tileEntityPoweredTrigger && _ea != null && _ea.entityType == EntityType.Player)
		{
