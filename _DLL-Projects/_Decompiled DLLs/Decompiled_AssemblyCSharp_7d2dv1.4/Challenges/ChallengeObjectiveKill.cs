...
public class ChallengeObjectiveKill : BaseChallengeObjective
{
	...
	public override string DescriptionText
	{
		get
		{
			...
			return string.Format(Localization.Get("challengeObjectiveKillIn"), Localization.Get(entityIDs), biome);
		}
	}
	...
	public void Current_EntityKill(EntityAlive killedBy, EntityAlive killedEntity)
	{
		...
		bool flag = false;
		if (biome != "" && Owner.Owner.Player.biomeStandingOn.m_sBiomeName != biome)
		{
			return;
		}
