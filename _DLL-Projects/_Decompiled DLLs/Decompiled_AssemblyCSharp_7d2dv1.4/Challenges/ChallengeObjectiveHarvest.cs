...
public class ChallengeObjectiveHarvest : ChallengeBaseTrackedItemObjective
{
	...
	{
		if ((held.ItemClass == expectedHeldClass || !requireHeld) && (!bv.isair || !isBlock) && (!isBlock || blockTag.IsEmpty || bv.Block.HasAnyFastTags(blockTag)) && stack.itemValue.type == expectedItem.type)
		{
