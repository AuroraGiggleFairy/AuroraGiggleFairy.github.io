...
public class XUiC_OptionsGeneral : XUiController
{
	...
	public override void Init()
	{
		...
		comboLnlMtuWorkaround = GetChildById("LnlMtuWorkaround").GetChildByType<XUiC_ComboBoxBool>();
		...
		comboLnlMtuWorkaround.OnValueChangedGeneric += anyOtherValueChanged;
	...
	public void BtnDefaults_OnOnPressed(XUiController _sender, int _mouseButton)
	{
		...
		comboLnlMtuWorkaround.Value = (bool)GamePrefs.GetDefault(EnumGamePrefs.OptionsLiteNetLibMtuOverride);
	...
	public void applyChanges()
	{
		...
		GamePrefs.Set(EnumGamePrefs.OptionsLiteNetLibMtuOverride, comboLnlMtuWorkaround.Value);
	...
	public override void OnOpen()
	{
		...
		comboLnlMtuWorkaround.Value = GamePrefs.GetBool(EnumGamePrefs.OptionsLiteNetLibMtuOverride);
