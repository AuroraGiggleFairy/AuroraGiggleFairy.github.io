...
public class MeshGeneratorPrefab : MeshGenerator
{
	...
	public int GetTextureFor(int _x, int _y, int _z, int idx)
	{
		...
		int sideTextureId = block.GetSideTextureId(blockValue, BlockFace.Top);
		int sideTextureId2 = block.GetSideTextureId(blockValue, BlockFace.South);
	...
	public void build(Vector3 _drawPosOffset, Vector3i _start, Vector3i _end, VoxelMesh _mesh)
	{
		...
		for (int num28 = 0; num28 < num3; num28++)
		{
			...
			if (flag2)
			{
				...
				_mesh.GetColorForTextureId(num30, vertexStorage[index].texture, vertexStorage[index].bTopSoil, out vertexStorage[index].color, out vertexStorage[index].uv, out vertexStorage[index].uv2, out vertexStorage[index].uv3, out vertexStorage[index].uv4);
				_mesh.GetColorForTextureId(num30, vertexStorage[index2].texture, vertexStorage[index2].bTopSoil, out vertexStorage[index2].color, out vertexStorage[index2].uv, out vertexStorage[index2].uv2, out vertexStorage[index2].uv3, out vertexStorage[index2].uv4);
				_mesh.GetColorForTextureId(num30, vertexStorage[index3].texture, vertexStorage[index3].bTopSoil, out vertexStorage[index3].color, out vertexStorage[index3].uv, out vertexStorage[index3].uv2, out vertexStorage[index3].uv3, out vertexStorage[index3].uv4);
			}
			else
			{
