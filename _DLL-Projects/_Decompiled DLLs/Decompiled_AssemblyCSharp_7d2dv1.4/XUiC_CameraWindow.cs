...
public class XUiC_CameraWindow : XUiController
{
	...
	public override void OnOpen()
	{
		...
		{
			wasFirstPerson = base.xui.playerUI.localPlayer.entityPlayerLocal.bFirstPersonView;
			firstPass = false;
		}
		if (cameraClick != null)
		{
		...
		if (TileEntity.BlockTransform != null)
		{
			...
			base.xui.playerUI.entityPlayer.SetFirstPersonView(_bFirstPersonView: false, _bLerpPosition: true);
	...
	public override void OnClose()
	{
		...
		{
			firstPass = false;
			if (wasFirstPerson && base.xui != null && base.xui.playerUI != null && base.xui.playerUI.entityPlayer != null && base.xui.playerUI.entityPlayer.emodel != null)
			{
				base.xui.playerUI.entityPlayer.SetFirstPersonView(_bFirstPersonView: true, _bLerpPosition: true);
				Camera playerCamera = base.xui.playerUI.localPlayer.entityPlayerLocal.playerCamera;
				if ((bool)playerCamera)
				{
