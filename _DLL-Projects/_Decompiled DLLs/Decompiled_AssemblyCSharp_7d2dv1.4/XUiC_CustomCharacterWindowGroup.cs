...
public class XUiC_CustomCharacterWindowGroup : XUiController
{
	...
	public void SetupRaces(bool isMale)
	{
		...
		{
			races.Elements.Add(new NameData(race, Localization.Get("xuiRace" + race)));
			num++;
		}
	}
	...
	public void Genders_OnValueChanged(XUiController _sender, NameData _oldValue, NameData _newValue)
	{
		...
		previewWindow.Archetype.Sex = text;
		bool isMale = text == "male";
		if (playerProfile != null)
		{
			playerProfile.IsMale = isMale;
		}
		string internalName = races.Value.InternalName;
		int variant = StringParsers.ParseSInt32(variants.Value.InternalName);
		SetupRaces(isMale);
		SetSelectedRace(internalName, applyToPreview: true);
	...
	{
		string text = _newValue.InternalName.ToLower();
		previewWindow.Archetype.Race = text;
		if (playerProfile != null)
		{
			playerProfile.RaceName = text;
		}
		int variant = StringParsers.ParseSInt32(variants.Value.InternalName);
	...
	public void HairColors_OnValueChanged(XUiController _sender, NameData _oldValue, NameData _newValue)
	{
		...
		previewWindow.Archetype.HairColor = hairColor;
		if (playerProfile != null)
		{
			playerProfile.HairColor = hairColor;
		}
		previewWindow.MakePreview();
		previewWindow.ZoomToHead();
		HasChanges = true;
	...
	{
		string text = _newValue.InternalName.ToLower();
		previewWindow.Archetype.EyeColorName = text;
		if (playerProfile != null)
		{
			playerProfile.EyeColor = text;
		}
		previewWindow.MakePreview();
	...
	public void Mustaches_OnValueChanged(XUiController _sender, NameData _oldValue, NameData _newValue)
	{
		...
		previewWindow.Archetype.MustacheName = mustacheName;
		if (playerProfile != null)
		{
			playerProfile.MustacheName = mustacheName;
		}
		previewWindow.MakePreview();
		previewWindow.ZoomToHead();
		HasChanges = true;
	...
	public void Chops_OnValueChanged(XUiController _sender, NameData _oldValue, NameData _newValue)
	{
		...
		previewWindow.Archetype.ChopsName = chopsName;
		if (playerProfile != null)
		{
			playerProfile.ChopsName = chopsName;
		}
		previewWindow.MakePreview();
		previewWindow.ZoomToHead();
		HasChanges = true;
	...
	public void Beards_OnValueChanged(XUiController _sender, NameData _oldValue, NameData _newValue)
	{
		...
		previewWindow.Archetype.BeardName = beardName;
		if (playerProfile != null)
		{
			playerProfile.BeardName = beardName;
		}
		previewWindow.MakePreview();
		previewWindow.ZoomToHead();
		HasChanges = true;
