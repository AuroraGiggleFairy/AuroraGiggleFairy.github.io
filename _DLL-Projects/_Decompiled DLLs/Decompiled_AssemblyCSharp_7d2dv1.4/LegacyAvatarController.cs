...
public abstract class LegacyAvatarController : AvatarController
{
	...
	public override void Update()
	{
		...
		TryGetFloat(AvatarController.rotationPitchHash, out var _value3);
		float value2 = Mathf.Lerp(_value3, entity.rotation.x, Time.deltaTime * 12f);
		_setFloat(AvatarController.rotationPitchHash, value2, _netsync: false);
		TryGetFloat(AvatarController.yLookHash, out var _value4);
		UpdateFloat(AvatarController.yLookHash, Mathf.Lerp(_value4, (0f - base.Entity.rotation.x) / 90f, Time.deltaTime * 12f), _netsync: false);
	}
