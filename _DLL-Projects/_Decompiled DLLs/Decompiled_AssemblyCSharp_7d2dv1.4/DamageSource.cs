...
{
	public static readonly DamageSource eat = new DamageSource(EnumDamageSource.External, EnumDamageTypes.Slashing, bTransferToRider: true);

	public static readonly DamageSource fallingBlock = new DamageSource(EnumDamageSource.External, EnumDamageTypes.Crushing, bTransferToRider: true);

	public static readonly DamageSource radiation = new DamageSource(EnumDamageSource.External, EnumDamageTypes.Radiation, bTransferToRider: true);

	public static readonly DamageSource fall = new DamageSource(EnumDamageSource.Internal, EnumDamageTypes.Falling, bTransferToRider: true);
	...
	public DamageSource(EnumDamageSource _dsn, EnumDamageTypes _damageType, bool bTransferToRider)
	{
		damageSource = _dsn;
		damageType = _damageType;
		bIsDamageTransfer = bTransferToRider;
		DamageTypeTag = FastTags<TagGroup.Global>.Parse(_damageType.ToStringCached());
	}
