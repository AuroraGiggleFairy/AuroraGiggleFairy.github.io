	...
	public void ContainerList(string _name, int _count, int _stage, float _abundance)
	{
		...
		if (lootContainer != null)
		{
			...
			for (int i = 0; i < _count; i++)
			{
				...
				LootContainer.SpawnLootItemsFromList(gameRandom, lootContainer.itemsToSpawn, 1, _abundance, list, ref slotsLeft, _stage, 0f, lootContainer.lootQualityTemplate, null, FastTags<TagGroup.Global>.none, uniqueItems: false, ignoreLootProb: false, _forceStacking: true);
