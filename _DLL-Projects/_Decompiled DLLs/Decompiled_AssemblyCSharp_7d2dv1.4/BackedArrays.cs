...
public static class BackedArrays
{
	...
	public static IBackedArrayView<T> CreateSingleView<T>(IBackedArray<T> array, BackedArrayHandleMode mode, int viewLength = 0, int startingOffset = 0) where T : unmanaged
	{
