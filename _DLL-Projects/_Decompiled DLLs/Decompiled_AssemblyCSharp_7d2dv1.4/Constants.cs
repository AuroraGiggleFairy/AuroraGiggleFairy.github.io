...
public class Constants
{
	...
	public const int cVersionMajor = 1;

	public const int cVersionMinor = 4;

	public const int cVersionBuild = 8;

	public static readonly VersionInformation cVersionInformation = new VersionInformation(VersionInformation.EGameReleaseType.V, 1, 4, 8);
	...
	public const string cCopyright = "Copyright (c) 2014-2024 The Fun Pimps LLC All Rights Reserved.";
