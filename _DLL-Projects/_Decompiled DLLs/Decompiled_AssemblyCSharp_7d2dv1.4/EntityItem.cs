...
public class EntityItem : Entity
{
	...
	public virtual void createMesh()
	{
		...
		if (itemClass.IsBlock())
		{
			...
			{
				itemTransform = itemClass.CloneModel(meshGameObject, world, blockValue, null, Vector3.zero, base.transform, BlockShape.MeshPurpose.Drop, 0L);
			}
		...
		else
		{
			if (itemTransform == null)
			{
				itemTransform = itemClass.CloneModel(world, itemStack.itemValue, Vector3.zero, base.transform, BlockShape.MeshPurpose.Drop, 0L);
			}
