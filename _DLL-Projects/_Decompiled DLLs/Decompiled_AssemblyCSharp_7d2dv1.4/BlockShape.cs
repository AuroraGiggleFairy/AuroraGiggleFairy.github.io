...
public abstract class BlockShape
{
	...
	public virtual void renderFace(Vector3i _worldPos, BlockValue _blockValue, Vector3 _drawPos, BlockFace _face, Vector3[] _vertices, LightingAround _lightingAround, long _textureFull, VoxelMesh[] _meshes, MeshPurpose _purpose = MeshPurpose.World)
	{
	}
	...
	public virtual void renderFull(Vector3i _worldPos, BlockValue _blockValue, Vector3 _drawPos, Vector3[] _vertices, LightingAround _lightingAround, long _textureFull, VoxelMesh[] _meshes, MeshPurpose _purpose = MeshPurpose.World)
	{
	}
	...
	public virtual void renderDecorations(Vector3i _worldPos, BlockValue _blockValue, Vector3 _drawPos, Vector3[] _vertices, LightingAround _lightingAround, long _textureFull, VoxelMesh[] _meshes, INeighborBlockCache _nBlocks)
	{
		renderFull(_worldPos, _blockValue, _drawPos, _vertices, _lightingAround, _textureFull, _meshes);
	}
