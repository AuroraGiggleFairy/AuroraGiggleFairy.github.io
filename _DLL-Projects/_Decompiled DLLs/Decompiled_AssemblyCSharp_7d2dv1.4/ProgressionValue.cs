...
public class ProgressionValue
{
	...
	public float GetCalculatedLevel(EntityAlive _ea)
	{
		...
		{
			num = EffectManager.GetValue(PassiveEffects.AttributeLevel, null, num, _ea, null, progressionClass.NameTag);
		}
		else if (progressionClass.Type == ProgressionType.Skill)
		{
			num = EffectManager.GetValue(PassiveEffects.SkillLevel, null, num, _ea, null, progressionClass.NameTag);
		}
		else if (progressionClass.Type == ProgressionType.Perk)
		{
			num = EffectManager.GetValue(PassiveEffects.PerkLevel, null, num, _ea, null, progressionClass.NameTag);
		}
