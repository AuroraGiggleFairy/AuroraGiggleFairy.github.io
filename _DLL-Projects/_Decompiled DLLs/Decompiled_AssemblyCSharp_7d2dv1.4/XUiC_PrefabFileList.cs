...
public class XUiC_PrefabFileList : XUiC_List<XUiC_PrefabFileList.PrefabFileEntry>
{
	...
	public class PrefabFileEntry : XUiListEntry
	{
		...
		{
			if (!(_otherEntry is PrefabFileEntry prefabFileEntry))
			{
				return 1;
			}
			return location.CompareTo(prefabFileEntry.location);
		}
	...
	public override void RebuildList(bool _resetFilter = false)
	{
		...
		GameManager.Instance.prefabEditModeManager.FindPrefabs(groupFilter, prefabSearchList);
