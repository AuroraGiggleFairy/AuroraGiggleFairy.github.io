	...
	public override void ProcessPackage(World _world, GameManager _callbacks)
	{
		...
		if (!_world.IsRemote())
		{
			...
			case NetPackageEditorSleeperVolume.EChangeType.Changed:
				PrefabVolumeManager.Instance.UpdateTeleportPropertiesServer(prefabInstanceId, volumeId, volumeSettings);
				break;
			case NetPackageEditorSleeperVolume.EChangeType.Removed:
				PrefabVolumeManager.Instance.UpdateTeleportPropertiesServer(prefabInstanceId, volumeId, volumeSettings, remove: true);
				break;
			default:
		...
		else
		{
			...
			case NetPackageEditorSleeperVolume.EChangeType.Changed:
				PrefabVolumeManager.Instance.AddUpdateTeleportPropertiesClient(prefabInstanceId, volumeId, volumeSettings);
				break;
			case NetPackageEditorSleeperVolume.EChangeType.Removed:
				PrefabVolumeManager.Instance.AddUpdateTeleportPropertiesClient(prefabInstanceId, volumeId, volumeSettings, remove: true);
				break;
			default:
				throw new ArgumentOutOfRangeException();
			}
