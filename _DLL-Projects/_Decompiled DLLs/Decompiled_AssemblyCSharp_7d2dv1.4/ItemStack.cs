...
public class ItemStack
{
	...
	public bool CanStackWith(ItemStack _other, bool allowPartialStack = false)
	{
		...
		if (_other.itemValue != null && itemValue != null && _other.itemValue.type == itemValue.type && (itemValue.type >= Block.ItemsStartHere || _other.itemValue.Texture == itemValue.Texture || itemValue.IsShapeHelperBlock))
		{
