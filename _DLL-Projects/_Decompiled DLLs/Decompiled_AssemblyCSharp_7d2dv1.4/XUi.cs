...
public class XUi : MonoBehaviour
{
	...
	{
		LoadManager.LoadAssetFromResources(_path, _callback, loadGroup, _deferLoading: false, !asyncLoad);
	}
	...
	public void Init(int _id)
	{
		...
		{
			LoadData("Sounds/UI/ui_menu_cycle", [PublicizedFrom(EAccessModifier.Private)] (AudioClip o) =>
			{
				uiScrollSound = o;
			});
			LoadData("Sounds/UI/ui_menu_click", [PublicizedFrom(EAccessModifier.Private)] (AudioClip o) =>
			{
				uiClickSound = o;
			});
			LoadData("Sounds/UI/ui_menu_start", [PublicizedFrom(EAccessModifier.Private)] (AudioClip o) =>
			{
				uiConfirmSound = o;
			});
			LoadData("Sounds/UI/ui_menu_back", [PublicizedFrom(EAccessModifier.Private)] (AudioClip o) =>
			{
				uiBackSound = o;
			});
			LoadData("Sounds/UI/ui_hover", [PublicizedFrom(EAccessModifier.Private)] (AudioClip o) =>
			{
				uiSliderSound = o;
			});
		}
	...
	public static void HandlePaging(XUi _xui, Action _onPageUp, Action _onPageDown, bool useVerticalAxis = false)
	{
		if (null != _xui.playerUI && _xui.playerUI.playerInput != null && _xui.playerUI.playerInput.GUIActions != null && _xui.playerUI.windowManager.IsKeyShortcutsAllowed())
		{
			...
			{
				pagingRepeatTimer -= Time.deltaTime;
