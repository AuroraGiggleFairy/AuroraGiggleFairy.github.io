...
public class PartyVoice
{
	...
	public void Update()
	{
		if (platformPartyVoiceInitialized && !(localPlayer == null))
		{
			LocalPlayerUI playerUI = localPlayer.PlayerUI;
			if (!(playerUI == null) && playerUI.playerInput != null && platformPartyVoice.InLobby)
			{
				...
				platformPartyVoice.MuteSelf = !flag2;
				platformPartyVoice.MuteOthers = !flag;
			}
		}
	}
}
