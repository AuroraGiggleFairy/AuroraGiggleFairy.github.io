...
public class ItemActionRanged : ItemActionAttack
{
	...
	public override void ReadFrom(DynamicProperties _props)
	{
		...
		{
			bulletMaterialName = _props.Values["bullet_material"];
		}
		else
		{
		...
		{
			bSupportHarvesting = StringParsers.ParseBool(_props.Values["SupportHarvesting"]);
		}
		if (_props.Values.ContainsKey("UseMeleeCrosshair"))
		{
			bUseMeleeCrosshair = StringParsers.ParseBool(_props.Values["UseMeleeCrosshair"]);
		}
		if (_props.Values.ContainsKey("EntityPenetrationCount"))
		{
			EntityPenetrationCount = StringParsers.ParseSInt32(_props.Values["EntityPenetrationCount"]);
		}
		else
		{
		...
		{
			BlockPenetrationFactor = StringParsers.ParseSInt32(_props.Values["BlockPenetrationFactor"]);
		}
		if (_props.Values.ContainsKey("AutoReload"))
		{
			AutoReload = StringParsers.ParseBool(_props.Values["AutoReload"]);
		}
	...
	public override void OnModificationsChanged(ItemActionData _data)
	{
		...
		if (itemActionDataRanged.OriginalDelay == -1f && Properties.Values.ContainsKey("Delay"))
		{
			itemActionDataRanged.OriginalDelay = StringParsers.ParseFloat(Properties.Values["Delay"]);
		}
		if (Properties.Values.ContainsKey("ScopeOffset"))
		{
			itemActionDataRanged.ScopeTransformOffset = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("ScopeOffset", Properties.Values["ScopeOffset"]));
		}
		else
		{
			itemActionDataRanged.ScopeTransformOffset = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("ScopeOffset", "0,0,0"));
		}
		if (Properties.Values.ContainsKey("SideOffset"))
		{
			itemActionDataRanged.SideTransformOffset = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("SideOffset", Properties.Values["SideOffset"]));
		}
		else
		{
			itemActionDataRanged.SideTransformOffset = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("SideOffset", "0,0,0"));
		}
		if (Properties.Values.ContainsKey("BarrelOffset"))
		{
			itemActionDataRanged.BarrelTransformOffset = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("BarrelOffset", Properties.Values["BarrelOffset"]));
		}
		else
		{
			itemActionDataRanged.BarrelTransformOffset = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("BarrelOffset", "0,0,0"));
		}
		if (Properties.Values.ContainsKey("ScopeScale"))
		{
			itemActionDataRanged.ScopeTransformScale = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("ScopeScale", Properties.Values["ScopeScale"]));
		}
		else
		{
			itemActionDataRanged.ScopeTransformScale = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("ScopeScale", "1,1,1"));
		}
		if (Properties.Values.ContainsKey("SideScale"))
		{
			itemActionDataRanged.SideTransformScale = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("SideScale", Properties.Values["SideScale"]));
		}
		else
		{
			itemActionDataRanged.SideTransformScale = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("SideScale", "1,1,1"));
		}
		if (Properties.Values.ContainsKey("BarrelScale"))
		{
			itemActionDataRanged.BarrelTransformScale = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("BarrelScale", Properties.Values["BarrelScale"]));
		}
		else
		{
			itemActionDataRanged.BarrelTransformScale = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("BarrelScale", "1,1,1"));
		}
		if (Properties.Values.ContainsKey("ScopeRotation"))
		{
			itemActionDataRanged.ScopeTransformRotation = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("ScopeRotation", Properties.Values["ScopeRotation"]));
		}
		else
		{
			itemActionDataRanged.ScopeTransformRotation = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("ScopeRotation", "0,0,0"));
		}
		if (Properties.Values.ContainsKey("SideRotation"))
		{
			itemActionDataRanged.SideTransformRotation = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("SideRotation", Properties.Values["SideRotation"]));
		}
		else
		{
			itemActionDataRanged.SideTransformRotation = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("SideRotation", "0,0,0"));
		}
		if (Properties.Values.ContainsKey("BarrelRotation"))
		{
			itemActionDataRanged.BarrelTransformRotation = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("BarrelRotation", Properties.Values["BarrelRotation"]));
		}
		else
		{
			itemActionDataRanged.BarrelTransformRotation = StringParsers.ParseVector3(itemActionDataRanged.invData.itemValue.GetPropertyOverride("BarrelRotation", "0,0,0"));
		}
		string optionalValue = "";
		Properties.ParseString("Sound_start", ref optionalValue);
		itemActionDataRanged.SoundStart = itemActionDataRanged.invData.itemValue.GetPropertyOverride("Sound_start", optionalValue);
		optionalValue = "";
		Properties.ParseString("Sound_loop", ref optionalValue);
		itemActionDataRanged.SoundLoop = itemActionDataRanged.invData.itemValue.GetPropertyOverride("Sound_loop", optionalValue);
		optionalValue = "";
		Properties.ParseString("Sound_end", ref optionalValue);
		itemActionDataRanged.SoundEnd = itemActionDataRanged.invData.itemValue.GetPropertyOverride("Sound_end", optionalValue);
		if (soundStart.Contains("silenced"))
		{
	...
	public override void SwapAmmoType(EntityAlive _entity, int _ammoItemId = -1)
	{
		...
		CancelReload(itemActionDataRanged);
		...
		if (itemActionDataRanged.invData.holdingEntity as EntityPlayerLocal != null)
		{
			...
			{
				SingletonMonoBehaviour<ConnectionManager>.Instance.SendPackage(NetPackageManager.GetPackage<NetPackageHoldingItem>().Setup(itemActionDataRanged.invData.holdingEntity));
			}
			else
			{
				SingletonMonoBehaviour<ConnectionManager>.Instance.SendToServer(NetPackageManager.GetPackage<NetPackageHoldingItem>().Setup(itemActionDataRanged.invData.holdingEntity));
			}
		}
		GameManager.Instance.ItemReloadServer(itemActionDataRanged.invData.holdingEntity.entityId);
		_entity.inventory.ShowHeldItem(show: true);
	}
	...
	public override void OnHoldingUpdate(ItemActionData _actionData)
	{
		...
		if (_actionData.invData.holdingEntity.isHeadUnderwater && _actionData.invData.itemValue.ItemClass != null)
		{
			...
			if (MagazineItemNames != null && !ItemClass.GetItemClass(MagazineItemNames[_actionData.invData.itemValue.SelectedAmmoTypeIndex]).UsableUnderwater)
			{
		...
		updateAccuracy(_actionData, _actionData.invData.holdingEntity.AimingGun);
	...
	[PublicizedFrom(EAccessModifier.Protected)]
	public bool reloadCancelled(ItemActionDataRanged actionData)
	{
	...
	[PublicizedFrom(EAccessModifier.Protected)]
	public bool notReloadCancelled(ItemActionDataRanged actionData)
	{
		if (actionData.isReloadCancelled)
		{
			return !actionData.isWeaponReloadCancelled;
	...
	[PublicizedFrom(EAccessModifier.Protected)]
	public bool reloading(ItemActionDataRanged actionData)
	{
		if (!actionData.isReloading)
		{
			return actionData.isWeaponReloading;
		}
		return true;
	}

	[PublicizedFrom(EAccessModifier.Protected)]
	public bool notReloading(ItemActionDataRanged actionData)
	{
		if (actionData.isReloading)
		{
			return !actionData.isWeaponReloading;
	...
	{
		ItemActionDataRanged itemActionDataRanged = (ItemActionDataRanged)_data;
		if (!notReloading(itemActionDataRanged) && !reloadCancelled(itemActionDataRanged))
		{
	...
	public override bool CanReload(ItemActionData _actionData)
	{
		...
		if (notReloading(actionData) && _actionData.invData.itemValue.Meta < num)
		{
	...
	public override void ItemActionEffects(GameManager _gameManager, ItemActionData _actionData, int _firingState, Vector3 _startPos, Vector3 _direction, int _userData = 0)
	{
		...
		if (particlesMuzzleSmoke != null)
		{
			...
			if ((bool)transform2 && entityPlayerLocal == GameManager.Instance.World.GetPrimaryPlayer() && entityPlayerLocal.vp_FPController.OnValue_IsFirstPerson)
			{
	...
	public virtual void onHoldingEntityFired(ItemActionData _actionData)
	{
		if (!_actionData.invData.holdingEntity.isEntityRemote)
		{
			_actionData.invData.holdingEntity.emodel.avatarController.UpdateFloat("MeleeAttackSpeed", 1f / ((ItemActionDataRanged)_actionData).Delay);
	...
	public override void ExecuteAction(ItemActionData _actionData, bool _bReleased)
	{
		...
		else
		{
			...
			getImageActionEffectsStartPosAndDirection(_actionData, out var _startPos, out var _direction);
			itemActionDataRanged.invData.gameManager.ItemActionEffectsServer(holdingEntity.entityId, itemActionDataRanged.invData.slotIdx, itemActionDataRanged.indexInEntityOfAction, (int)itemActionDataRanged.state, _startPos, _direction, getUserData(_actionData));
	...
	public virtual float updateAccuracy(ItemActionData _actionData, bool _isAimingGun)
	{
		...
		float num2 = Mathf.Clamp01(EffectManager.GetValue(PassiveEffects.WeaponHandling, itemValue, 0.1f, holdingEntity));
		obj.lastAccuracy = Mathf.Lerp(obj.lastAccuracy, num, Time.deltaTime * num2 * 15f);
	...
	public virtual Vector3 fireShot(int _shotIdx, ItemActionDataRanged _actionData, ref bool hitEntityFound)
	{
		...
		for (int i = 0; i < num; i++)
		{
			if (Voxel.Raycast(_actionData.invData.world, lookRay, range, -538750997, hitMask, 0f))
			{
				...
				ItemActionAttack.Hit(worldRayHitInfo, holdingEntity.entityId, (DamageType == EnumDamageTypes.None) ? EnumDamageTypes.Piercing : DamageType, GetDamageBlock(itemValue, ItemActionAttack.GetBlockHit(_actionData.invData.world, worldRayHitInfo), holdingEntity) * num3, GetDamageEntity(itemValue, holdingEntity) * num3, 1f, itemValue.PercentUsesLeft, _actionData.invData.item.CritChance.Value, ItemAction.GetDismemberChance(_actionData, worldRayHitInfo), bulletMaterialName, damageMultiplier, getBuffActions(_actionData), _actionData.attackDetails, 0, ActionExp, ActionExpBonusMultiplier, null, ToolBonuses, bSupportHarvesting ? EnumAttackMode.RealAndHarvesting : EnumAttackMode.RealNoHarvesting);
	...
	public override WorldRayHitInfo GetExecuteActionTarget(ItemActionData _actionData)
	{
		...
		if (holdingEntity is EntityPlayer entityPlayer && itemActionDataRanged.Laser != null)
		{
			...
			{
				if (Voxel.Raycast(_actionData.invData.world, lookRay, num, -538750997, hitMask, 0f))
				{
				...
				{
					entityPlayer.SetLaserSightData(_laserSightActive: false, lookRay.origin);
				}
			}
			else
			{
		...
		lookRay.direction = getDirectionOffset(itemActionDataRanged, lookRay.direction);
		bool num2 = Voxel.Raycast(_actionData.invData.world, lookRay, num, -538750997, hitMask, 0f);
		holdingEntity.SetModelLayer(modelLayer);
		if (num2)
		{
			WorldRayHitInfo updatedHitInfo = _actionData.GetUpdatedHitInfo();
