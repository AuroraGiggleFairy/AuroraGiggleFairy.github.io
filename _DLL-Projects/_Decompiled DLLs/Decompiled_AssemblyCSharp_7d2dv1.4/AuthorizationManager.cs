...
public class AuthorizationManager : IAuthorizationResponses
{
	...
	public void Authorize(ClientInfo _clientInfo, string _playerName, (PlatformUserIdentifierAbs userId, string token) _platformUserAndToken, (PlatformUserIdentifierAbs userId, string token) _crossplatformUserAndToken, string _compatibilityVersion)
	{
		...
		(_clientInfo.PlatformId, _) = _platformUserAndToken;
		(_clientInfo.CrossplatformId, _) = _crossplatformUserAndToken;
