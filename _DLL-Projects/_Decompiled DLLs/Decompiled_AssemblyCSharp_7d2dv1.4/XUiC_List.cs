...
public abstract class XUiC_List<T> : XUiController where T : XUiListEntry
{
	...
	public int PageLength => listEntryControllers.Length;
	...
	{
		if (SelectableEntries && CursorControllable && columns > 0 && rows > 0 && PlatformManager.NativePlatform.Input.CurrentInputStyle == PlayerInputManager.InputStyle.Keyboard)
		{
