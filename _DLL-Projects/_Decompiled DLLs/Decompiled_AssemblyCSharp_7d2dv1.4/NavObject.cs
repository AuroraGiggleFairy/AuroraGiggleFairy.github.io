...
public class NavObject
{
	...
	public bool HasRequirements => NavObjectClass != null;
	...
	public NavObjectMapSettings CurrentMapSettings => NavObjectClass.GetMapSettings(IsActive);

	public NavObjectCompassSettings CurrentCompassSettings => NavObjectClass.GetCompassSettings(IsActive);

	public NavObjectScreenSettings CurrentScreenSettings => NavObjectClass.GetOnScreenSettings(IsActive);
	...
	public bool IsValid()
	{
		...
		else if (TrackType == TrackTypes.Entity && TrackedEntity == null && entityID == -1)
		{
			TrackType = TrackTypes.None;
		}
	...
	public Vector3 GetPosition()
	{
		...
		case TrackTypes.Position:
			return trackedPosition - Origin.position;
		case TrackTypes.Transform:
			return trackedTransform.position;
		case TrackTypes.Entity:
			if (entityID != -1)
			{
				return trackedPosition - Origin.position;
			}
			return trackedEntity.position - Origin.position;
		default:
			return InvalidPos;
		}
	}
	...
	public void PauseEntityUpdate()
	{
		if (TrackType == TrackTypes.Entity)
		{
			...
			trackedPosition = trackedEntity.position;
		}
	}
