...
public class XUiC_MapStats : XUiController
{
	...
	[PublicizedFrom(EAccessModifier.Private)]
	public readonly CachedStringFormatter<float> tempFormatter = new CachedStringFormatter<float>([PublicizedFrom(EAccessModifier.Internal)] (float _f) => ValueDisplayFormatters.Temperature(_f, 0));
