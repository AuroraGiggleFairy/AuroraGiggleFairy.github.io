...
public static class LoadManager
{
	...
	public static AssetRequestTask<T> LoadAsset<T>(DataLoader.DataPathIdentifier _identifier, Action<T> _callback = null, LoadGroup _lg = null, bool _deferLoading = false, bool _loadSync = false) where T : UnityEngine.Object
	{
		...
		{
			return LoadAssetFromAddressables(_identifier.AssetName, _callback, _lg, _deferLoading, _loadSync);
		}
	...
	public static AddressableRequestTask<T> LoadAssetFromAddressables<T>(object _key, Action<T> _callback = null, LoadGroup _lg = null, bool _deferLoading = false, bool _loadSync = false) where T : UnityEngine.Object
	{
		if (_lg == null)
		{
			_lg = rootGroup;
		}
		AddressableRequestTask<T> addressableRequestTask = new AddressableRequestTask<T>(_lg, !_loadSync, _key, _callback);
		addOrExecLoadTask(_lg, addressableRequestTask, _deferLoading, _loadSync);
		return addressableRequestTask;
	}

	public static AddressableRequestTask<T> LoadAssetFromAddressables<T>(string _folderAddress, string _assetPath, Action<T> _callback = null, LoadGroup _lg = null, bool _deferLoading = false, bool _loadSync = false) where T : UnityEngine.Object
	{
		return LoadAssetFromAddressables(_folderAddress + "/" + _assetPath, _callback, _lg, _deferLoading, _loadSync);
	}
