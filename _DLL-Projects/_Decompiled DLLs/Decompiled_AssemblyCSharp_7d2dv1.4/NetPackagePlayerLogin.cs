...
public class NetPackagePlayerLogin : NetPackage
{
	...
	public NetPackagePlayerLogin Setup(string _playerName, (PlatformUserIdentifierAbs userId, string token) _platformUserAndToken, (PlatformUserIdentifierAbs userId, string token) _crossplatformUserAndToken, string _version, string _compVersion)
	{
	...
	{
		_callbacks.PlayerLoginRPC(base.Sender, playerName, platformUserAndToken, crossplatformUserAndToken, compVersion);
	}
