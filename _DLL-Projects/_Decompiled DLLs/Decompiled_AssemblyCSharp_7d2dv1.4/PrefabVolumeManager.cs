	...
	public void AddTeleportVolumeServer(Vector3i _hitPointBlockPos)
	{
		if (SingletonMonoBehaviour<ConnectionManager>.Instance.IsServer)
		{
			...
			if (prefabInstance != null)
			{
				...
				int num = prefabInstance.prefab.AddTeleportVolume(prefabInstance.name, prefabInstance.boundingBoxPosition, _hitPointBlockPos - prefabInstance.boundingBoxPosition - new Vector3i(size.x / 2, 0, size.z / 2), size);
		...
		{
			SingletonMonoBehaviour<ConnectionManager>.Instance.SendToServer(NetPackageManager.GetPackage<NetPackageEditorAddTeleportVolume>().Setup(_hitPointBlockPos));
		}
	}
	...
	public void AddInfoVolumeServer(Vector3i _hitPointBlockPos)
	{
		if (SingletonMonoBehaviour<ConnectionManager>.Instance.IsServer)
		{
			...
			if (dynamicPrefabDecorator != null)
			{
				...
				{
					Vector3i size = new Vector3i(15, 3, 15);
					int num = prefabInstance.prefab.AddInfoVolume(prefabInstance.name, prefabInstance.boundingBoxPosition, _hitPointBlockPos - prefabInstance.boundingBoxPosition - new Vector3i(size.x / 2, 0, size.z / 2), size);
		...
		{
			SingletonMonoBehaviour<ConnectionManager>.Instance.SendToServer(NetPackageManager.GetPackage<NetPackageEditorAddInfoVolume>().Setup(_hitPointBlockPos));
		}
	}
	...
	public void AddWallVolumeServer(Vector3i _hitPointBlockPos)
	{
		if (SingletonMonoBehaviour<ConnectionManager>.Instance.IsServer)
		{
			...
			if (dynamicPrefabDecorator != null)
			{
				...
				{
					Vector3i size = new Vector3i(15, 3, 15);
					int num = prefabInstance.prefab.AddWallVolume(prefabInstance.name, prefabInstance.boundingBoxPosition, _hitPointBlockPos - prefabInstance.boundingBoxPosition - new Vector3i(size.x / 2, 0, size.z / 2), size);
		...
		{
			SingletonMonoBehaviour<ConnectionManager>.Instance.SendToServer(NetPackageManager.GetPackage<NetPackageEditorAddWallVolume>().Setup(_hitPointBlockPos));
		}
	}
