...
public class BlockPoweredDoor : BlockPowered
{
	...
	public override void OnBlockValueChanged(WorldBase _world, Chunk _chunk, int _clrIdx, Vector3i _blockPos, BlockValue _oldBlockValue, BlockValue _newBlockValue)
	{
		...
		if (shape is BlockShapeModelEntity && (_oldBlockValue.type != _newBlockValue.type || _oldBlockValue.meta != _newBlockValue.meta) && !_newBlockValue.ischild)
		{
			...
			updateAnimState(blockEntity, IsDoorOpen(_newBlockValue.meta), _newBlockValue);
		}
	}
	...
	public void updateAnimState(WorldBase _world, int _cIdx, Vector3i _blockPos, BlockValue _blockValue)
	{
		...
		if (chunkSync != null)
		{
			...
			if (blockEntity != null && blockEntity.bHasTransform)
			{
				...
				updateAnimState(blockEntity, bOpen, _blockValue);
			}
		}
	}
	...
	public void updateAnimState(BlockEntityData _ebcd, bool _bOpen, BlockValue _blockValue)
	{
		...
		if (componentsInChildren != null)
		{
			for (int num = componentsInChildren.Length - 1; num >= 0; num--)
			{
				...
				obj.enabled = true;
				obj.SetBool("IsOpen", _bOpen);
				obj.SetTrigger("OpenTrigger");
			}
		}
	}
	...
	public override void OnBlockEntityTransformAfterActivated(WorldBase _world, Vector3i _blockPos, int _cIdx, BlockValue _blockValue, BlockEntityData _ebcd)
	{
		...
		updateAnimState(_world, _cIdx, _blockPos, _blockValue);
	}
