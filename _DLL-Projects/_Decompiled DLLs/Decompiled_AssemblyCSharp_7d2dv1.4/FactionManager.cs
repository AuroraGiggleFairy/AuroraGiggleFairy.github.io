...
public class FactionManager
{
	...
	public void Save()
	{
		if (dataSaveThreadInfo == null || !ThreadManager.ActiveThreads.ContainsKey("factionDataSave"))
		{
			...
			dataSaveThreadInfo = ThreadManager.StartThread("factionDataSave", null, saveFactionDataThreaded, null, System.Threading.ThreadPriority.Normal, pooledExpandableMemoryStream, null, _useRealThread: false, _isSilent: true);
		}
	}
