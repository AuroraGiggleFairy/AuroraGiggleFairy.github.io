...
public struct BodyDamage
{
	...
	public bool HasLeftLeg => (Flags & 0x60) == 0;

	public bool HasRightLeg => (Flags & 0x180) == 0;

	public bool HasLimbs => (Flags & 0x14A) != 330;

	public bool IsAnyLegMissing => (Flags & 0x1E0) != 0;

	public bool IsAnyArmOrLegMissing => (Flags & 0x1FE) != 0;
