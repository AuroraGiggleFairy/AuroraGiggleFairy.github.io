...
public class XUi_FallThrough : MonoBehaviour
{
	...
	public void Update()
	{
		...
		if (null != playerUI && null != playerUI.uiCamera && playerUI.playerInput != null && playerUI.playerInput.GUIActions != null)
		{
			...
			if ((flag4 || flag5) && PlatformManager.NativePlatform.Input.CurrentInputStyle == PlayerInputManager.InputStyle.Keyboard && xui.currentPopupMenu != null && !xui.currentPopupMenu.IsOver)
			{
