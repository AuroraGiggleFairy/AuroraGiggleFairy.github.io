...
public class NetPackageNPCQuestList : NetPackage
{
	...
	public override void ProcessPackage(World _world, GameManager _callbacks)
	{
		...
		if (SingletonMonoBehaviour<ConnectionManager>.Instance.IsServer)
		{
			...
			QuestEventManager.Current.SetupQuestList(npcEntityID, playerEntityID, entityTrader.activeQuests);
			if (eventType == NPCQuestEventTypes.FetchList)
			{
			...
			else if (eventType == NPCQuestEventTypes.RemoveQuest)
			{
				...
				QuestEventManager.Current.SetupQuestList(npcEntityID, playerEntityID, questList);
			}
			else
			{
