...
public class BlockShapeTerrain : BlockShapeCube
{
	...
	public override void renderFace(Vector3i _worldPos, BlockValue _blockValue, Vector3 _drawPos, BlockFace _face, Vector3[] _vertices, LightingAround _lightingAround, long _textureFull, VoxelMesh[] _meshes, MeshPurpose _purpose = MeshPurpose.World)
	{
	...
	public override void renderFull(Vector3i _worldPos, BlockValue _blockValue, Vector3 _drawPos, Vector3[] _vertices, LightingAround _lightingAround, long _textureFull, VoxelMesh[] _meshes, MeshPurpose _purpose = MeshPurpose.World)
	{
		...
		int sideTextureId = obj.GetSideTextureId(_blockValue, BlockFace.Top);
		int sideTextureId2 = obj.GetSideTextureId(_blockValue, BlockFace.South);
