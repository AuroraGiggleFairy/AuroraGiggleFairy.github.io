...
public class ItemValue : IEquatable<ItemValue>
{
	...
	public long Texture
	{
		get
		{
			return (long)((((ulong)Quality & 0xFFFFuL) << 48) | (((ulong)Meta & 0xFFFFuL) << 32) | (ulong)(((long)UseTimes & 0xFFFF) << 16) | (((ulong)Activated & 0xFFuL) << 8) | ((ulong)SelectedAmmoTypeIndex & 0xFFuL));
		}
		set
		{
			Quality = (ushort)((value >> 48) & 0xFFFF);
			Meta = (int)((value >> 32) & 0xFFFF);
			UseTimes = (int)((value >> 16) & 0xFFFF);
			Activated = (byte)((value >> 8) & 0xFF);
			SelectedAmmoTypeIndex = (byte)(value & 0xFF);
		}
	}
	...
	public int TextureAllSides
	{
		get
		{
			return Quality & 0xFFFF;
		}
		set
		{
			Quality = (ushort)(value & 0xFFFF);
		}
	}
	...
	public ItemClass ItemClassOrMissing
	{
		get
		{
			...
			return ItemClass.GetItemClass("missingItem");
		}
	}
	...
	public bool HasMetadata(string key, TypedMetadataValue.TypeTag typeTag = TypedMetadataValue.TypeTag.None)
	{
		...
		TypedMetadataValue typedMetadataValue = Metadata[key];
	...
	public void SetMetadata(string key, object value, string typeTag)
	{
		...
		SetMetadata(key, value, typeTag2);
	}
	...
	public void SetMetadata(string key, object value, TypedMetadataValue.TypeTag typeTag)
	{
		...
		{
			Metadata.Add(key, new TypedMetadataValue(value, typeTag));
		}
	}
