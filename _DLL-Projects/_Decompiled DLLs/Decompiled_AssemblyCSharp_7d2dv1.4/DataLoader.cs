...
public static class DataLoader
{
	...
	public static T LoadAsset<T>(DataPathIdentifier _identifier) where T : Object
	{
		return LoadManager.LoadAsset<T>(_identifier, null, null, _deferLoading: false, _loadSync: true).Asset;
	}

	public static T LoadAsset<T>(string _uri) where T : Object
	{
		return LoadAsset<T>(ParseDataPathIdentifier(_uri));
	}

	public static T LoadAsset<T>(AssetReference assetReference) where T : Object
	{
		return LoadManager.LoadAssetFromAddressables<T>(assetReference, null, null, _deferLoading: false, _loadSync: true).Asset;
	}
