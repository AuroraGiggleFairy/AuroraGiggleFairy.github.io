...
public class ConnectionManager : SingletonMonoBehaviour<ConnectionManager>
{
	...
	public void Connect(GameServerInfo _gameServerInfo)
	{
		...
		{
			Net_ConnectionFailed(Localization.Get("xuiNonStandardGameSettings"));
			return;
		}
	...
	public void SendLogin()
	{
		...
		SendToServer(NetPackageManager.GetPackage<NetPackagePlayerLogin>().Setup(GamePrefs.GetString(EnumGamePrefs.PlayerName), platformUserAndToken, crossplatformUserAndToken, Constants.cVersionInformation.LongStringNoBuild, Constants.cVersionInformation.LongStringNoBuild));
	}
