...
public class GamePrefs
{
	...
	public struct PropertyDecl
	{
		...
		public bool IsPersistent => bPersistent.HasFlag(DeviceFlags.Current);
		...
		public PropertyDecl(EnumGamePrefs _name, DeviceFlag _bPersistent, EnumType _type, object _defaultValue, object _minStockValue, object _maxStockValue, Dictionary<DeviceFlag, object> _deviceDefaults = null)
		{
			...
			{
				defaultValue = _deviceDefaults[DeviceFlags.Current];
			}
			else
			{
	...
	public static void initPropertyDecl()
	{
		...
		s_propertyList = new PropertyDecl[246]
		{
			...
			new PropertyDecl(EnumGamePrefs.OptionsLiteNetLibMtuOverride, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Bool, false, null, null),
			...
			new PropertyDecl(EnumGamePrefs.LandClaimCount, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Int, 3, null, null),
			...
			new PropertyDecl(EnumGamePrefs.OptionsSubtitlesEnabled, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Bool, false, null, null),
			...
			new PropertyDecl(EnumGamePrefs.OptionsControlsSprintLock, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Bool, true, null, null),
