...
public class BlockShapeModelEntity : BlockShapeInvisible
{
	...
	public override void Init(Block _block)
	{
		...
		if (modelNameWithPath.Length > 0)
		{
			...
			int num = 1;
			if (censorMode != 0 && num == 1 && (bool)GameManager.Instance && GameManager.Instance.IsGoreCensored())
			{
	...
	public Transform getPrefab()
	{
		...
		if (prefab == null)
		{
			...
			prefab = DataLoader.LoadAsset<Transform>("Entities/Misc/block_missingPrefab");
			if (prefab == null)
			{
				return null;
			}
