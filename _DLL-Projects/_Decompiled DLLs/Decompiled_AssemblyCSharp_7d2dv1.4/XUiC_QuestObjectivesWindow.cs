...
public class XUiC_QuestObjectivesWindow : XUiController
{
	...
	public override bool GetBindingValue(ref string value, string bindingName)
	{
		...
		case "questrequirementstitle":
			...
			return true;
		case "tieradd":
			if (currentQuest != null && questClass.AddsToTierComplete && (currentQuest.QuestProgressDay > 0 || (currentQuest.OwnerJournal.CanAddProgression && currentQuest.QuestProgressDay == int.MinValue)))
			{
