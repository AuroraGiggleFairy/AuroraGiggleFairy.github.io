...
public class XUiC_PrefabMarkerList : XUiC_List<XUiC_PrefabMarkerList.PrefabMarkerEntry>
{
	...
	public class PrefabMarkerEntry : XUiListEntry
	{
		...
		{
			if (!(_otherEntry is PrefabMarkerEntry))
			{
				return 1;
			}
			return string.Compare(marker.GroupName, ((PrefabMarkerEntry)_otherEntry).marker.GroupName, StringComparison.OrdinalIgnoreCase);
		}
