...
public class XUiC_PowerRangedAmmoSlots : XUiC_ItemStackGrid
{
	...
	public void btnOn_OnPress(XUiController _sender, int _mouseButton)
	{
		...
		if (!flag)
		{
			...
			GameManager.ShowTooltip(xui.playerUI.localPlayer.entityPlayerLocal, Localization.Get("ttRequiresAmmo"));
		}
		else
		{
	...
	public override void OnOpen()
	{
		...
		setRequirements();
		RefreshIsLocked(tileEntity.IsLocked);
		xui.CurrentPowerAmmoSlots = this;
		xui.CalloutWindow.AddCallout(UIUtils.ButtonIcon.RightBumper, "igcoPoweredTrapLockAmmo", XUiC_GamepadCalloutWindow.CalloutType.MenuShortcuts);
	...
	public override void OnClose()
	{
		...
		IsDirty = true;
		tileEntity = null;
		xui.CurrentPowerAmmoSlots = null;
