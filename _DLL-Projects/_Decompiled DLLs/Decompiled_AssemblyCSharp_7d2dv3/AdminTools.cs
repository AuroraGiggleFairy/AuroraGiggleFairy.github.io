...
public class AdminTools
{
	...
	public AdminTools()
	{
		...
		ApiTokens = new AdminApiTokens(this);
		WebModules = new AdminWebModules(this);
		WebUsers = new AdminWebUsers(this);
		adminFileStorage = PlatformManager.MultiPlatform.UserDataRoaming.DefaultSaveStorage;
		registerModules();
	...
	public void registerModules()
	{
		...
		modules.Add(ApiTokens.SectionTypeName, ApiTokens);
		modules.Add(WebModules.SectionTypeName, WebModules);
		modules.Add(WebUsers.SectionTypeName, WebUsers);
	}
	...
	{
		if (adminFileStorage == UserDataStorageType.DeviceLocal)
		{
	...
	{
		return GameIO.GetSaveGameRootDir(adminFileStorage);
	}
