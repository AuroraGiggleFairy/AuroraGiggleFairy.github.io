...
public class ObjectiveRandomPOIGoto : ObjectiveGoto
{
	...
	public override Vector3 GetPosition(EntityNPC ownerNPC = null, EntityPlayer entityPlayer = null, List<Vector2> usedPOILocations = null, int entityIDforQuests = -1)
	{
		...
		if (SingletonMonoBehaviour<ConnectionManager>.Instance.IsServer)
		{
			...
			prefabInstance = ((!(ownerNPC != null)) ? DynamicPrefabDecorator.GetRandomPOINearWorldPos(new Vector2(entityAlive.position.x, entityAlive.position.z), 1000, 4000000, base.OwnerQuest.QuestTags, (byte)POITier, usedPOILocations, entityIDforQuests, biomeFilterType, biomeFilter) : DynamicPrefabDecorator.GetRandomPOINearTrader(ownerNPC as EntityTrader, base.OwnerQuest.QuestTags, (byte)POITier, usedPOILocations, entityIDforQuests, biomeFilterType, biomeFilter));
