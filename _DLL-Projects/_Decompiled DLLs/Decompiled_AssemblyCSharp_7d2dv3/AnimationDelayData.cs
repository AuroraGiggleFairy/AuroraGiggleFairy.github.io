...
{
	public struct AnimationDelays(int _carry, float _rayCast, float _rayCastMoving, float _holster, float _unholster, bool _twoHanded)
	{
	...
	public static void InitStatic()
	{
		...
		{
			AnimationDelay[i] = new AnimationDelays(0, 0f, 0f, Constants.cMinHolsterTime, Constants.cMinUnHolsterTime, _twoHanded: false);
		}
	}
