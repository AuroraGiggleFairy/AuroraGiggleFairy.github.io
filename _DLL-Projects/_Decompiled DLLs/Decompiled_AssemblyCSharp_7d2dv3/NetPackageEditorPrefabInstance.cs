	...
	public override void ProcessPackage(World _world, GameManager _callbacks)
	{
		if (_world != null && _world.IsRemote())
		{
			...
			case EChangeType.Added:
				PrefabInstanceClientManager.Instance.PrefabLoadedClient(id, boundingBoxPosition, boundingBoxSize, name, size, filename, localRotation, yOffset);
				break;
			case EChangeType.Changed:
				PrefabInstanceClientManager.Instance.PrefabChangedClient(id, boundingBoxPosition, boundingBoxSize, name, size, filename, localRotation, yOffset);
				break;
			case EChangeType.Removed:
				PrefabInstanceClientManager.Instance.PrefabRemovedClient(id);
				break;
			default:
