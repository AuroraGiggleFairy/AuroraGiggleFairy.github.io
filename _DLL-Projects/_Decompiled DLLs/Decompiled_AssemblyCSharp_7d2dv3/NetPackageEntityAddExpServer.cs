...
public class NetPackageEntityAddExpServer : NetPackageEntityAddExpClient
{
	...
	{
		Setup(_entityId, _experience, Progression.XPTypes.Other, null);
		return this;
	}
	...
	public override void ProcessPackage(World _world, GameManager _callbacks)
	{
		if (_world != null)
		{
			...
			{
				entityPlayer.Progression.AddLevelExp(xp, "_xpOther", Progression.XPTypes.Other, useBonus: true, notifyUI: true, -1, usedItem);
			}
		}
	}
}
