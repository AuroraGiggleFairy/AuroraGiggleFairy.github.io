...
public class XUiC_ItemStackGrid : XUiController
{
	...
	public virtual XUiC_ItemStack[] GetItemStackControllers()
	{
	...
	public int FindFirstEmptySlot()
	{
		...
		for (int i = 0; i < itemControllers.Length; i++)
		{
			if (itemControllers[i].ViewComponent.IsActiveInHierarchy && itemControllers[i].ItemStack.IsEmpty())
			{
				result = i;
				break;
			}
	...
	public override void OnOpen()
	{
		base.OnOpen();
		IsDirty = true;
		xui.playerUI.RegisterItemStackGrid(this);
	}
	...
	public override void OnClose()
	{
		base.OnClose();
		ClearHoveredItems();
		xui.playerUI.UnregisterItemStackGrid(this);
	}
}
