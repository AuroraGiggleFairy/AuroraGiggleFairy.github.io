...
public abstract class EAIBase
{
	...
	{
		if (data.TryGetValue(name, out var value2) && StringParsers.TryParseFloat(value2, out var _result))
		{
			value = _result;
		}
	}
	...
	{
		if (data.TryGetValue(name, out var value2) && StringParsers.TryParseSInt32(value2, out var _result))
		{
			value = _result;
		}
	}
