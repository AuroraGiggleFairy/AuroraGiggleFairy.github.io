...
public class XUiC_AssembleWindow : XUiController
{
	...
	public string GetStatValue(int index)
	{
		...
		return XUiM_ItemStack.GetStatItemValueTextWithModInfo(itemStack, xui.playerUI.entityPlayer, infoEntry);
	}
	...
	{
		XUiC_AssembleWindowGroup.GetWindowGroup(xui).ItemStack = ItemStack;
	}
}
