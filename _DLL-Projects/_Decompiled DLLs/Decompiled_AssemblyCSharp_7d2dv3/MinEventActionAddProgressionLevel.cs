...
public class MinEventActionAddProgressionLevel : MinEventActionTargetedBase
{
	...
	public override void Execute(MinEventParams _params)
	{
		...
		for (int i = 0; i < targets.Count; i++)
		{
			...
			int num2 = level;
			if (progressionValue.ProgressionClass.Type == ProgressionType.Crafting && level == 1)
			{
				num2 = SandboxOptionManager.GetInt(global::SandboxOptions.SandboxOptions.PointsPerMagazine);
			}
			progressionValue.Level += num2;
