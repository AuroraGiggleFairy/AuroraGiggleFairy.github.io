...
public class XUiC_MaterialWindow : XUiController
{
	...
	public int CurrentPaintId
	{
		...
		get
		{
			...
			{
				return (int)(xui.playerUI.entityPlayer.inventory.holdingItemItemValue.TextureFullArray[0] & 0xFF);
			}
			return ((ItemActionTextureBlock.ItemActionTextureBlockData)xui.playerUI.entityPlayer.inventory.holdingItemData.actionData[1]).idx;
		}
	}
	...
	public override void OnOpen()
	{
		...
		materialGrid.SetMaterials(currentItems, currentPaintId);
		int holdingItemIdx = xui.playerUI.entityPlayer.inventory.holdingItemIdx;
	...
	public override void OnClose()
	{
		...
		int holdingItemIdx = xui.playerUI.entityPlayer.inventory.holdingItemIdx;
		XUiController childByType = ((XUiWindowGroup)xui.playerUI.windowManager.GetWindow("toolbelt")).Controller.GetChildByType<XUiC_Toolbelt>();
	...
	public override void Update(float _dt)
	{
		...
		{
			if (null != xui.playerUI && xui.playerUI.playerInput != null && xui.playerUI.playerInput.GUIActions != null)
			{
				_ = xui.playerUI.playerInput.GUIActions;
			}
			if (IsDirty)
			{
				RefreshBindings();
