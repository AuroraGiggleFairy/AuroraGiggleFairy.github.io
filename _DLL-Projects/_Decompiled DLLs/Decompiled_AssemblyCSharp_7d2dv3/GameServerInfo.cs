...
public class GameServerInfo
{
	...
	public static readonly GameInfoString[] SearchableStringInfos = new GameInfoString[10]
	{
	...
	public static readonly GameInfoInt[] IntInfosInGameTags = new GameInfoInt[45]
	{
	...
	public void UpdateGameTimePlayers(ulong _time, int _players)
	{
		...
		if (unscaledTime - timeLastWorldTimeUpdate > 20f || GetValue(GameInfoInt.CurrentPlayers) != _players)
		{
			timeLastWorldTimeUpdate = unscaledTime;
	...
	public static GameServerInfo BuildGameServerInfo()
	{
		...
		_ = SandboxOptionManager.Current;
