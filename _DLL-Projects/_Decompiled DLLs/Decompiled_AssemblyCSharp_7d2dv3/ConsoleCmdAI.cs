		...
		case "ragdoll":
		{
			...
			}
			{
				foreach (Entity item3 in world.Entities.list)
				{
					...
					{
						entityAlive2.emodel.DoRagdoll(EModelBase.RagdollMode.Default, result6, EnumBodyPartHit.None, -entityAlive2.GetForwardVector() * result5, Vector3.zero, isRemote: false);
					}
				}
				break;
			}
