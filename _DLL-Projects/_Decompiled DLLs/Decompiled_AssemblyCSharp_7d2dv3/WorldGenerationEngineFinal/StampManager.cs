...
public class StampManager
{
	...
	public delegate void DrawStamp_0000B65F_0024PostfixBurstDelegate(ref NativeArray<float> _dest, ref RawStamp.Data _src, int _x, int _y, int _destWidth, int _destHeight, float _alphaScale, bool _additive, float _scale, ref Color32 _customColor, float _alphaCutoff, float _angle);

	[PublicizedFrom(EAccessModifier.Internal)]
	public static class DrawStamp_0000B65F_0024BurstDirectCall
	{
		[PublicizedFrom(EAccessModifier.Private)]
		...
		public unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(DrawStamp_0000B65F_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		[PublicizedFrom(EAccessModifier.Private)]
		static DrawStamp_0000B65F_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	[PublicizedFrom(EAccessModifier.Internal)]
	public delegate void DrawWaterStamp_0000B662_0024PostfixBurstDelegate(ref NativeArray<float> _dest, ref NativeArray<float> _src, int _x, int _y, int _destWidth, int _destHeight, int _srcWidth, int _srcHeight, float _alpha, float _scale, float _customColor, float _angle);

	[PublicizedFrom(EAccessModifier.Internal)]
	public static class DrawWaterStamp_0000B662_0024BurstDirectCall
	{
		[PublicizedFrom(EAccessModifier.Private)]
		public static IntPtr Pointer;
		...
		public unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(DrawWaterStamp_0000B662_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		[PublicizedFrom(EAccessModifier.Private)]
		static DrawWaterStamp_0000B662_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	{
		DrawStamp_0000B65F_0024BurstDirectCall.Invoke(ref _dest, ref _src, _x, _y, _destWidth, _destHeight, _alphaScale, _additive, _scale, ref _customColor, _alphaCutoff, _angle);
	}
	...
	{
		DrawWaterStamp_0000B662_0024BurstDirectCall.Invoke(ref _dest, ref _src, _x, _y, _destWidth, _destHeight, _srcWidth, _srcHeight, _alpha, _scale, _customColor, _angle);
	}
	...
	public IEnumerator LoadStamps()
	{
		...
		AllStamps.Clear();
		List<PathAbstractions.AbstractedLocation> stampMaps = PathAbstractions.RwgStampsSearchPaths.GetAvailablePathsList(null, _ignoreDuplicateNames: true);
