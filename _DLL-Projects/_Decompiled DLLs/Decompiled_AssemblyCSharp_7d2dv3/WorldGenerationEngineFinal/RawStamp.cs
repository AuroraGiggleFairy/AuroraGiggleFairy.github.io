...
public class RawStamp
{
	...
	public delegate void SmoothAlpha_0000B63C_0024PostfixBurstDelegate(ref Data d, int _boxSize);

	[PublicizedFrom(EAccessModifier.Internal)]
	public static class SmoothAlpha_0000B63C_0024BurstDirectCall
	{
		...
		public unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(SmoothAlpha_0000B63C_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		[PublicizedFrom(EAccessModifier.Private)]
		static SmoothAlpha_0000B63C_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	{
		SmoothAlpha_0000B63C_0024BurstDirectCall.Invoke(ref d, _boxSize);
	}
