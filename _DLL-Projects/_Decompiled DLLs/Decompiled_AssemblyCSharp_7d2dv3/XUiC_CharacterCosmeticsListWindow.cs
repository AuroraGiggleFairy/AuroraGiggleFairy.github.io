...
public class XUiC_CharacterCosmeticsListWindow : XUiController
{
	...
	public void ApplySelected()
	{
		...
		if (flag)
		{
			xui.PlayerEquipment.Equipment.ApplyTempCosmeticSlot();
	...
	public void BtnApplySet_OnPressed(XUiController _sender, int _mouseButton)
	{
		...
		ItemClassArmor itemClassArmor = xui.PlayerEquipment.Equipment.tempCosmeticSlot as ItemClassArmor;
		Equipment equipment = xui.PlayerEquipment.Equipment;
		if (itemClassArmor == null)
		{
			if (xui.PlayerEquipment.Equipment.tempCosmeticSlot == ItemClass.MissingItem)
			{
				xui.PlayerEquipment.Equipment.SetCosmeticSlot(0, -1);
				xui.PlayerEquipment.Equipment.SetCosmeticSlot(1, -1);
				xui.PlayerEquipment.Equipment.SetCosmeticSlot(2, -1);
				xui.PlayerEquipment.Equipment.SetCosmeticSlot(3, -1);
			}
			else
			{
	...
	public void SetEmptyCosmeticForCurrentCategory()
	{
		cosmeticGrid.SetEmptyCosmetic();
	}
	...
	public void CategoryList_CategoryChanged(XUiC_CategoryEntry _categoryEntry)
	{
		...
		if (xui.playerUI.entityPlayer.equipment.GetSlotItem((int)selectedSlot) == null)
		{
		...
		IsDirty = true;
		xui.PlayerEquipment.Equipment.ClearTempCosmeticSlot();
		((XUiC_CharacterCosmeticWindowGroup)base.WindowGroup.Controller).ResetPreview();
	}
