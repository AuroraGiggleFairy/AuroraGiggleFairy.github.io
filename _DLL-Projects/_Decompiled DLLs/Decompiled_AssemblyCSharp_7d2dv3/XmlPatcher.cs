...
public class XmlPatcher
{
	...
	static XmlPatcher()
	{
		...
		static void TypeFoundCallback(Type _type, bool _hasMultiple, XmlPatchMethodsClassAttribute _xmlPatchMethodsClassAttribute)
		{
			ReflectionHelpers.GetMethodsWithAttribute<XmlPatchMethodAttribute>(_type, MethodFoundCallback, _declaredOnly: true, _allowInstance: false);
			[PublicizedFrom(EAccessModifier.Internal)]
			static void MethodFoundCallback(MethodInfo _method, bool flag, XmlPatchMethodAttribute _xmlPatchMethodAttribute)
			{
