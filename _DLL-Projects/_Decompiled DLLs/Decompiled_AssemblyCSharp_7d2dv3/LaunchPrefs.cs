...
public static class LaunchPrefs
{
	...
	public static readonly ILaunchPref<string> UserDataFolder = Create(string.Empty, Parsers.STRING, "UserDataFolder");
	...
	public static readonly ILaunchPref<bool> EnableProps = Create(defaultValue: false, Parsers.BOOL, "EnableProps");

	public static readonly ILaunchPref<SaveStorageProvider> GameCoreSaveStorageProvider = Create(SaveStorageProvider.Blobs, EnumParsers<SaveStorageProvider>.CASE_INSENSITIVE, "GameCoreSaveStorageProvider");

	public static readonly ILaunchPref<bool> GameCoreBlobCache = Create(defaultValue: true, Parsers.BOOL, "GameCoreBlobCache");

	public static readonly ILaunchPref<bool> GameCoreBlobCacheProactive = Create(defaultValue: false, Parsers.BOOL, "GameCoreBlobCacheProactive");

	public static readonly ILaunchPref<int> GameCoreBlobOperationQueueMaxTotalSize = Create(PlatformOptimizations.DefaultGameCoreBlobOperationQueueMaxTotalSize, Parsers.INT, "GameCoreBlobOperationQueueMaxTotalSize");

	public static readonly ILaunchPref<string> RunAutomation = Create(string.Empty, Parsers.STRING, "RunAutomation");

	public static readonly ILaunchPref<string> SubmissionOverride = Create(string.Empty, Parsers.STRING, "SubmissionOverride");
