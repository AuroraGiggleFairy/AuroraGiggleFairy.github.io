...
public class GUIWindowConsole : GUIWindowUGUI
{
	...
	public void openConsole(string _logString)
	{
		...
		{
			windowManager.Open(this, _bModal: false);
		}
	}
	...
	public override void Update()
	{
		...
		if (playerActionsGUI != null)
		{
			...
			{
				ThreadManager.StartCoroutine(closeLater());
			}
	...
	{
		return instance ?? (instance = new GUIWindowConsole());
	}

	public static void Open()
	{
		LocalPlayerUI.primaryUI.windowManager.Open(instance, _bModal: false);
	}

	public static void Close()
	{
		LocalPlayerUI.primaryUI.windowManager.Close(instance);
	}

	public static bool IsOpen()
	{
		return LocalPlayerUI.primaryUI.windowManager.IsWindowOpen(instance);
	}

	public static void AddLines(List<string> _lines)
	{
		instance?.addLines(_lines);
	}
