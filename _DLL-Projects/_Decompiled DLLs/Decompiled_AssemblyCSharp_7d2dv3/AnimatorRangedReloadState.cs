...
public class AnimatorRangedReloadState : StateMachineBehaviour
{
	...
	public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
	{
		...
		if (actionData.invData.item.Properties.GetValue(ItemClass.PropSoundIdle) != null)
		{
			Manager.Stop(actionData.invData.holdingEntity.entityId, actionData.invData.item.Properties.GetValue(ItemClass.PropSoundIdle));
		}
	...
	public override void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
	{
		...
		{
			actionRanged.CompleteReload(actionData);
		}
