...
public class ItemActionDisconnectPower : ItemAction
{
	...
	public override void OnHoldingUpdate(ItemActionData _actionData)
	{
		...
		if (!hitInfo.bHitValid || hitInfo.tag.StartsWith("E_") || ((ItemActionConnectPower)_actionData.invData.holdingEntity.inventory.holdingItem.Actions[1]).DisconnectWire((ItemActionConnectPower.ConnectPowerData)_actionData.invData.holdingEntity.inventory.holdingItemData.actionData[1]) || !myInventoryData.invData.world.CanPlaceBlockAt(blockPos, myInventoryData.invData.world.gameManager.GetPersistentLocalPlayer()))
		{
			return;
		}
		...
		if (poweredBlock != null)
		{
			...
			{
				_actionData.invData.itemValue.UseTimes += EffectManager.GetValue(PassiveEffects.DegradationPerUse, _actionData.invData.itemValue, 1f, invData.holdingEntity, null, _actionData.invData.itemValue.ItemClass.ItemTags) * ItemAction.ItemDegradationModifier;
