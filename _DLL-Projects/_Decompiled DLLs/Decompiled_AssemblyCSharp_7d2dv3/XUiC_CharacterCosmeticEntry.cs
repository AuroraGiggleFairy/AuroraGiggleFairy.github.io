...
public class XUiC_CharacterCosmeticEntry : XUiController
{
	...
	public string Name
	{
		get
		{
			...
			case EntryTypes.Empty:
				return Localization.Get("xuiEmpty");
			case EntryTypes.Hide:
				return Localization.Get("xuiHide");
			}
			return Localization.Get("xuiCosmetics");
		}
	}
	...
	{
		base.OnOpen();
		xui.PlayerEquipment.Equipment.CosmeticUnlocked += Equipment_CosmeticUnlocked;
	}
	...
	public override void Update(float _dt)
	{
		if (IsDirty)
		{
			...
			bool isNavigatable = (base.ViewComponent.IsSnappable = entryType != EntryTypes.Item || (entryType == EntryTypes.Item && itemClass != null));
	...
	public (bool isUnlocked, EntitlementSetEnum set) IsUnlocked()
	{
		...
		return xui.PlayerEquipment.Equipment.HasCosmeticUnlocked(itemClass);
	}
	...
	public override bool GetBindingValueInternal(ref string value, string bindingName)
	{
		...
		case "tooltip":
			...
			case EntryTypes.Item:
				...
				break;
			case EntryTypes.Empty:
				value = Localization.Get("xuiEmpty");
				break;
			case EntryTypes.Hide:
				value = Localization.Get("xuiHide");
				break;
			}
			return true;
		default:
