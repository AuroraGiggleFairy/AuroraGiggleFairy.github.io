...
public class ItemActionUseOther : ItemAction
{
	...
	public override bool CanExecute(ItemActionData _actionData)
	{
		...
		if (Voxel.Raycast(feedInventoryData.invData.world, feedInventoryData.ray, distance, -538750989, 128, SphereRadius))
		{
		...
		{
			Voxel.Raycast(feedInventoryData.invData.world, feedInventoryData.ray, distance, -538488845, 128, SphereRadius);
		}
	...
	public override void ExecuteAction(ItemActionData _actionData, bool _bReleased)
	{
		...
		ItemAction.ExecuteBuffActions(getBuffActions(_actionData), holdingEntity.entityId, feedInventoryData.TargetEntity, isCritical: false, EnumBodyPartHit.None, null);
		...
		if (Consume)
		{
			if (_actionData.invData.itemValue.MaxUseTimes > 0 && _actionData.invData.itemValue.UseTimes + 1f < (float)_actionData.invData.itemValue.MaxUseTimes)
			{
				...
				itemValue.UseTimes += EffectManager.GetValue(PassiveEffects.DegradationPerUse, feedInventoryData.invData.itemValue, 1f, holdingEntity, null, _actionData.invData.itemValue.ItemClass.ItemTags) * ItemAction.ItemDegradationModifier;
