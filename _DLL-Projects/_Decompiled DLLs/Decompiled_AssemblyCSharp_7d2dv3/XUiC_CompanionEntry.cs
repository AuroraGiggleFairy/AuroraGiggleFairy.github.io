...
public class XUiC_CompanionEntry : XUiController
{
	...
	public override void Update(float _dt)
	{
		...
		{
			arrowRotation = ReturnRotation(xui.playerUI.entityPlayer, Companion);
	...
	public override bool GetBindingValueInternal(ref string value, string bindingName)
	{
		...
		case "healthmodifiedmax":
			if (Companion == null || xui.playerUI.entityPlayer.IsDead())
			{
				value = "0";
				return true;
			}
		...
		case "arrowcolor":
		{
			...
			int num = xui.playerUI.entityPlayer.Companions.IndexOf(Companion);
