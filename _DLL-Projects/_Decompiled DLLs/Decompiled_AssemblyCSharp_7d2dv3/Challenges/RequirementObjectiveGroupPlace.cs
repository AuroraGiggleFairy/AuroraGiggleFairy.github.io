...
public class RequirementObjectiveGroupPlace : BaseRequirementObjectiveGroup
{
	...
	public override bool HasPrerequisiteCondition()
	{
		...
		if (playerInventory.HasItem(ItemClass.GetItem(ItemID)) || CheckDragDropItem(uIForPlayer.xui.DragAndDropWindow.CurrentStack, ItemID))
		{
	...
	public override bool CheckPhaseStatus(int index)
	{
		...
		case 1:
			...
			{
				return !CheckDragDropItem(uIForPlayer.xui.DragAndDropWindow.CurrentStack, ItemID);
			}
			return false;
		case 2:
			if (playerInventory.HasItem(ItemClass.GetItem(ItemID)) || CheckDragDropItem(uIForPlayer.xui.DragAndDropWindow.CurrentStack, ItemID))
