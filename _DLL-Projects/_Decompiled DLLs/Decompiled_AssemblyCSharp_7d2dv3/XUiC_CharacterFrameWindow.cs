...
public class XUiC_CharacterFrameWindow : XUiController
{
	...
	{
		XUiC_CharacterCosmeticWindowGroup.Open(xui, EquipmentSlots.Head);
	}
	...
	public void PreviewFrame_OnPress(XUiController _sender, int _mouseButton)
	{
		...
		if (!currentStack.IsEmpty() && currentStack.itemValue.ItemClass.CanEquip())
		{
			ItemStack itemStack = xui.PlayerEquipment.EquipItem(currentStack);
	...
	public override bool GetBindingValueInternal(ref string _value, string _bindingName)
	{
		...
		case "playerlootstage":
			...
			return true;
		case "gear_visible":
			_value = World.BiomeProgressionEnabled.ToString();
			return true;
		case "clothing_visible":
			_value = (World.TemperatureSurvival || World.StormFrequency > 0f).ToString();
			return true;
		default:
	...
	public string GetStatValue(int _index)
	{
		...
		return XUiM_Player.GetStatValue(displayInfoEntry.StatType, xui.playerUI.entityPlayer, displayInfoEntry, currentMovementTag);
	}
}
