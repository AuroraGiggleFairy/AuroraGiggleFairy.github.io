...
public class XUiC_PartyEntry : XUiController
{
	...
	public override void Init()
	{
		...
		if (childById2 != null)
		{
			...
			iconSpriteSize = new Vector2(iconSprite1.Size.x, iconSprite1.Size.y);
		}
	...
	public override void Update(float _dt)
	{
		...
		{
			arrowRotation = ReturnRotation(xui.playerUI.entityPlayer, Player);
		...
		if (Player.TwitchActionsEnabled == EntityPlayer.TwitchActionsStates.TempDisabledEnding)
		{
			...
			if (Player.Party.Leader == Player)
			{
				...
				iconSprite2.Size = new Vector2i(iconSpriteSize * num2);
			}
			else
			{
				iconSprite1.Color = Color.Lerp(defaultIconColor, iconBlinkColor, num * 4f);
				iconSprite1.Size = new Vector2i(iconSpriteSize * num2);
			}
		}
		else
		{
	...
	public override bool GetBindingValueInternal(ref string value, string bindingName)
	{
		...
		case "healthmodifiedmax":
			if (Player == null || xui.playerUI.entityPlayer.IsDead())
			{
				value = "0";
				return true;
			}
