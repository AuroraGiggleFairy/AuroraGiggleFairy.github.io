...
public class XUiC_SkillAttributeInfoWindow : XUiC_InfoWindow
{
	...
	public ProgressionValue CurrentSkill
	{
		...
		get
		{
			if (xui.SelectedSkill == null || !xui.SelectedSkill.ProgressionClass.IsAttribute)
			{
				return null;
			}
	...
	public override void Update(float _dt)
	{
		...
		if (base.ViewComponent.IsActiveInHierarchy && CurrentSkill != null && !xui.playerUI.windowManager.IsInputActive() && ((PlatformManager.NativePlatform.Input.CurrentInputStyle != PlayerInputManager.InputStyle.Keyboard && xui.playerUI.playerInput.GUIActions.Inspect.WasPressed) || (PlatformManager.NativePlatform.Input.CurrentInputStyle == PlayerInputManager.InputStyle.Keyboard && xui.playerUI.playerInput.GUIActions.DPad_Up.WasPressed)))
		{
			foreach (XUiC_SkillAttributeLevel levelEntry in levelEntries)
			{
