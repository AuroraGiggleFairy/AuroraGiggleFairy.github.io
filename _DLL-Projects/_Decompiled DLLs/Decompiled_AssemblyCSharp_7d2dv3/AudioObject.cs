...
public class AudioObject
{
	...
	public bool PlayConditionPasses()
	{
		...
		case Trigger.Dusk:
		{
			bool flag5 = EffectManager.GetValue(PassiveEffects.NoTimeDisplay, null, 0f, primaryPlayer) == 1f || !SandboxOptionManager.GetBool(global::SandboxOptions.SandboxOptions.ShowDayTime) || flag2 || flag3;
		...
		case Trigger.Dawn:
		{
			bool flag6 = EffectManager.GetValue(PassiveEffects.NoTimeDisplay, null, 0f, primaryPlayer) == 1f || !SandboxOptionManager.GetBool(global::SandboxOptions.SandboxOptions.ShowDayTime) || flag2 || flag3;
