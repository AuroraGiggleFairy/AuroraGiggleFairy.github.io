...
public class ConsoleCmdGiveXp : ConsoleCmdAbstract
{
	...
	public override void Execute(List<string> _params, CommandSenderInfo _senderInfo)
	{
		...
		{
			NetPackageEntityAddExpClient package = NetPackageManager.GetPackage<NetPackageEntityAddExpClient>().Setup(value.entityId, result2, Progression.XPTypes.Debug, null);
