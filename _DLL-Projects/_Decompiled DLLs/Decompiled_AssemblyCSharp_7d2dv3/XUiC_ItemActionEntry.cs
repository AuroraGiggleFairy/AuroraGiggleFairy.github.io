...
public class XUiC_ItemActionEntry : XUiController
{
	...
	public BaseItemActionEntry ItemActionEntry
	{
		...
		set
		{
			...
			if (itemActionEntry != null)
			{
				PlayerAction action = itemActionEntry.ShortCut switch
				{
					BaseItemActionEntry.GamepadShortCut.DPadUp => xui.playerUI.playerInput.GUIActions.DPad_Up, 
					BaseItemActionEntry.GamepadShortCut.DPadLeft => xui.playerUI.playerInput.GUIActions.DPad_Left, 
					BaseItemActionEntry.GamepadShortCut.DPadRight => xui.playerUI.playerInput.GUIActions.DPad_Right, 
					BaseItemActionEntry.GamepadShortCut.DPadDown => xui.playerUI.playerInput.GUIActions.DPad_Down, 
					_ => null, 
				};
				gamepadIcon.Action = action;
				keyboardButton.Text = action.GetBindingString(_forController: false, PlayerInputManager.InputStyle.Undefined, XUiUtils.EmptyBindingStyle.EmptyString, XUiUtils.DisplayStyle.KeyboardWithAngleBrackets);
	...
	{
		if (isOver && !background.UiTransformIsHovered)
		{
			background.Color = defaultBackgroundColor;
			background.SpriteName = "menu_empty";
			isOver = false;
	...
	public override bool GetBindingValueInternal(ref string value, string bindingName)
	{
		...
		case "statuscolor":
			...
			return true;
		case "inspectheld":
			value = ((itemActionEntry != null && xui.playerUI.playerInput.GUIActions.Inspect.IsPressed) ? "true" : "false");
			return true;
		default:
