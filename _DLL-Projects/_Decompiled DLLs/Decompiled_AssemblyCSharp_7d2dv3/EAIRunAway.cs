...
public abstract class EAIRunAway : EAIBase
{
	...
	public override void Start()
	{
		...
		string soundAlert = theEntity.GetSoundAlert();
		if (soundAlert != null)
		{
			theEntity.PlayOneShot(soundAlert);
		}
	}
	...
	{
		return string.Format("{0}, flee {1}, timeout {2}, {3}", base.ToString(), fleeTicks, timeoutTicks, (enemy != null) ? enemy.GetDebugName() : "");
	}
}
