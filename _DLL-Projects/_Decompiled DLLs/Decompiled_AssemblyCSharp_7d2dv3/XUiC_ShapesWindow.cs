...
public class XUiC_ShapesWindow : XUiController
{
	...
	{
		List<string> favoriteShapes = xui.playerUI.entityPlayer.favoriteShapes;
		currentItems.Clear();
	...
	public override void OnOpen()
	{
		...
		xui.CalloutWindow.AddCallout(UIUtils.ButtonIcon.FaceButtonNorth, "igcoToggleFavorite", XUiC_GamepadCalloutWindow.CalloutType.MenuShortcuts);
