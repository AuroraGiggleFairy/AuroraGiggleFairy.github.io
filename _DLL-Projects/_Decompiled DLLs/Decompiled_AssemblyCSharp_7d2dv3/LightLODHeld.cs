...
public class LightLODHeld : LightLOD
{
	...
	[NonSerialized]
	[PublicizedFrom(EAccessModifier.Private)]
	public const int cMask = -554734606;
	...
	public void LateUpdate()
	{
		...
		position2.y += 0.5f;
		if (Physics.Raycast(position2, Vector3.up, out var hitInfo, 1.4f, -554734606))
		{
		...
		if (Physics.SphereCast(position2, 0.15f, vector, out hitInfo, magnitude - 0.15f - 0.02f + 0.15f, -554734606))
		{
