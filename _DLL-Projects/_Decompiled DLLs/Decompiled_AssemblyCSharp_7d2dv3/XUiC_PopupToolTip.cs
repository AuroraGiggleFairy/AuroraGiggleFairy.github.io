...
public class XUiC_PopupToolTip : XUiController
{
	...
	public override void Init()
	{
		...
		toolbelt = xui.GetChildByType<XUiC_Toolbelt>();
	}
	...
	public override void Update(float _dt)
	{
		...
		{
			if ((xui.playerUI != null && xui.playerUI.entityPlayer != null && xui.playerUI.entityPlayer.IsDead()) || !xui.playerUI.windowManager.IsHUDEnabled())
			{
			...
			if (!pauseToolTips)
			{
				...
				if (countdownTooltip.HasPassed() && xui.IsReady && !XUiC_SubtitlesDisplay.IsDisplaying)
				{
					DisplayTooltipText();
				}
			}
