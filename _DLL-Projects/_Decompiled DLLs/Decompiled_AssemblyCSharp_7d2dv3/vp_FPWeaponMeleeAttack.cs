...
public class vp_FPWeaponMeleeAttack : vp_Component
{
	...
	public void UpdateAttack()
	{
		...
		vp_Timer.In(SwingDelay, [PublicizedFrom(EAccessModifier.Private)] () =>
		{
			...
			{
				Physics.SphereCast(new Ray(new Vector3(m_Controller.Transform.position.x, m_Camera.Transform.position.y, m_Controller.Transform.position.z), m_Camera.Transform.forward), DamageRadius, out var hitInfo, DamageRange, -538750989);
