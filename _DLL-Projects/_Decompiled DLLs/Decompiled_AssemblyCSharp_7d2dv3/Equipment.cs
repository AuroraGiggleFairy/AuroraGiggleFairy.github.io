...
public class Equipment
{
	...
	public void SetCosmeticSlot(ItemClassArmor itemClass)
	{
		...
		if (!(CosmeticSlots[equipSlot] is ItemClassArmor itemClassArmor) || !(itemClassArmor.ArmorGroup[0] == itemClass.ArmorGroup[0]))
		{
			CosmeticSlots[equipSlot] = itemClass;
			if ((bool)m_entity && !m_entity.isEntityRemote)
			{
				m_entity.bPlayerEquipmentChanged = true;
			}
		}
	}
	...
	public static void SetupCosmeticMapping()
	{
		...
		AddCosmeticMapping(135, "armorWinterHelmet");
		AddCosmeticMapping(136, "armorWinterOutfit");
		AddCosmeticMapping(137, "armorWinterGloves");
		AddCosmeticMapping(138, "armorWinterBoots");
		AddCosmeticMapping(139, "armorWorkingStiffHelmet");
		AddCosmeticMapping(140, "armorWorkingStiffOutfit");
		AddCosmeticMapping(141, "armorWorkingStiffGloves");
		AddCosmeticMapping(142, "armorWorkingStiffBoots");
		AddCosmeticMapping(143, "armorCasualOutfit");
		AddCosmeticMapping(144, "armorCasualGloves");
		AddCosmeticMapping(145, "armorCasualBoots");
		AddCosmeticMapping(146, "armorBeachHelmet");
		AddCosmeticMapping(147, "armorBeachOutfit");
		AddCosmeticMapping(148, "armorBeachGloves");
		AddCosmeticMapping(149, "armorBeachBoots");
		AddCosmeticMapping(150, "armorBeachHelmet02");
	}
}
