...
public class XUiC_DiscordPendingList : XUiC_List<XUiC_DiscordPendingList.PendingEntry>
{
	...
	public class DiscordPendingListEntryController : XUiC_ListEntry
	{
		...
		[PublicizedFrom(EAccessModifier.Private)]
		public PendingEntry.EEntryType bindingEntryType()
		{
			return entryData?.EntryType ?? PendingEntry.EEntryType.Invite;
		}
	}
