...
public class vp_BodyAnimator : MonoBehaviour
{
	...
	{
		Physics.SphereCast(new Ray(Transform.position + Vector3.up * 0.5f, Vector3.down), 0.4f, out m_GroundHit, 1f, 1084850184);
	...
	{
		vp_FPController vp_FPController2 = UnityEngine.Object.FindAnyObjectByType<vp_FPController>();
