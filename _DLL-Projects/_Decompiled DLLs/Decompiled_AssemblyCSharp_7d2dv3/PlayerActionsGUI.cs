...
public class PlayerActionsGUI : PlayerActionsBase
{
	...
	public PlayerAction MiddleClick;
	...
	public PlayerOneAxisAction BumperAxis;
	...
	public override void CreateActions()
	{
		...
		MiddleClick = CreatePlayerAction("GUI Middle Click");
		MiddleClick.UserData = new PlayerActionData.ActionUserData("inpActGuiMiddleclick", null, PlayerActionData.GroupUI, PlayerActionData.EAppliesToInputType.KbdMouseOnly);
		...
		BumperAxis = CreateOneAxisPlayerAction(WindowPagingRight, WindowPagingLeft);
	...
	public override void CreateDefaultKeyboardBindings()
	{
		...
		MiddleClick.AddDefaultBinding(Mouse.MiddleButton);
