...
public class Jiggle : MonoBehaviour
{
	...
	{
		return $"{base.gameObject.name} - enabled: {base.isActiveAndEnabled}, m_Initialized: {m_Initialised}, m_RestLocalRotation: {m_RestLocalRotation}, UseCenterOfMass: {UseCenterOfMass}, CenterOfMass: {CenterOfMass}, Hinge: {Hinge}, HingeAngle: {HingeAngle}, UseAngleLimit: {UseAngleLimit}, AngleLimit: {AngleLimit}";
	}
}
