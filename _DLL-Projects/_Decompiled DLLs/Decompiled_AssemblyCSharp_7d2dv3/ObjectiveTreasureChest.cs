...
public class ObjectiveTreasureChest : BaseObjective
{
	...
	[PublicizedFrom(EAccessModifier.Private)]
	public string radiusReductionMessage = "ttTreasureRadiusReduced";
	...
	public static string PropRadiusReductionMessage = "radius_reduction_message";
	...
	[PublicizedFrom(EAccessModifier.Private)]
	public void Current_ContainerOpened(Vector3i containerLocation, ITileEntityLootable lootTE)
	{
		if (!base.Complete && neededContainerLocation.x == containerLocation.x && neededContainerLocation.y == containerLocation.y && neededContainerLocation.z == containerLocation.z && base.OwnerQuest.CheckRequirements())
		{
			base.CurrentValue = 5;
			if (projector != null)
			{
	...
	public bool AddToDestroyCount()
	{
		if (CurrentRadius != 0)
		{
			...
			if (CurrentRadius != lastRadius)
			{
				...
				if (radiusReductionMessage != "")
				{
					GameManager.ShowTooltip(base.OwnerQuest.OwnerJournal.OwnerPlayer, Localization.Get(radiusReductionMessage));
				}
	...
	public override void CopyValues(BaseObjective objective)
	{
		...
		obj.radiusReductionMessage = radiusReductionMessage;
	...
	public override void ParseProperties(DynamicProperties properties)
	{
		...
		properties.ParseString(PropRadiusReductionMessage, ref radiusReductionMessage);
