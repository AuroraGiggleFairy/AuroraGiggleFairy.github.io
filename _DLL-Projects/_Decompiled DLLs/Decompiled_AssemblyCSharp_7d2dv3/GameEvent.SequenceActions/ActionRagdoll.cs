...
public class ActionRagdoll : ActionBaseTargetAction
{
	...
	public override ActionCompleteStates PerformTargetAction(Entity target)
	{
		...
		if (entityAlive != null)
		{
			...
			_dmResponse.StunDuration = GameEventManager.GetFloatValue(entityAlive, stunDurationText, 1f);
			_dmResponse.Source = new DamageSource(EnumDamageSource.External, EnumDamageTypes.Bashing);
