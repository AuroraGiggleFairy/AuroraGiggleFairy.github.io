...
public class ActionExplodeTarget : ActionBaseTargetAction
{
	...
	public override ActionCompleteStates PerformTargetAction(Entity target)
	{
		...
		if (entityAlive != null)
		{
			...
			GameManager.Instance.ExplosionServer(entityAlive.position, entityAlive.GetBlockPosition(), entityAlive.qrotation, explosionData, -1, 0.1f, _bRemoveBlockAtExplPosition: false);
		}
