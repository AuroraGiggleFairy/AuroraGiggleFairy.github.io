...
public class ActionExplodePosition : BaseAction
{
	...
	public override ActionCompleteStates OnPerformAction()
	{
		...
		GameManager.Instance.ExplosionServer(targetPosition, World.worldToBlockPos(targetPosition), Quaternion.identity, explosionData, -1, 0.1f, _bRemoveBlockAtExplPosition: false);
