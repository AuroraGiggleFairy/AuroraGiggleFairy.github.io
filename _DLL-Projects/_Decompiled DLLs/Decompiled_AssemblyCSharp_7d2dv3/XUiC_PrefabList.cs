...
public class XUiC_PrefabList : XUiController
{
	...
	public override void Init()
	{
		...
		fileList.ListEntryDoubleClicked += FileList_OnEntryDoubleClicked;
	...
	[PublicizedFrom(EAccessModifier.Private)]
	public void GroupListSelectionChanged(XUiC_List<XUiC_PrefabGroupList.PrefabGroupEntry> _list, XUiC_PrefabGroupList.PrefabGroupEntry _previousEntry, XUiC_PrefabGroupList.PrefabGroupEntry _newEntry)
	{
		string groupFilter = null;
		if (_newEntry != null)
		{
			groupFilter = _newEntry.filterString;
		}
	...
	[PublicizedFrom(EAccessModifier.Private)]
	public void FileListOnPageNumberChanged(XUiC_List<XUiC_PrefabFileList.PrefabFileEntry> _list, int _pageNumber)
	{
		fileList.SelectedEntryIndex = fileList.Page * fileList.PageLength;
	}

	[PublicizedFrom(EAccessModifier.Private)]
	public void FileList_SelectionChanged(XUiC_List<XUiC_PrefabFileList.PrefabFileEntry> _list, XUiC_PrefabFileList.PrefabFileEntry _previousEntry, XUiC_PrefabFileList.PrefabFileEntry _newEntry)
	{
	...
	[PublicizedFrom(EAccessModifier.Private)]
	public void updatePreview(XUiC_PrefabFileList.PrefabFileEntry _newEntry)
	{
		...
		if (_newEntry != null)
		{
			string path = _newEntry.location.FullPathNoExtension + ".jpg";
	...
	[PublicizedFrom(EAccessModifier.Private)]
	public void FileList_OnEntryDoubleClicked(XUiC_List<XUiC_PrefabFileList.PrefabFileEntry> _list, XUiC_PrefabFileList.PrefabFileEntry _entry)
	{
	...
	{
		if (fileList.SelectedEntryData != null)
		{
			XUiC_SaveDirtyPrefab.Show(xui, loadPrefab);
		}
	}
	...
	{
		xui.playerUI.windowManager.Open(XUiC_InGameMenuWindow.ID, _bModal: true);
		if (_action == XUiC_SaveDirtyPrefab.ESelectedAction.Cancel)
		{
			return;
		}
		PathAbstractions.AbstractedLocation location = fileList.SelectedEntryData.location;
	...
	public void BtnPropertiesOnOnPressed(XUiController _sender, int _mouseButton)
	{
		...
		{
			XUiC_PrefabPropertiesEditor.Show(xui, XUiC_PrefabPropertiesEditor.EPropertiesFrom.LoadedPrefab, PathAbstractions.AbstractedLocation.None);
		}
		else
		{
			XUiC_PrefabPropertiesEditor.Show(xui, XUiC_PrefabPropertiesEditor.EPropertiesFrom.FileBrowserSelection, location);
		}
	}
	...
	public void BtnLoadIntoPrefabOnOnPressed(XUiController _sender, int _mouseButton)
	{
		...
		xui.playerUI.windowManager.Close(XUiC_InGameMenuWindow.ID);
	}
	...
	{
		XUiC_SaveDirtyPrefab.Show(xui, newPrefab);
	}
	...
	public void newPrefab(XUiC_SaveDirtyPrefab.ESelectedAction _action)
	{
		...
		{
			xui.playerUI.windowManager.Open(XUiC_CreatePoi.ID, _bModal: true);
		}
	}
	...
	{
		GameUtils.DirEightWay closestDirection = GameUtils.GetClosestDirection(xui.playerUI.entityPlayer.rotation.y, _limitTo90Degress: true);
	...
	public override void OnOpen()
	{
		...
		if (fileList.SelectedEntryData != null)
		{
			location = fileList.SelectedEntryData.location;
		}
		if (groupList.SelectedEntryData != null)
		{
			string name = groupList.SelectedEntryData.name;
	...
	public override void Update(float _dt)
	{
		...
		btnLoadIntoPrefab.Enabled = fileList.SelectedEntryData != null && blockToolSelection != null && blockToolSelection.SelectionActive && dynamicPrefabDecorator != null;
		btnApplyLoadedPrefab.Enabled = prefabInstance != null && !prefabInstance.IsBBInSyncWithPrefab();
		btnWorldPlacePrefab.Enabled = blockToolSelection != null && blockToolSelection.SelectionActive && fileList.SelectedEntryData != null;
		btnWorldReplacePrefab.Enabled = prefabInstance != null && fileList.SelectedEntryData != null;
