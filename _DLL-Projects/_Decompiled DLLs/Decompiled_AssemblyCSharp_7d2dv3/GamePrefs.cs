...
public class GamePrefs
{
	...
	[PublicizedFrom(EAccessModifier.Private)]
	public object[] propertyValues = new object[314];
	...
	public static void initPropertyDecl()
	{
		...
		s_propertyList = new PropertyDecl[291]
		{
			...
			new PropertyDecl(EnumGamePrefs.OptionsGfxSignQuality, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX, EnumType.Int, 2, null, null),
			...
			new PropertyDecl(EnumGamePrefs.UNUSED_OptionsPlayerModel, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.String, "playerMale", null, null),
			...
			new PropertyDecl(EnumGamePrefs.DayNightLength, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Int, 60, 10, 120),
			...
			new PropertyDecl(EnumGamePrefs.AirDropFrequency, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Int, 3, 0, 6),
			...
			new PropertyDecl(EnumGamePrefs.ResetUnprotectedChunks, DeviceFlag.None, EnumType.Int, 0, null, null),
			...
			new PropertyDecl(EnumGamePrefs.JarRefund, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Int, 60, null, null),
			new PropertyDecl(EnumGamePrefs.SandboxPreset, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.String, "", null, null),
			new PropertyDecl(EnumGamePrefs.SandboxCode, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.String, "", null, null),
			...
			new PropertyDecl(EnumGamePrefs.OptionsCrosshairEnabled, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Bool, true, null, null),
			new PropertyDecl(EnumGamePrefs.OptionsCrosshairScale, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Float, 1f, null, null),
			new PropertyDecl(EnumGamePrefs.OptionsCrosshairColor, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Int, 0, null, null),
			new PropertyDecl(EnumGamePrefs.OptionsCrosshairOpacity, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Float, 1f, null, null),
			new PropertyDecl(EnumGamePrefs.OptionsCrosshairADS, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Bool, true, null, null),
			new PropertyDecl(EnumGamePrefs.OptionsCrosshairDot3P, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Bool, true, null, null),
			new PropertyDecl(EnumGamePrefs.OptionsCrosshairThickness, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Float, 0.2f, null, null),
			new PropertyDecl(EnumGamePrefs.OptionsCrosshairRangedEnabled, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Bool, true, null, null),
			new PropertyDecl(EnumGamePrefs.GameSaveStorageType, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Int, UserDataStorageType.DeviceLocal, null, null),
			new PropertyDecl(EnumGamePrefs.UserWorldStorageType, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Int, UserDataStorageType.DeviceLocal, null, null),
			new PropertyDecl(EnumGamePrefs.DiscordFirstTimeInfoShown, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Bool, false, null, null),
			new PropertyDecl(EnumGamePrefs.DiscordDisabled, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Bool, false, null, null),
			new PropertyDecl(EnumGamePrefs.DiscordLastAccountType, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Int, 0, null, null),
			new PropertyDecl(EnumGamePrefs.DiscordAccessToken, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.String, null, null, null),
			new PropertyDecl(EnumGamePrefs.DiscordRefreshToken, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.String, null, null, null),
			new PropertyDecl(EnumGamePrefs.DiscordSelectedOutputDevice, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.String, "default", null, null),
			new PropertyDecl(EnumGamePrefs.DiscordSelectedInputDevice, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.String, "default", null, null),
			new PropertyDecl(EnumGamePrefs.DiscordOutputVolume, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Float, 1f, null, null),
			new PropertyDecl(EnumGamePrefs.DiscordInputVolume, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Float, 1f, null, null),
			new PropertyDecl(EnumGamePrefs.DiscordVoiceModePtt, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Bool, false, null, null),
			new PropertyDecl(EnumGamePrefs.DiscordVoiceVadModeAuto, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Bool, true, null, null),
			new PropertyDecl(EnumGamePrefs.DiscordVoiceVadThreshold, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Int, -60, null, null),
			new PropertyDecl(EnumGamePrefs.DiscordDmPrivacyMode, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Bool, true, null, null),
			new PropertyDecl(EnumGamePrefs.DiscordAutoJoinVoiceMode, DeviceFlag.StandaloneWindows | DeviceFlag.StandaloneLinux | DeviceFlag.StandaloneOSX | DeviceFlag.XBoxSeriesS | DeviceFlag.XBoxSeriesX | DeviceFlag.PS5, EnumType.Int, 0, null, null),
			new PropertyDecl(EnumGamePrefs.GameWorldLocationType, DeviceFlag.None, EnumType.Int, PathAbstractions.EAbstractedLocationType.None, null, null)
		};
	}
	...
	public static float GetFloat(EnumGamePrefs _eProperty)
	{
		try
		{
			BaseSandboxOption baseSandboxOption = sandboxReferences[(int)_eProperty];
	...
	{
		sandboxReferences = new BaseSandboxOption[314];
		for (int i = 0; i < s_propertyList.Length; i++)
		{
			PropertyDecl propertyDecl = s_propertyList[i];
			if (Enum.TryParse<global::SandboxOptions.SandboxOptions>(propertyDecl.name.ToString(), out var result))
			{
				sandboxReferences[(int)propertyDecl.name] = SandboxOptionManager.GetOption(result);
			}
		}
	}
