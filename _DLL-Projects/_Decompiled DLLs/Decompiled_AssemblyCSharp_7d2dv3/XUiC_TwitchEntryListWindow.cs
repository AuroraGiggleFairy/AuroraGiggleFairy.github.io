...
public class XUiC_TwitchEntryListWindow : XUiController
{
	...
	public override bool GetBindingValueInternal(ref string value, string bindingName)
	{
		...
		case "headertitle":
			...
			case ListTypes.Actions:
			{
				string text3 = ((categoryList == null) ? "" : (categoryList.CurrentCategory?.CategoryDisplayName ?? ""));
			...
			case ListTypes.ActionHistory:
			{
				string text2 = ((actionHistoryCategoryList == null) ? "" : (actionHistoryCategoryList.CurrentCategory?.CategoryDisplayName ?? ""));
