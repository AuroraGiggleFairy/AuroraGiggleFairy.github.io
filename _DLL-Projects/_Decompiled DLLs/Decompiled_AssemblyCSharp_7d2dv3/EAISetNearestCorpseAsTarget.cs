...
public class EAISetNearestCorpseAsTarget : EAITarget
{
	...
	{
		base.SetData(data);
		if (data.TryGetValue("flags", out var value))
		{
			EntityClass.ParseEntityFlags(value, ref targetFlags);
		}
	...
	public override bool CanExecute()
	{
		...
		for (int i = 0; i < entityList.Count; i++)
		{
			...
			if ((bool)entityAlive2 && entityAlive2.IsDead() && (ZombiesEatAnimalCorpses || (!(entityAlive2 is EntityAnimal) && !(entityAlive2 is EntityEnemyAnimal))))
			{
