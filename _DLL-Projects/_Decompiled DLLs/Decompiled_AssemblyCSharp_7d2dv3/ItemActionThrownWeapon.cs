...
public class ItemActionThrownWeapon : ItemActionThrowAway
{
	...
	public override void throwAway(MyInventoryData _actionData)
	{
		...
		{
			float num = EffectManager.GetValue(PassiveEffects.StaminaLoss, _actionData.invData.holdingEntity.inventory.holdingItemItemValue, 2f, _actionData.invData.holdingEntity, null, _actionData.invData.holdingEntity.inventory.holdingItem.ItemTags | FastTags<TagGroup.Global>.Parse((_actionData.indexInEntityOfAction == 0) ? "primary" : "secondary")) * ItemActionAttack.StaminaUsageMultiplier;
			_actionData.invData.holdingEntity.Stats.Stamina.Value -= num;
		}
