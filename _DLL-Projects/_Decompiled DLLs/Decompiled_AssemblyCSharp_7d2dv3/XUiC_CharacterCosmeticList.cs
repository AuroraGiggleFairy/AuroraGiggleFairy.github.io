...
public class XUiC_CharacterCosmeticList : XUiController
{
	...
	{
		base.Update(_dt);
		xui.playerUI.entityPlayer.AimingGun = false;
	...
	public void UpdateCallouts(bool _holdingItem)
	{
		...
		XUiC_GamepadCalloutWindow calloutWindow = xui.CalloutWindow;
	...
	public void SetCosmeticList(List<ItemClass> _currentItems, EquipmentSlots slot)
	{
		...
		ItemClass cosmeticSlot = xui.PlayerEquipment.Equipment.GetCosmeticSlot((int)slot, useTemporary: false);
		SelectedEntry = null;
		int num = 0;
	...
	public void SetTempCosmeticSlot(XUiC_CharacterCosmeticEntry _entry)
	{
		if (_entry != null)
		{
			...
			case XUiC_CharacterCosmeticEntry.EntryTypes.Item:
				xui.PlayerEquipment.Equipment.SetTempCosmeticSlot(_entry.Index, _entry.ItemClass);
				break;
			case XUiC_CharacterCosmeticEntry.EntryTypes.Empty:
				xui.PlayerEquipment.Equipment.SetTempCosmeticSlot(_entry.Index, null);
				break;
			case XUiC_CharacterCosmeticEntry.EntryTypes.Hide:
				xui.PlayerEquipment.Equipment.SetTempCosmeticSlot(_entry.Index, ItemClass.MissingItem);
				break;
			}
