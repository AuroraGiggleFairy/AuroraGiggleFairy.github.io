...
public static class StringParsers
{
	...
	public static bool TryParseSInt8(string _input, out sbyte _result, int _startIndex, int _endIndex = -1, NumberStyles _style = NumberStyles.Integer)
	{
	...
	public static bool TryParseUInt8(string _input, out byte _result, int _startIndex, int _endIndex = -1, NumberStyles _style = NumberStyles.Integer)
	{
	...
	public static bool TryParseSInt8(string _input, out sbyte _result)
	{
		return TryParseSInt8(_input, out _result, 0);
	}

	[XuiXmlAttributeConverter]
	public static bool TryParseUInt8(string _input, out byte _result)
	{
		return TryParseUInt8(_input, out _result, 0);
	}
	...
	public static bool TryParseSInt16(string _input, out short _result, int _startIndex, int _endIndex = -1, NumberStyles _style = NumberStyles.Integer)
	{
		if (!internalParseInt64(_input, _style, _tryParse: true, out var _resultSigned, out var _, out var _, _signedResult: true, _startIndex, _endIndex))
		{
			_result = 0;
	...
	public static bool TryParseUInt16(string _input, out ushort _result, int _startIndex, int _endIndex = -1, NumberStyles _style = NumberStyles.Integer)
	{
		if (!internalParseInt64(_input, _style, _tryParse: true, out var _, out var _resultUnsigned, out var _, _signedResult: false, _startIndex, _endIndex))
		{
			_result = 0;
	...
	[XuiXmlAttributeConverter]
	public static bool TryParseSInt16(string _input, out short _result)
	{
		return TryParseSInt16(_input, out _result, 0);
	}

	[XuiXmlAttributeConverter]
	public static bool TryParseUInt16(string _input, out ushort _result)
	{
		return TryParseUInt16(_input, out _result, 0);
	}
	...
	public static bool TryParseSInt32(string _input, out int _result, int _startIndex, int _endIndex = -1, NumberStyles _style = NumberStyles.Integer)
	{
		if (!internalParseInt64(_input, _style, _tryParse: true, out var _resultSigned, out var _, out var _, _signedResult: true, _startIndex, _endIndex))
		{
			_result = 0;
	...
	public static bool TryParseUInt32(string _input, out uint _result, int _startIndex, int _endIndex = -1, NumberStyles _style = NumberStyles.Integer)
	{
		if (!internalParseInt64(_input, _style, _tryParse: true, out var _, out var _resultUnsigned, out var _, _signedResult: false, _startIndex, _endIndex))
		{
			_result = 0u;
	...
	[XuiXmlAttributeConverter]
	public static bool TryParseSInt32(string _input, out int _result)
	{
		return TryParseSInt32(_input, out _result, 0);
	}

	[XuiXmlAttributeConverter]
	public static bool TryParseUInt32(string _input, out uint _result)
	{
		return TryParseUInt32(_input, out _result, 0);
	}
	...
	public static bool TryParseSInt64(string _input, out long _result, int _startIndex, int _endIndex = -1, NumberStyles _style = NumberStyles.Integer)
	{
		if (!internalParseInt64(_input, _style, _tryParse: true, out var _resultSigned, out var _, out var _, _signedResult: true, _startIndex, _endIndex))
		{
			_result = 0L;
	...
	public static bool TryParseUInt64(string _input, out ulong _result, int _startIndex, int _endIndex = -1, NumberStyles _style = NumberStyles.Integer)
	{
		if (!internalParseInt64(_input, _style, _tryParse: true, out var _, out var _resultUnsigned, out var _, _signedResult: false, _startIndex, _endIndex))
		{
			_result = 0uL;
	...
	[XuiXmlAttributeConverter]
	public static bool TryParseSInt64(string _input, out long _result)
	{
		return TryParseSInt64(_input, out _result, 0);
	}

	[XuiXmlAttributeConverter]
	public static bool TryParseUInt64(string _input, out ulong _result)
	{
		return TryParseUInt64(_input, out _result, 0);
	}
	...
	public static bool TryParseFloat(string _input, out float _result, int _startIndex, int _endIndex = -1, NumberStyles _style = NumberStyles.Any)
	{
	...
	[XuiXmlAttributeConverter]
	public static bool TryParseFloat(string _input, out float _result)
	{
		return TryParseFloat(_input, out _result, 0);
	}
	...
	public static bool TryParseDouble(string _input, out double _result, int _startIndex, int _endIndex = -1, NumberStyles _style = NumberStyles.Any)
	{
	...
	[XuiXmlAttributeConverter]
	public static bool TryParseDouble(string _input, out double _result)
	{
		return TryParseDouble(_input, out _result, 0);
	}
	...
	public static bool TryParseBool(string _input, out bool _result, int _startIndex, int _endIndex = -1, bool _ignoreCase = true)
	{
	...
	[XuiXmlAttributeConverter]
	public static bool TryParseBool(string _input, out bool _result)
	{
		return TryParseBool(_input, out _result, 0);
	}

	public static bool TryParseRange(string _input, out FloatRange _result, float? _defaultMax = null, char separators = ',')
	{
		_result = default(FloatRange);
		SeparatorPositions separatorPositions = GetSeparatorPositions(_input, separators, 1);
	...
	public static bool TryParseRange(string _input, out IntRange _result, int? _defaultMax = null, char separators = ',')
	{
	...
	[XuiXmlAttributeConverter]
	public static bool TryParseVector2(string _input, out Vector2 _output)
	{
		_output = default(Vector2);
		int num = 0;
		int num2 = -1;
		if (_input.Length > 0 && _input[0] == '(')
		{
			...
			{
				num = 1;
				num2 = _input.Length - 2;
			}
		}
		if (num2 < 0)
		{
			num2 = _input.Length - 1;
		}
		if (num2 < num || num2 >= _input.Length)
		{
			return false;
		}
		SeparatorPositions separatorPositions = GetSeparatorPositions(_input, ',', 1, num, num2);
		if (separatorPositions.TotalFound != 1)
		{
			return false;
		}
		if (!TryParseFloat(_input, out var _result, num, separatorPositions.Sep1 - 1))
		{
			return false;
		}
		if (!TryParseFloat(_input, out var _result2, separatorPositions.Sep1 + 1, num2))
		{
			return false;
		}
		_output = new Vector2(_result, _result2);
		return true;
	}
	...
	{
		if (_startIndex == 0 && _endIndex < 0 && _input.Length > 0 && _input[0] == '(')
		{
			if (_input[_input.Length - 1] == ')')
			{
				_startIndex = 1;
	...
	[XuiXmlAttributeConverter]
	public static bool TryParseVector3(string _input, out Vector3 _output)
	{
		_output = default(Vector3);
		int num = 0;
		int num2 = -1;
		if (_input.Length > 0 && _input[0] == '(')
		{
		...
		SeparatorPositions separatorPositions = GetSeparatorPositions(_input, ',', 2, num, num2);
		if (separatorPositions.TotalFound != 2)
		{
			return false;
		}
		...
		if (!TryParseFloat(_input, out var _result2, separatorPositions.Sep1 + 1, separatorPositions.Sep2 - 1))
		{
			return false;
		}
		if (!TryParseFloat(_input, out var _result3, separatorPositions.Sep2 + 1, num2))
		{
			return false;
		}
		_output = new Vector3(_result, _result2, _result3);
		return true;
	}
	...
	[XuiXmlAttributeConverter]
	public static bool TryParseVector4(string _input, out Vector4 _output)
	{
		_output = default(Vector4);
		int num = 0;
		int num2 = -1;
		if (_input.Length > 0 && _input[0] == '(')
		{
		...
		SeparatorPositions separatorPositions = GetSeparatorPositions(_input, ',', 3, num, num2);
		if (separatorPositions.TotalFound != 3)
		{
			return false;
		}
		...
		if (!TryParseFloat(_input, out var _result3, separatorPositions.Sep2 + 1, separatorPositions.Sep3 - 1))
		{
			return false;
		}
		if (!TryParseFloat(_input, out var _result4, separatorPositions.Sep3 + 1, num2))
		{
			return false;
		}
		_output = new Vector4(_result, _result2, _result3, _result4);
		return true;
	}
	...
	public static BlockFaceFlag ParseCoverFaceMask(string _input)
	{
		...
		try
		{
			if (_input != null)
			{
				...
				{
					if (char.TryParse(array[i], out var result))
					{
						blockFaceFlag |= BlockFaceFlags.FromBlockFace(BlockFaces.CharToFace(result));
					}
				}
	...
	{
		if (!TryParseColor(_input, out var _output))
		{
			return Color.white;
		}
		return _output;
	...
	public static bool TryParseColor(string _input, out Color _output)
	{
		_output = default(Color);
		int startIndex = 0;
		int num = _input.Length - 1;
		if (_input.StartsWith("RGBA("))
		{
			startIndex = "RGBA(".Length;
			num--;
		}
		SeparatorPositions separatorPositions = GetSeparatorPositions(_input, ',', 3, startIndex, num);
		if (separatorPositions.TotalFound < 2 || separatorPositions.TotalFound > 3)
		{
			return false;
		}
		if (!TryParseFloat(_input, out var _result, startIndex, separatorPositions.Sep1 - 1))
		{
			return false;
		}
		if (!TryParseFloat(_input, out var _result2, separatorPositions.Sep1 + 1, separatorPositions.Sep2 - 1))
		...
		if (separatorPositions.TotalFound == 2)
		{
			_output = new Color(_result, _result2, _result3);
			return true;
		}
		if (!TryParseFloat(_input, out var _result4, separatorPositions.Sep3 + 1, num))
		{
			return false;
		}
		_output = new Color(_result, _result2, _result3, _result4);
		return true;
	}
	...
	public static bool TryParseColor32(string _input, out Color32 _output)
	{
		_output = default(Color32);
		int startIndex = 0;
		int num = _input.Length - 1;
		if (_input.StartsWith("RGBA("))
		{
		...
		if (!TryParseSInt32(_input, out var _result, startIndex, separatorPositions.Sep1 - 1))
		{
			return false;
		}
		if (!TryParseSInt32(_input, out var _result2, separatorPositions.Sep1 + 1, separatorPositions.Sep2 - 1))
		{
			return false;
		}
		if (!TryParseSInt32(_input, out var _result3, separatorPositions.Sep2 + 1, separatorPositions.Sep3 - 1))
		{
			return false;
		}
		int _result4 = 255;
		if (separatorPositions.TotalFound > 2 && !TryParseSInt32(_input, out _result4, separatorPositions.Sep3 + 1, num))
		{
			return false;
		}
		_output = new Color32((byte)_result, (byte)_result2, (byte)_result3, (byte)_result4);
		return true;
	}
	...
	public static Color ParseColor32(string _input)
	{
		...
		int num = ParseSInt32(_input, 0, separatorPositions.Sep1 - 1);
		int num2 = ParseSInt32(_input, separatorPositions.Sep1 + 1, separatorPositions.Sep2 - 1);
		int num3 = ParseSInt32(_input, separatorPositions.Sep2 + 1, separatorPositions.Sep3 - 1);
		int num4 = 255;
		if (separatorPositions.TotalFound > 2)
		{
	...
	[XuiXmlAttributeConverter]
	public static bool TryParseVector2i(string _input, out Vector2i _output)
	{
		_output = default(Vector2i);
		int num = 0;
		int num2 = -1;
		if (_input.Length > 0 && _input[0] == '(')
		{
		...
		if (!TryParseSInt32(_input, out var _result, num, separatorPositions.Sep1 - 1))
		{
			return false;
		}
		if (!TryParseSInt32(_input, out var _result2, separatorPositions.Sep1 + 1, num2))
		{
			return false;
		}
		_output = new Vector2i(_result, _result2);
		return true;
	}
	...
	[XuiXmlAttributeConverter]
	public static bool TryParseVector3i(string _input, out Vector3i _output)
	{
		_output = default(Vector3i);
		int num = 0;
		int num2 = -1;
		if (_input.Length > 0 && _input[0] == '(')
		{
		...
		if (!TryParseSInt32(_input, out var _result3, separatorPositions.Sep2 + 1, num2))
		{
			return false;
		}
		_output = new Vector3i(_result, _result2, _result3);
		return true;
	}
	...
	public static List<T> ParseList<T>(string _input, char _separator, Func<string, int, int, T> _parserFunc)
	{
		...
		{
			list.Add(_parserFunc(_input, num + 1, _input.Length - 1));
		}
		return list;
	}
