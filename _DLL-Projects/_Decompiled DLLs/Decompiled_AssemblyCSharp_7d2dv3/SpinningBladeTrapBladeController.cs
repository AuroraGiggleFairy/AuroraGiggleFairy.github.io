	...
	public void Update()
	{
		...
		else
		{
			...
			for (int i = 0; i < Blades.Length; i++)
			{
				...
				Voxel.Raycast(ray: new Ray(vector, direction), _world: GameManager.Instance.World, distance: 1.24f, _layerMask: -538750989, _hitMask: 128, _sphereRadius: 0.1f);
