...
public class XUiC_ActiveBuffList : XUiController, IEntityUINotificationChanged
{
	...
	{
		EntityUINotification selectedNotification = xui.BuffPopoutList.SelectedNotification;
		if (selectedNotification != null)
		{
			xui.BuffPopoutList.SelectedNotification = null;
	...
	{
		base.OnClose();
		xui.playerUI.entityPlayer.PlayerStats.RemoveUINotificationChangedDelegate(this);
	}
}
