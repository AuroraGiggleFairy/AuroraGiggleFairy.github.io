...
public class ConsoleCmdPlaceBlockRotations : ConsoleCmdAbstract
{
	...
	{
		BlockPlacement.Result _bpResult = new BlockPlacement.Result(BlockPlacement.EnumPlacement.Voxel, _placementPos + Vector3.one * 0.5f, _placementPos, BlockFace.None, _blockValue, _holdingData.propTransform);
