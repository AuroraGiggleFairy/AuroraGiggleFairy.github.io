...
public class ConsoleCmdMemoryProfiler : ConsoleCmdAbstract
{
	...
	public override void Execute(List<string> _params, CommandSenderInfo _senderInfo)
	{
		...
		{
			enabled = true;
			UnityMemoryProfilerLabel[] array = Object.FindObjectsByType<UnityMemoryProfilerLabel>(FindObjectsSortMode.None);
			...
			UnityMemoryProfilerLabel[] array2 = Object.FindObjectsByType<UnityMemoryProfilerLabel>(FindObjectsSortMode.None);
