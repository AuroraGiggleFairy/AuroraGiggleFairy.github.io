...
public abstract class AvatarController : MonoBehaviour
{
	...
	public static void StaticInit()
	{
		if (!initialized)
		{
			...
			AssignAnimatorHash(ref readyToFireHash, "readyToFire");
			...
			AssignAnimatorHash(ref aimPitchHash, "AimPitch");
			AssignAnimatorHash(ref aimYawHash, "AimYaw");
			...
			AssignAnimatorHash(ref weaponCarryHash, "WeaponCarry");
			...
			AssignAnimatorHash(ref hitRandomValueHash, "HitRandomValue");
			AssignAnimatorHash(ref hitTriggerHash, "HitTrigger");
			AssignAnimatorHash(ref CoverModeHash, "CoverMode");
			AssignAnimatorHash(ref CoverTypeHash, "CoverType");
			AssignAnimatorHash(ref CoverEngageHash, "CoverEngage");
			AssignAnimatorHash(ref CoverHeightHash, "CoverHeight");
			...
			AssignAnimatorHash(ref stressLevel, "ChickenStress");
		}
	}
	...
	public virtual CoverMode CurrentCoverMode()
	{
		return CoverMode.None;
	}

	public virtual CoverType CurrentCoverType()
	{
		return CoverType.Center;
	}

	public virtual CoverEngageType CurrentCoverEngageType()
	{
		return CoverEngageType.None;
	}

	public virtual void SetCoverMode(CoverMode _coverMode)
	{
	}

	public virtual void SetCoverType(CoverType _coverType)
	{
	}

	public virtual void SetCoverEngageType(CoverEngageType _engage)
	{
	}
