...
public class XUiC_ChallengeEntryDescriptionWindow : XUiController
{
	...
	public void GotoButton_OnPress(XUiController _sender, int _mouseButton)
	{
		if (currentChallenge != null)
		{
			...
			if (navObjective is ChallengeObjectiveCraft challengeObjectiveCraft)
			{
				...
				xui.GetChildByType<XUiC_RecipeList>()?.SetRecipeDataByItem(challengeObjectiveCraft.itemRecipe.itemValueType);
			}
	...
	public override void Update(float _dt)
	{
		...
		if (!base.ViewComponent.IsActiveInHierarchy || currentChallenge == null)
		{
			return;
		}
	...
	public void TrackCurrentChallenege()
	{
		...
		{
			if (xui.QuestTracker.TrackedChallenge == currentChallenge)
			{
				xui.QuestTracker.TrackedChallenge = null;
			}
			else
			{
				xui.QuestTracker.TrackedChallenge = currentChallenge;
	...
	public void CompleteCurrentChallenege()
	{
		if (currentChallenge != null && currentChallenge.ReadyToComplete)
		{
			...
			XUiC_ChallengeEntry selectedEntry = XUiC_ChallengeEntryList.SelectedEntry;
	...
	public override bool GetBindingValueInternal(ref string value, string bindingName)
	{
		...
		case "rewardtext":
			if (currentChallenge != null)
			{
				value = (currentChallenge.AutoCompleted ? "--" : challengeClass.RewardText);
			}
			else
			{
				value = "";
