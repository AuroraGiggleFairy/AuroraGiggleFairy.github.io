...
public class ObservableDictionary<TKey, TValue> : IDictionary<TKey, TValue>, ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable, IDictionary, ICollection
{
	...
	public virtual void OnEntryModified(TKey key, TValue value, EChangeType action)
	{
	...
	{
		this.EntryAdded?.Invoke(this, new DictionaryChangedEventArgs<TKey, TValue>(key, value, EChangeType.Added));
		OnEntryModified(key, value, EChangeType.Added);
	}

	[PublicizedFrom(EAccessModifier.Protected)]
	public virtual void OnEntryRemoved(TKey key, TValue value)
	{
		this.EntryRemoved?.Invoke(this, new DictionaryChangedEventArgs<TKey, TValue>(key, value, EChangeType.Removed));
		OnEntryModified(key, value, EChangeType.Removed);
	}

	[PublicizedFrom(EAccessModifier.Protected)]
	public virtual void OnEntryUpdated(TKey key, TValue value)
	{
		this.EntryUpdatedValue?.Invoke(this, new DictionaryChangedEventArgs<TKey, TValue>(key, value, EChangeType.Updated));
		OnEntryModified(key, value, EChangeType.Updated);
	}
