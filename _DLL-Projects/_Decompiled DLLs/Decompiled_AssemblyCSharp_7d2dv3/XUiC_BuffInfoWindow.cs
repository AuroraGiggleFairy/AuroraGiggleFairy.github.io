...
public class XUiC_BuffInfoWindow : XUiC_InfoWindow
{
	...
	public override bool GetBindingValueInternal(ref string value, string bindingName)
	{
		...
		case "bufficon":
			...
			return true;
		case "buffstats":
			value = (flag ? XUiM_PlayerBuffs.GetInfoFromBuff(xui.playerUI.entityPlayer, notification, overridenBuff) : "");
			return true;
		case "buffstatus":
	...
	{
		ensureReferencesSet();
		if (emptyInfoWindow != null && itemInfoWindow != null && buffEntry == null)
		{
	...
	[PublicizedFrom(EAccessModifier.Private)]
	public void ensureReferencesSet()
	{
