...
public class ItemActionEntryRepair : BaseItemActionEntry
{
	...
	public override void OnDisabledActivate()
	{
		...
		case StateTypes.RecipeLocked:
			GameManager.ShowTooltip(base.ItemController.xui.playerUI.entityPlayer, Localization.Get("xuiRepairMustReadBook"), _showImmediately: true);
			break;
		case StateTypes.NotEnoughMaterials:
		{
			GameManager.ShowTooltip(base.ItemController.xui.playerUI.entityPlayer, Localization.Get("xuiRepairMissingMats"), _showImmediately: true);
		...
		case StateTypes.NoLongerRepairable:
			GameManager.ShowTooltip(base.ItemController.xui.playerUI.entityPlayer, Localization.Get("ttItemCanNoLongerBeRepaired"), _showImmediately: true);
			break;
		case StateTypes.DurabilityWouldBeReduced:
			GameManager.ShowTooltip(base.ItemController.xui.playerUI.entityPlayer, Localization.Get("ttDurabilityWouldBeReduced"), _showImmediately: true);
			break;
		}
	}
	...
	public override void RefreshEnabled()
	{
		...
		switch (ItemAction.CanRepair(itemValue))
		{
		case ItemAction.CanRepairValues.NoLongerRepairable:
			state = StateTypes.NoLongerRepairable;
			base.Enabled = false;
			return;
		case ItemAction.CanRepairValues.DurabilityWouldBeReduced:
			state = StateTypes.DurabilityWouldBeReduced;
			base.Enabled = false;
			return;
		}
		if (itemClass == null || !(itemClass.RepairTools?.Length > 0))
	...
	public override void OnActivated()
	{
		...
		{
			xUiC_EquipmentStack2.ItemStack = ItemStack.Empty;
