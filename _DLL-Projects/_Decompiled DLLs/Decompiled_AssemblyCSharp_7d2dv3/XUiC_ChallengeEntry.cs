...
public class XUiC_ChallengeEntry : XUiController
{
	...
	public override void Init()
	{
		...
		if (childById != null)
		{
			itemIconSprite = (XUiV_Sprite)childById.ViewComponent;
	...
	public override void OnCursorSelected(bool _isActualElement)
	{
		...
		XUiC_ChallengeEntryList.SelectedEntry = this;
	}
	...
	public override void Update(float _dt)
	{
		...
		if (IsRedeemBlinking && !Selected)
		{
			...
			itemIconSprite.Size = new Vector2i((int)((float)iconSize.x * num2), (int)((float)iconSize.y * num2));
		}
		else if (Selected)
		{
			itemIconSprite.Size = iconSize;
		}
	}
