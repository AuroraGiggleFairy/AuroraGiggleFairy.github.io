...
public class vp_FPCamera : vp_Component
{
	...
	public override void LateUpdate()
	{
		...
		base.Transform.localEulerAngles += vp_MathUtility.NaNSafeVector3(Vector3.right * m_RotationSpring.State.x);
	...
	public void Update3rdPerson()
	{
		...
		pitch3P = Mathf.Clamp(pitch3P + Player.InputSmoothLook.Get().y, -89.5f, 89.5f);
		m_Pitch = pitch3P;
	...
	public virtual void OnMessage_FallImpact(float impact)
	{
		...
		if (m_RotationSpring != null)
		{
			m_RotationSpring.AddSoftForce(Vector3.right * (t2 * 2f), RotationKneelingSoftness);
		}
	}
