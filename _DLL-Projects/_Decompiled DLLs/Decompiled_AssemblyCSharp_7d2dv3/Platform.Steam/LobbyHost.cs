...
public class LobbyHost : ILobbyHost
{
	...
	{
		if (owner.User.UserStatus == EUserStatus.LoggedIn && gameServerInfo != null && !(CurrentLobby == CSteamID.Nil) && !(Time.unscaledTime - timeLastWorldTimeUpdate < 30f))
		{
			timeLastWorldTimeUpdate = Time.unscaledTime;
