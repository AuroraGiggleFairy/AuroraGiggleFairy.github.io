...
public class XUiC_TwitchWindow : XUiController
{
	...
	public override void Init()
	{
		...
		gearSpriteSize = new Vector2(optionsButton.Size.x, optionsButton.Size.y);
	...
	{
		XUiC_TwitchWindowSelector.OpenSelectorAndWindow(xui.playerUI.entityPlayer, "Actions");
	}

	[PublicizedFrom(EAccessModifier.Private)]
	public void history_OnPress(XUiController _sender, int _mouseButton)
	{
		XUiC_TwitchWindowSelector.OpenSelectorAndWindow(xui.playerUI.entityPlayer, "ActionHistory");
	}
	...
	public override void Update(float _dt)
	{
		...
		{
			twitchManager.LocalPlayerXUi = xui;
		}
		if (!window.IsVisible)
		{
			return;
		...
		if (!twitchManager.HasViewedSettings)
		{
			...
			optionsButton.Size = new Vector2i((int)(gearSpriteSize.x * num2), (int)(gearSpriteSize.y * num2));
		}
		else
		{
