...
public class WorldState
{
	...
	public static int CurrentSaveVersion = 23;
	...
	public int sleeperVolumesSaveVersion;

	public MemoryStream sleeperVolumeState;

	public int triggerVolumesSaveVersion;

	public MemoryStream triggerVolumeState;

	public int wallVolumesSaveVersion;
			...
			try
			{
				...
				if (_load)
				{
					if (version > 14)
					{
						...
						int major = binaryReaderOrWriter.ReadWrite(3);
						int minor = binaryReaderOrWriter.ReadWrite(0);
						int build = binaryReaderOrWriter.ReadWrite(252);
				...
				else
				{
					...
					binaryReaderOrWriter.ReadWrite(3);
					binaryReaderOrWriter.ReadWrite(0);
					binaryReaderOrWriter.ReadWrite(252);
				}
				...
				if (version > 12)
				{
					if (version >= 23)
					{
						sleeperVolumesSaveVersion = binaryReaderOrWriter.ReadWrite(1);
					}
				...
				if (version >= 19)
				{
					if (version >= 23)
					{
						triggerVolumesSaveVersion = binaryReaderOrWriter.ReadWrite(1);
					}
				...
				if (version >= 20)
				{
					if (version >= 23)
					{
						wallVolumesSaveVersion = binaryReaderOrWriter.ReadWrite(1);
					}
