...
public class Factory : IPlatform
{
	...
	public IPlatformSaveGameProvider SaveGameProvider => PlatformManager.NativePlatform.SaveGameProvider;

	[field: PublicizedFrom(EAccessModifier.Private)]
	public IUserDataRoaming UserDataRoaming
	{
		get; [PublicizedFrom(EAccessModifier.Private)]
		set;
	}
	...
	public void CreateInstances()
	{
		...
		UserDataRoaming = new UserDataRoamingMultiPlatform();
	}
