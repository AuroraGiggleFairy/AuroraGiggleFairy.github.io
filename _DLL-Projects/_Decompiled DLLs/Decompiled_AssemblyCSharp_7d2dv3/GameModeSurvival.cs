...
public class GameModeSurvival : GameModeAbstract
{
	...
	public override ModeGamePref[] GetSupportedGamePrefsInfo()
	{
		return new ModeGamePref[60]
		{
			...
			new ModeGamePref(EnumGamePrefs.ResetUnprotectedChunks, GamePrefs.EnumType.Int, 0),
			...
			new ModeGamePref(EnumGamePrefs.JarRefund, GamePrefs.EnumType.Int, 60),
			new ModeGamePref(EnumGamePrefs.SandboxPreset, GamePrefs.EnumType.String, ""),
			new ModeGamePref(EnumGamePrefs.SandboxCode, GamePrefs.EnumType.String, "")
		};
	}
