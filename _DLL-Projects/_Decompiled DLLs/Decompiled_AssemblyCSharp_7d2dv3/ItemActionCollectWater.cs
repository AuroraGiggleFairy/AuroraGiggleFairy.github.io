...
public class ItemActionCollectWater : ItemAction
{
	...
	public override void ExecuteAction(ItemActionData _actionData, bool _bReleased)
	{
		...
		if (Voxel.Raycast(invData.world, ((EntityPlayerLocal)invData.holdingEntity).HitInfo.ray, Constants.cDigAndBuildDistance, 16, 4095, 0f) && Voxel.voxelRayHitInfo.bHitValid && Voxel.voxelRayHitInfo.hit.voxelData.WaterValue.HasMass())
		{
	...
	public override void StopHolding(ItemActionData _actionDatadata)
	{
		base.StopHolding(_actionDatadata);
		_actionDatadata.lastUseTime = 0f;
	}
	...
	public override void OnHoldingUpdate(ItemActionData _actionData)
	{
		...
		int num = CollectWaterUtils.CollectWater(chunkCluster, collectWaterActionData.targetMass, collectWaterActionData.targetPosition, 2, waterPoints);
		if (num > 195)
		{
			if (isReduceWater)
			{
