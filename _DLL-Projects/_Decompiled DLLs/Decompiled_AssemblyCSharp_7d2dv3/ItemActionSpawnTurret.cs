...
public class ItemActionSpawnTurret : ItemAction
{
	...
	public override void ReadFrom(DynamicProperties _props)
	{
		...
		canPlaceInAir = false;
		if (_props.Values.ContainsKey("CanPlaceInAir"))
		{
			canPlaceInAir = StringParsers.ParseBool(_props.Values["CanPlaceInAir"]);
		}
	...
	public void setupPreview(ItemActionDataSpawnTurret data)
	{
		...
		data.CanPlaceInAir = canPlaceInAir;
	...
	public override void ExecuteAction(ItemActionData _actionData, bool _bReleased)
	{
		...
		else
		{
			...
			if (EntityClass.list[entityClassId].entityClassName == "entityJunkDrone" && !EntityDrone.IsValidForLocalPlayer())
			{
				return;
			}
	...
	public bool CalcSpawnPosition(ItemActionDataSpawnTurret _actionData, ref Vector3 position)
	{
		...
		if (Voxel.Raycast(_layerMask: _actionData.CanPlaceInAir ? 8454144 : 65536, _world: world, ray: lookRay, distance: 4f + turretSize.x, _hitMask: 69, _sphereRadius: 0f))
		{
