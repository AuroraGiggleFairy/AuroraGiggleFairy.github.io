...
public class ConsoleCmdChunkCache : ConsoleCmdAbstract
{
	...
	public override void Execute(List<string> _params, CommandSenderInfo _senderInfo)
	{
		...
		int num5 = 0;
		int[] array = new int[1];
		lock (GameManager.Instance.World.ChunkCache.GetSyncRoot())
		{
		...
		SingletonMonoBehaviour<SdtdConsole>.Instance.Output("Chunks: " + GameManager.Instance.World.ChunkCache.Count());
