...
public class XUiC_QuestRewardsWindow : XUiController
{
	...
	public override bool GetBindingValueInternal(ref string value, string bindingName)
	{
		...
		case "commonrewards":
			...
			{
				string questRewards = XUiM_Quest.GetQuestRewards(currentQuest, xui.playerUI.entityPlayer, _isChosen: false, rewardItemFormat, rewardItemBonusFormat, rewardNumberFormat, rewardNumberBonusFormat);
				if (questRewards == "")
				{
		...
		case "chosenrewards":
			...
			if (currentQuest != null)
			{
				string questRewards2 = XUiM_Quest.GetQuestRewards(currentQuest, xui.playerUI.entityPlayer, _isChosen: true, rewardItemFormat, rewardItemBonusFormat, rewardNumberFormat, rewardNumberBonusFormat);
				if (questRewards2 == "")
				{
					value = Localization.Get("none");
				}
		...
		case "chainrewards":
			...
			if (currentQuest != null)
			{
				string chainQuestRewards = XUiM_Quest.GetChainQuestRewards(currentQuest, xui.playerUI.entityPlayer, rewardItemFormat, rewardItemBonusFormat, rewardNumberFormat, rewardNumberBonusFormat);
