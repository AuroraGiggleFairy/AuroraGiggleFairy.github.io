...
public class NGSS_Directional : MonoBehaviour
{
	...
	public void AddCommandBuffer()
	{
		...
		_computeDenoiseCB.GetTemporaryRT(num, -1, -1, 0, FilterMode.Bilinear, RenderTextureFormat.R8, RenderTextureReadWrite.Linear);
		_computeDenoiseCB.GetTemporaryRT(num2, -1, -1, 0, FilterMode.Bilinear, RenderTextureFormat.R8, RenderTextureReadWrite.Linear);
