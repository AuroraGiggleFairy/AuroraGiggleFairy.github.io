...
public class NGSS_FrustumShadows : MonoBehaviour
{
	...
	public void Init()
	{
		...
		computeShadowsCB.GetTemporaryRT(num, scaledPixelWidth / _downGrade, scaledPixelHeight / _downGrade, 0, FilterMode.Bilinear, RenderTextureFormat.RG16, RenderTextureReadWrite.Linear);
		computeShadowsCB.GetTemporaryRT(num2, scaledPixelWidth / _downGrade, scaledPixelHeight / _downGrade, 0, FilterMode.Bilinear, RenderTextureFormat.RG16, RenderTextureReadWrite.Linear);
