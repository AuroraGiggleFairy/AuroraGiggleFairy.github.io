...
public abstract class CursorControllerAbs : MonoBehaviour, IGamePrefsChangedListener
{
	...
	[field: NonSerialized]
	[field: PublicizedFrom(EAccessModifier.Private)]
	public XUiView navigationTargetLater
	{
		get; [PublicizedFrom(EAccessModifier.Protected)]
		set;
	}
	...
	public void OnGamePrefChanged(EnumGamePrefs _enum)
	{
		switch (_enum)
		{
		case EnumGamePrefs.OptionsInterfaceSensitivity:
			UpdateMoveSpeed();
			break;
		case EnumGamePrefs.OptionsControllerCursorSnap:
			bSnapCursor = GamePrefs.GetBool(_enum);
			break;
		case EnumGamePrefs.OptionsControllerCursorHoverSensitivity:
			hoverSpeed = GamePrefs.GetFloat(_enum);
			break;
		}
	}
	...
	public bool GetMouseButtonDown(UICamera.MouseButton _mouseButton)
	{
		...
		case UICamera.MouseButton.MiddleButton:
			return guiActions.MiddleClick.WasPressed;
		default:
			return false;
		}
	}
	...
	public bool GetMouseButton(UICamera.MouseButton _mouseButton)
	{
		...
		case UICamera.MouseButton.RightButton:
			...
			return true;
		case UICamera.MouseButton.MiddleButton:
			return guiActions.MiddleClick.IsPressed;
		default:
			return false;
		}
	}
	...
	public bool GetMouseButtonUp(UICamera.MouseButton _mouseButton)
	{
		...
		case UICamera.MouseButton.RightButton:
			...
			return true;
		case UICamera.MouseButton.MiddleButton:
			return guiActions.MiddleClick.WasReleased;
		default:
			return false;
		}
	}
