...
public static class XUiC_LevelToolsHelpers
{
	...
	public static NGuiAction createSelectionBoxAction(string _categoryName)
	{
		...
		NGuiAction nGuiAction = new NGuiAction(string.Format(Localization.Get("xuiShowVolumesCategory"), Localization.Get("selectionCategory" + _categoryName)), null, _isToggle: true);
	...
	public static NGuiAction createSpecialAction(string _substring)
	{
		...
		{
			NGuiAction nGuiAction7 = new NGuiAction(Localization.Get("leveltoolsShowCompositionGrid"), null, _isToggle: true);
			...
			nGuiAction7.SetIsCheckedDelegate([PublicizedFrom(EAccessModifier.Internal)] () => PrefabEditModeManager.Instance.IsCompositionGrid());
			return nGuiAction7;
		}
		case "ShowChunkBorders":
		{
			NGuiAction nGuiAction31 = new NGuiAction(Localization.Get("leveltoolsShowChunkBorders"), null, _isToggle: true);
			...
			nGuiAction31.SetIsCheckedDelegate([PublicizedFrom(EAccessModifier.Internal)] () => LocalPlayerUI.GetUIForPrimaryPlayer().entityPlayer.MoveController.drawChunkMode > 0);
			return nGuiAction31;
		}
		case "Unpaintable":
		{
			NGuiAction nGuiAction5 = new NGuiAction(Localization.Get("leveltoolsShowUnpaintable"), null, _isToggle: true);
			...
			nGuiAction5.SetIsCheckedDelegate([PublicizedFrom(EAccessModifier.Internal)] () => GameManager.bShowUnpaintables);
			return nGuiAction5;
		}
		case "Paintable":
		{
			NGuiAction nGuiAction10 = new NGuiAction(Localization.Get("leveltoolsShowPaintable"), null, _isToggle: true);
			...
			nGuiAction10.SetIsCheckedDelegate([PublicizedFrom(EAccessModifier.Internal)] () => GameManager.bShowPaintables);
			return nGuiAction10;
		}
		case "Terrain":
		{
			NGuiAction nGuiAction23 = new NGuiAction(Localization.Get("leveltoolsShowTerrain"), null, _isToggle: true);
			...
			nGuiAction23.SetIsCheckedDelegate([PublicizedFrom(EAccessModifier.Internal)] () => GameManager.bShowTerrain);
			return nGuiAction23;
		}
		case "Decor":
		{
			NGuiAction nGuiAction29 = new NGuiAction(Localization.Get("leveltoolsShowDecor"), null, _isToggle: true);
			...
			nGuiAction29.SetIsCheckedDelegate([PublicizedFrom(EAccessModifier.Internal)] () => GameManager.bShowDecorBlocks);
			return nGuiAction29;
		}
		case "Loot":
		{
			NGuiAction nGuiAction26 = new NGuiAction(Localization.Get("leveltoolsShowLoot"), null, _isToggle: true);
			...
			nGuiAction26.SetIsCheckedDelegate([PublicizedFrom(EAccessModifier.Internal)] () => GameManager.bShowLootBlocks);
			return nGuiAction26;
		}
		case "QuestLoot":
		{
			NGuiAction nGuiAction16 = new NGuiAction(Localization.Get("leveltoolsShowQuestLoot"), null, _isToggle: true);
			...
			nGuiAction16.SetIsCheckedDelegate([PublicizedFrom(EAccessModifier.Internal)] () => PrefabEditModeManager.Instance.HighlightQuestLoot);
			return nGuiAction16;
		}
		case "BlockTriggers":
		{
			NGuiAction nGuiAction18 = new NGuiAction(Localization.Get("leveltoolsShowBlockTriggers"), null, _isToggle: true);
			...
			nGuiAction18.SetIsCheckedDelegate([PublicizedFrom(EAccessModifier.Internal)] () => PrefabEditModeManager.Instance.HighlightBlockTriggers);
			return nGuiAction18;
		}
		case "SleeperXRay":
		{
			...
			{
				SleeperVolumeToolManager.XRayMode = !SleeperVolumeToolManager.XRayMode;
			});
			nGuiAction3.SetIsCheckedDelegate([PublicizedFrom(EAccessModifier.Internal)] () => SleeperVolumeToolManager.XRayMode);
			return nGuiAction3;
		}
