...
public class Quest
{
	...
	public static string StarterQuest = "quest_whiteRiverCitizen1";
	...
	public bool CanTurnInQuest(List<BaseReward> rewardChoice)
	{
		...
		ItemStack[] array = ItemStack.Clone(OwnerJournal.OwnerPlayer.bag.GetSlots());
		ItemStack[] array2 = ItemStack.Clone(OwnerJournal.OwnerPlayer.inventory.GetSlots());
