...
public class ConsoleCmdLogGameState : ConsoleCmdAbstract
{
	...
	public void WriteCounts()
	{
		...
		printLine("Active GameObjs:  {0}", UnityEngine.Object.FindObjectsByType<GameObject>(FindObjectsSortMode.None).Length);
		printLine("Script instances: {0}", UnityEngine.Object.FindObjectsByType<MonoBehaviour>(FindObjectsSortMode.None).Length);
		printLine("Total Objects:    {0}", UnityEngine.Object.FindObjectsByType<UnityEngine.Object>(FindObjectsSortMode.None).Length);
