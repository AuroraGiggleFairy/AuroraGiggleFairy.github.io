...
public class XUiC_DewCollectorWindow : XUiController
{
	...
	public override void Update(float _dt)
	{
		...
		if ((!(GameManager.Instance == null) || GameManager.Instance.World != null) && !isClosing && base.ViewComponent != null && base.ViewComponent.IsVisible && (PlatformManager.NativePlatform.Input.CurrentInputStyle != PlayerInputManager.InputStyle.Keyboard || !xui.playerUI.windowManager.IsInputActive()) && (xui.playerUI.playerInput.GUIActions.LeftStick.WasPressed || xui.playerUI.playerInput.PermanentActions.Reload.WasPressed))
		{
			controls.MoveAll();
		}
	}
	...
	public IEnumerator closeInventoryLater()
	{
		isClosing = true;
		yield return null;
		xui.playerUI.windowManager.Close("dewcollector");
		isClosing = false;
	}
