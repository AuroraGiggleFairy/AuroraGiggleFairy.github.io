	...
	public override void Execute(MinEventParams _params)
	{
		...
		for (int i = 0; i < targets.Count; i++)
		{
			...
			if (entityAlive != null)
			{
				...
				GameManager.Instance.ExplosionServer(entityAlive.getHeadPosition(), entityAlive.GetBlockPosition(), entityAlive.qrotation, explosionData, entityAlive.entityId, 0.1f, _bRemoveBlockAtExplPosition: false);
			}
		}
	}
