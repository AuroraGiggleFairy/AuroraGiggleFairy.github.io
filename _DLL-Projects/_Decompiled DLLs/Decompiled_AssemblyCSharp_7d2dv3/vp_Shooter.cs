...
public class vp_Shooter : vp_Component
{
	...
	public void DrawProjectileDebugInfo(int projectileIndex)
	{
		...
		if (Physics.Linecast(gameObject.transform.position, gameObject.transform.position + gameObject.transform.forward * 1000f, out var hitInfo, 1084850184) && !hitInfo.collider.isTrigger && base.Root.InverseTransformPoint(hitInfo.point).z > 0f)
		{
