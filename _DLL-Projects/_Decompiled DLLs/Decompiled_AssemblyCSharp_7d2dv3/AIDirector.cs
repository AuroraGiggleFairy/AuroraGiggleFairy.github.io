...
public class AIDirector
{
	...
	{
		if (value > 0f && GameStats.GetBool(EnumGameStats.ZombieHordeMeter) && GameStats.GetBool(EnumGameStats.IsSpawnEnemies) && HeatMapSensitivityModifier > 0f && !BloodMoonComponent.BloodMoonActive && !TwitchManager.BossHordeActive)
		{
			AIDirectorChunkEvent chunkEvent = new AIDirectorChunkEvent(type, position, value * HeatMapSensitivityModifier, _duration);
