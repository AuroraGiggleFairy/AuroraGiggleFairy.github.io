...
public class XUiC_QuestTrackerWindow : XUiController
{
	...
	{
		base.OnOpen();
		xui.QuestTracker.OnTrackedQuestChanged += QuestTracker_OnTrackedQuestChanged;
		...
		xui.playerUI.entityPlayer.QuestJournal.RefreshTracked();
		if (xui.QuestTracker.TrackedQuest != null)
		{
			CurrentQuest = xui.QuestTracker.TrackedQuest;
		}
		else if (xui.QuestTracker.TrackedChallenge != null)
		{
			CurrentChallenge = xui.QuestTracker.TrackedChallenge;
		}
	}
