...
[Preserve]
public class NetPackageEntityStatChanged : NetPackageEntityTargeted
{
	...
	{
		if (_world == null || (entityId == _world.GetPrimaryPlayerId() && entityId == m_instigatorId) || !ValidEntityIdForSender(m_instigatorId))
		{
			return;
		}
