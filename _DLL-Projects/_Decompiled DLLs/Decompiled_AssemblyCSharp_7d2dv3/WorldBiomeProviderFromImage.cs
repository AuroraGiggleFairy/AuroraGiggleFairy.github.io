...
public class WorldBiomeProviderFromImage : IBiomeProvider
{
	...
	public WorldBiomeProviderFromImage(string _levelName, string _worldPath, WorldBiomes _biomes, int _worldSize = 4096)
	{
