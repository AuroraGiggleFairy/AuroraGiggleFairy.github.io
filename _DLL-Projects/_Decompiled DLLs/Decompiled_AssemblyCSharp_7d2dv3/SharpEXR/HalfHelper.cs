...
public static class HalfHelper
{
	...
	public static uint[] mantissaTable = GenerateMantissaTable();

	[PublicizedFrom(EAccessModifier.Private)]
	public static uint[] exponentTable = GenerateExponentTable();

	[PublicizedFrom(EAccessModifier.Private)]
	public static ushort[] offsetTable = GenerateOffsetTable();

	[PublicizedFrom(EAccessModifier.Private)]
	public static ushort[] baseTable = GenerateBaseTable();

	[PublicizedFrom(EAccessModifier.Private)]
	public static sbyte[] shiftTable = GenerateShiftTable();
