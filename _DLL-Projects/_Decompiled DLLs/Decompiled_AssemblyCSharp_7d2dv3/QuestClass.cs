...
public class QuestClass
{
	...
	public static string PropFilterTags = "filter_tags";

	public static string PropQuestStage = "quest_stage";

	public static string PropQuestHints = "quest_hints";

	public static string PropQuestHintRequirement = "quest_hint_requirement";
	...
	public global::SandboxOptions.SandboxOptions QuestHintRequirement = global::SandboxOptions.SandboxOptions.Max;

	public int RewardChoicesCount = 2;

	public FastTags<TagGroup.Global> ExtraTags = FastTags<TagGroup.Global>.none;

	public FastTags<TagGroup.Global> FilterTags = FastTags<TagGroup.Global>.none;
	...
	{
		if (QuestHintRequirement != global::SandboxOptions.SandboxOptions.Max && !SandboxOptionManager.GetBool(QuestHintRequirement))
		{
			return "";
		}
		phase--;
	...
	public void Init()
	{
		...
		if (Properties.Values.ContainsKey(PropFilterTags))
		{
			string text2 = Properties.Values[PropFilterTags];
			if (text2 != "")
			{
				FilterTags = FastTags<TagGroup.Global>.Parse(text2);
			}
		}
		...
		Properties.ParseString(PropQuestHintRequirement, ref optionalValue2);
		if (optionalValue2 != null)
		{
			Enum.TryParse<global::SandboxOptions.SandboxOptions>(optionalValue2, out QuestHintRequirement);
		}
	...
	{
		foreach (KeyValuePair<string, string> item in properties.Params1)
		{
