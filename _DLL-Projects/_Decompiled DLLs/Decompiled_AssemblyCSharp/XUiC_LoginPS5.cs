...
public class XUiC_LoginPS5 : XUiController
{
	...
	public override bool GetBindingValueInternal(ref string _value, string _bindingName)
	{
		...
		{
		case "title":
			_value = ((offendingPlatform == null) ? "" : string.Format(Localization.Get("xuiPSNLogin"), offendingPlatform.PlatformDisplayName));
			return true;
		case "caption":
	...
	{
		XUiC_LoginPS5 childByType = _xuiInstance.FindWindowGroupByName(ID).GetChildByType<XUiC_LoginPS5>();
