...
public class TwitchCommandSetPot : BaseTwitchCommand
{
	...
	public override string[] CommandText => new string[1] { "#setpot" };

	public override string[] LocalizedCommandNames => new string[1] { Localization.Get("TwitchCommand_SetPot") };
	...
	public override void Execute(ViewerEntry entry, TwitchIRCClient.TwitchChatMessage message)
	{
		...
		if (array.Length == 2)
		{
			...
			{
				TwitchManager.Current.SetPot(result);
			}
		}
	}
