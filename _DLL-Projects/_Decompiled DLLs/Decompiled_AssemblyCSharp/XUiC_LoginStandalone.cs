...
public class XUiC_LoginStandalone : XUiController
{
	...
	public void updateState(IPlatform _platform, EApiStatusReason _statusReason, string _statusReasonAdditionalText)
	{
		...
		btnRetry.Enabled = _platform.Api.ClientApiStatus != EApiStatus.PermanentError && !wantOffline;
	...
	{
		XUiC_LoginStandalone childByType = _xuiInstance.FindWindowGroupByName(ID).GetChildByType<XUiC_LoginStandalone>();
