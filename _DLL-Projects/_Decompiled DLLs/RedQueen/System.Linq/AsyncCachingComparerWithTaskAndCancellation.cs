...
internal class AsyncCachingComparerWithTaskAndCancellation<[_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(2)] TElement, [_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(2)] TKey> : AsyncCachingComparer<TElement>
{
	...
	public AsyncCachingComparerWithTaskAndCancellation([_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(new byte[] { 1, 1, 0, 1 })] Func<TElement, CancellationToken, ValueTask<TKey>> keySelector, IComparer<TKey> comparer, bool descending)
	{
	...
	{
		_lastKey = await _keySelector(element, cancellationToken).ConfigureAwait(continueOnCapturedContext: false);
	}
}
