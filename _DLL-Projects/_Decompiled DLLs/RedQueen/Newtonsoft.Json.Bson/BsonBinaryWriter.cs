...
internal class BsonBinaryWriter
{
	...
	private void WriteTokenInternal(BsonToken t)
	{
		...
		case BsonType.Array:
		{
			...
			foreach (BsonToken item2 in bsonArray)
			{
				...
				WriteString(num2.ToString(CultureInfo.InvariantCulture), Newtonsoft.Json.Utilities.MathUtils.IntLength(num2), null);
	...
	private int CalculateSize(BsonToken t)
	{
		...
		case BsonType.Array:
		{
			...
			{
				num2++;
				num2 += CalculateSize(Newtonsoft.Json.Utilities.MathUtils.IntLength(num3));
