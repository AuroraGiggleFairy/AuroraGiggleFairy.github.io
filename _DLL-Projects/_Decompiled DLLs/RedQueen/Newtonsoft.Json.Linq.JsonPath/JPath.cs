...
internal class JPath
{
	...
	private static PathFilter CreatePathFilter([_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] string member, bool scan)
	{
		if (!scan)
		{
	...
	private bool TryParseExpression([_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(new byte[] { 2, 1 })] out List<PathFilter> expressionPath)
	{
		if (_expression[_currentIndex] == '$')
		{
	...
	internal IEnumerable<JToken> Evaluate(JToken root, JToken t, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] JsonSelectSettings settings)
	{
		return Evaluate(Filters, root, t, settings);
	}

	internal static IEnumerable<JToken> Evaluate(List<PathFilter> filters, JToken root, JToken t, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] JsonSelectSettings settings)
	{
