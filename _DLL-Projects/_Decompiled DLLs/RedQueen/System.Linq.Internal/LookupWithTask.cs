...
internal class LookupWithTask<[_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(2)] TKey, [_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(2)] TElement> : ILookup<TKey, TElement>, IEnumerable<IGrouping<TKey, TElement>>, IEnumerable, IAsyncIListProvider<IAsyncGrouping<TKey, TElement>>, IAsyncEnumerable<IAsyncGrouping<TKey, TElement>>
{
	...
	private LookupWithTask([_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(new byte[] { 2, 1 })] IEqualityComparer<TKey> comparer)
	{
	...
	internal static async Task<LookupWithTask<TKey, TElement>> CreateAsync(IAsyncEnumerable<TElement> source, [_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(new byte[] { 1, 1, 0, 1 })] Func<TElement, ValueTask<TKey>> keySelector, [_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(new byte[] { 2, 1 })] IEqualityComparer<TKey> comparer, CancellationToken cancellationToken)
	{
		LookupWithTask<TKey, TElement> lookup = new LookupWithTask<TKey, TElement>(comparer);
	...
	internal static async Task<LookupWithTask<TKey, TElement>> CreateAsync(IAsyncEnumerable<TElement> source, [_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(new byte[] { 1, 1, 0, 1 })] Func<TElement, CancellationToken, ValueTask<TKey>> keySelector, [_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(new byte[] { 2, 1 })] IEqualityComparer<TKey> comparer, CancellationToken cancellationToken)
	{
		LookupWithTask<TKey, TElement> lookup = new LookupWithTask<TKey, TElement>(comparer);
		await foreach (TElement item in source.WithCancellation(cancellationToken).ConfigureAwait(continueOnCapturedContext: false))
		{
	...
	internal static async Task<LookupWithTask<TKey, TElement>> CreateForJoinAsync(IAsyncEnumerable<TElement> source, [_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(new byte[] { 1, 1, 0, 1 })] Func<TElement, ValueTask<TKey>> keySelector, [_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(new byte[] { 2, 1 })] IEqualityComparer<TKey> comparer, CancellationToken cancellationToken)
	{
		LookupWithTask<TKey, TElement> lookup = new LookupWithTask<TKey, TElement>(comparer);
		await foreach (TElement item in source.WithCancellation(cancellationToken).ConfigureAwait(continueOnCapturedContext: false))
		{
	...
	internal static async Task<LookupWithTask<TKey, TElement>> CreateForJoinAsync(IAsyncEnumerable<TElement> source, [_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(new byte[] { 1, 1, 0, 1 })] Func<TElement, CancellationToken, ValueTask<TKey>> keySelector, [_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(new byte[] { 2, 1 })] IEqualityComparer<TKey> comparer, CancellationToken cancellationToken)
	{
		LookupWithTask<TKey, TElement> lookup = new LookupWithTask<TKey, TElement>(comparer);
		await foreach (TElement item in source.WithCancellation(cancellationToken).ConfigureAwait(continueOnCapturedContext: false))
		{
	...
	internal async Task<TResult[]> ToArray<[_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(2)] TResult>([_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(new byte[] { 1, 1, 1, 1, 0, 1 })] Func<TKey, IAsyncEnumerable<TElement>, ValueTask<TResult>> resultSelector)
	{
		...
		if (g != null)
		{
			do
			{
				...
				int num = index;
				array2[num] = await resultSelector(g._key, g._elements.ToAsyncEnumerable()).ConfigureAwait(continueOnCapturedContext: false);
				int num2 = index + 1;
				index = num2;
			}
			while (g != _lastGrouping);
	...
	internal async Task<TResult[]> ToArray<[_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(2)] TResult>([_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(new byte[] { 1, 1, 1, 1, 0, 1 })] Func<TKey, IAsyncEnumerable<TElement>, CancellationToken, ValueTask<TResult>> resultSelector, CancellationToken cancellationToken)
	{
		...
		if (g != null)
		{
			do
			{
				...
				TResult[] array2 = array;
				int num = index;
				array2[num] = await resultSelector(g._key, g._elements.ToAsyncEnumerable(), cancellationToken).ConfigureAwait(continueOnCapturedContext: false);
				int num2 = index + 1;
				index = num2;
			}
			while (g != _lastGrouping);
	...
	internal async Task<List<TResult>> ToList<[_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(2)] TResult>([_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(new byte[] { 1, 1, 1, 1, 0, 1 })] Func<TKey, IAsyncEnumerable<TElement>, ValueTask<TResult>> resultSelector)
	{
		...
		if (g != null)
		{
			do
			{
				g = g._next;
				g.Trim();
				list.Add(await resultSelector(g._key, g._elements.ToAsyncEnumerable()).ConfigureAwait(continueOnCapturedContext: false));
			}
			while (g != _lastGrouping);
		}
		return list;
	...
	internal async Task<List<TResult>> ToList<[_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(2)] TResult>([_003C24de4114_002D6bff_002D4b93_002D86b9_002D76223a10670c_003ENullable(new byte[] { 1, 1, 1, 1, 0, 1 })] Func<TKey, IAsyncEnumerable<TElement>, CancellationToken, ValueTask<TResult>> resultSelector, CancellationToken cancellationToken)
	{
		cancellationToken.ThrowIfCancellationRequested();
		List<TResult> list = new List<TResult>(Count);
		Grouping<TKey, TElement> g = _lastGrouping;
		if (g != null)
		{
			do
			{
				g = g._next;
				g.Trim();
				list.Add(await resultSelector(g._key, g._elements.ToAsyncEnumerable(), cancellationToken).ConfigureAwait(continueOnCapturedContext: false));
			}
			while (g != _lastGrouping);
		}
		return list;
