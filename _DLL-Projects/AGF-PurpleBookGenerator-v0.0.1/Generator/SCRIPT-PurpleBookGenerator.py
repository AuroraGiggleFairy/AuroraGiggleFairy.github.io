...
Output: ``_DLL-Projects/AGF-PurpleBookGenerator-vX.Y.Z/Config/XUi_InGame/windows.xml``.
...
def _resolve_out_mod_dir(out_mod_arg: str) -> Path:
    ...
    for parent_dir in (WORKSPACE / "_DLL-Projects", WORKSPACE / "01_Draft"):
    ...
    return (WORKSPACE / "_DLL-Projects" / out_mod_arg)
...
def main() -> int:
    ...
    if not out_mod_dir.exists():
        ...
        print("      (default expected location: _DLL-Projects/<mod-name>)")
        return 2
