...
- Config/XUi_InGame/templates.xml (or legacy xui.xml)
- Links/*.xml
"""
...
DEFAULT_LOCALIZATION_FILE = PROJECT_ROOT / "Config" / "Localization.csv"
DEFAULT_WINDOWS_FILE = PROJECT_ROOT / "Config" / "XUi_InGame" / "windows.xml"
DEFAULT_XUI_FILE = PROJECT_ROOT / "Config" / "XUi_InGame" / "templates.xml"
DEFAULT_STYLES_FILE = PROJECT_ROOT / "Config" / "XUi_InGame" / "styles.xml"
DEFAULT_LEGACY_XUI_FILE = PROJECT_ROOT / "Config" / "XUi_InGame" / "xui.xml"
