...
public class CharacterHealth : BindingAlias
{
    ...
    public override string GetCurrentValue(EntityPlayer player, string alias)
    {
        switch (alias)
        {
            ...
            case "withmax":
                return player.Health.ToString() + "/" + FormatUtil.FormatFloat(player.Stats.Health.Max);
            case "percentage":
...
public class CharacterStamina : BindingAlias
{
    ...
    public override string GetCurrentValue(EntityPlayer player, string alias)
    {
        switch (alias)
        {
            ...
            case "withmax":
                return FormatUtil.FormatFloat(player.Stamina) + "/" + FormatUtil.FormatFloat(player.Stats.Stamina.Max);
            case "percentage":
...
public class CharacterFood : BindingAlias
{
    ...
    public override string GetCurrentValue(EntityPlayer player, string alias)
    {
        switch (alias)
        {
            ...
            case "withmax":
                return FormatUtil.FormatRoundingFloat(player.Stats.Food.Value) + "/" + FormatUtil.FormatFloat(player.Stats.Food.Max);
            case "percentage":
...
public class CharacterWater : BindingAlias
{
    ...
    public override string GetCurrentValue(EntityPlayer player, string alias)
    {
        switch (alias)
        {
            ...
            case "withmax":
                return FormatUtil.FormatRoundingFloat(player.Water) + "/" + FormatUtil.FormatFloat(player.Stats.Water.Max);
            case "percentage":
