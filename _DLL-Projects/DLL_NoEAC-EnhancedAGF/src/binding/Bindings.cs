...
namespace StatControllers
{
    public static class Bindings
    {
        ...
        private static readonly Dictionary<string, Binding> supportedBindings = new Dictionary<string, Binding>(StringComparer.OrdinalIgnoreCase);
        ...
        static Bindings()
        {
            ...
            AddNewBinding(new BagMaxCarryCapacity(307, "PlayerMaxCarryCapacity"));
                ...
                AddNewBinding(new PlayerElevation(400, "PlayerElevation"));
                AddNewBinding(new PlayerFloorLevelDTC(401, "PlayerFloorLevelDTC"));
                    AddNewBinding(new PlayerIsDay(402, "PlayerIsDay"));
        ...
        {
            if (!supportedBindings.ContainsKey(bindingName))
            {
                var message = string.Format("{0} is not a supported bindingName", bindingName);
                Logging.Error(TAG, message);
                return false;
