...
Adds same-elevation flight assist for gyrocopters and helicopters with
...
------------------------------------------------------------------------
  ...
  - Gyrocopter: Press Z to move forward while staying at the same
    elevation.
  - Helicopter: Press Z for Hover, then press Z again for forward
    same-elevation flight.
