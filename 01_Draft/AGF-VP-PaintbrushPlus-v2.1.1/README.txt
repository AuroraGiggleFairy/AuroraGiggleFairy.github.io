...
Painting costs no paint, supports hold-to-paint, and has reduced reach
...
------------------------------------------------------------------------
  ...
  - Painting distance is reduced to prevent accidental long distance
    painting.
...
------------------------------------------------------------------------
  ...
  - Implementation edits used to make this work:
      ...
      - Sets both paint tool action delays to 0.3 for consistent repeat
        timing.
