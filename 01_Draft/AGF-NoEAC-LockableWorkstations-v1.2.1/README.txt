...
Workstations, collectors, and generators are now lockable with
...
------------------------------------------------------------------------
  ...
  - Workstations, Collectors, Generators, and Ranged Defenses start
    locked when placed.
  - These stations can be unlocked, locked again, or set with a key
    code.
  - Without client install, look at block within 5 meters and use chat
    commands '/agf-lw help'.
