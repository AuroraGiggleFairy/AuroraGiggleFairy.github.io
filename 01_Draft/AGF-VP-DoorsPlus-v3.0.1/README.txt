...
All door models available through one craftable helper per material
...
------------------------------------------------------------------------
  ...
  - All door models are selectable in each "All Doors" variant: wood,
    iron, steel, and powered.
