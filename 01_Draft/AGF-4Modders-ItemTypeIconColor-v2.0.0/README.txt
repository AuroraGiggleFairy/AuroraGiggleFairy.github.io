...
------------------------------------------------------------------------
  ...
  - Adds a new XML property, ItemTypeIconColor, so you can color the
    main item type icon.
  - Vanilla only supports alternate icon color (AltItemTypeIconColor)
    for unlock-state style behavior.
