...
7d2d Version 3
**Version:** 0.0.1  
[Download](https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/04_DownloadZips/AGF-PurpleBookGenerator.zip)
...
- "AGF-PurpleBookGenerator" is TBD to install on an existing game.
- "AGF-PurpleBookGenerator" is TBD to remove from an existing game.
- Unique Details: TBD
