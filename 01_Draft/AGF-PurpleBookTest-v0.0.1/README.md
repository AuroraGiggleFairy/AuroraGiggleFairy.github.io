...
7d2d Version 2  
**Version:** 0.0.1  
[Download](https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/04_DownloadZips/AGF-PurpleBookTest.zip)
...
- "AGF-PurpleBookTest" is TBD to install on an existing game.
- "AGF-PurpleBookTest" is TBD to remove from an existing game.
- Unique Details: TBD
