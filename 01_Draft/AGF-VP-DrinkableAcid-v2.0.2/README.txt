...
Drink acid for a wild mix of damage, speed buffs, trippy effects, and
...
------------------------------------------------------------------------
  ...
  - You can now drink acid for interesting, possibly life ending,
    effects!
...
------------------------------------------------------------------------
  ...
  - Implementation edits used to make this work:
      ...
      - Jump buff: higher jumps, lower jump stamina cost, and temporary
        leg-protection buff.
