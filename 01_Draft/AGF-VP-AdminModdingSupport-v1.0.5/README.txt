...
Adds a faster block replace tool, dev XP books, and harvest test blocks
...
------------------------------------------------------------------------
  ...
  - Dev-only harvest testing blocks for all harvest types, with baseline
    harvest set to 10.
...
------------------------------------------------------------------------
  ...
  - Specific XML Edits:
      ...
      - Test blocks are intended for controlled admin/modding tests, not
