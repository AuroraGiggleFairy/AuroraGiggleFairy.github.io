...
7d2d Version 2  
Version: 0.3.1  
Download: https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/04DownloadZips/AGF-4Modders-ESCWindowPlus.zip

 > FloridaMan is responsible for the base of this mod and graciously handed it to AGF to carry on with it and share with all of you!
...
- "AGF-4Modders-ESCWindowPlus" is SAFE to install on an existing game.
- "AGF-4Modders-ESCWindowPlus" is Unknown to remove from an existing game.
- Unique Details: None
...
- Users can generete their own ESC Menu with extra information!
- In the Generator folder, you can see all the customizations.
- 3 Main window types: Esc Menu, Server Join Menu, and ADMIN variant.
- Also note, that automatically, content is reproduced in a high visibility variant.
...
v0.3.1
- Added options for the Visual Entity Tracker.

v0.3.0
- Added the visual aspects for Screamer Alert in options.

v0.2.0
- Added the use of the styles.xml for simplification and compatibility.

v0.1.2
- ADMIN localization generates appropriately.
- Localization is now sorted. 
- Day/Time removed from joining as it doesn't work server side.

v0.1.1
- Corrected XUI for windowESC.
