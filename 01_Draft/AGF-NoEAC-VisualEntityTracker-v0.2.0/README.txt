...
Accessibility-focused nearby entity tracking for compass visuals (XML
...
------------------------------------------------------------------------
  ...
  - Accessibility-focused nearby entity tracking for compass visuals
    (XML baseline + optional DLL extensions).
