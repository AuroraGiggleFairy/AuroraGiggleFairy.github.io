...
------------------------------------------------------------------------
  ...
  - Implementation edits used to make this work:
      ...
      - Config/recipes.xml adds conditional seedStation recipe variants
        when AGF-VP-FarmingPlus is loaded.
      - Config/blocks.xml adds x5 and x25 planted tree block chains for
        oak, mountain pine, and winter pine across growth stages.
      - Config/blocks.xml sets higher MaxDamage and wood harvest counts
        for x5 and x25 tree variants relative to base trees.
      ...
      - Tree name/stage display is enabled on configured planted growth
        stages.
