...
Expands prompts with crafting state, storage slot usage, and vehicle
...
------------------------------------------------------------------------
  ...
  - When looking at any workstation, provides crafting and status
    information on the prompt.
  - When looking at storages, provides slots used status.
  - When looking at vehicles, shows seats available, locked status, and
    slots used.
  - LockableWorkstations compatible: hides extra prompt details if
    access is denied.
