...
Adds two audio menu tabs: per-category volume profiles and animal
...
------------------------------------------------------------------------
  ...
  - Adds two audio tabs to the vanilla game audio menu: Volume Profiles
    and Sound Swap.
  - Volume Profiles gives separate volume control for many sound groups
    (for example: motorized tools, vehicles, and trader voices).
  - Sound Swap lets you turn Silly Sounds on/off and swap animal
    pain/death sounds to non-pain sounds.
