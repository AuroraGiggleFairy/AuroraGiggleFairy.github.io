...
------------------------------------------------------------------------
  ...
  - Displays health, stamina, food, water, level, XP, and elevation in a
    ...
    - Storm visual alerts now appear below the location display, freeing
      space for other mods.
    - Trader dialogue, including quest selection, is easier to read with
      updated backgrounds.
    - Simple color-coding for interactive prompts (the text that appears
      when looking at loot, workstations, etc.) for quick recognition.
