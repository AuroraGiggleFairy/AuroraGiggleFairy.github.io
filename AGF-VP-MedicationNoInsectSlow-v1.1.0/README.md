...
- "AGF Medication No Slow from Insects" is SAFE to install on an existing game.
- "AGF Medication No Slow from Insects" is DANGEROUS to remove from an existing game.
- Unique Details: None
