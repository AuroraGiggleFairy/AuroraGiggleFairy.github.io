...
- "AGF Craft and Stack Engine/Battery/Cells" is SAFE to install on an existing game.
- "AGF Craft and Stack Engine/Battery/Cells" is DANGEROUS to remove from an existing game.
- Unique Details: None
