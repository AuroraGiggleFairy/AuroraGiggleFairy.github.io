...
7d2d Version 2  
**Version:** 1.0.0  
[Download](https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/_Mods3.zip/AGF-VP-BedrollPlus.zip)
...
- "AGF-VP-BedrollPlus" is {{SAFE_TO_INSTALL}} to install on an existing game.
- "AGF-VP-BedrollPlus" is {{SAFE_TO_REMOVE}} to remove from an existing game.
