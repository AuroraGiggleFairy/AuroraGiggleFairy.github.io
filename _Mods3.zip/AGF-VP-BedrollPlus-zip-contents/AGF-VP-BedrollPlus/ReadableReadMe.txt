...
7d2d Version 2  
Version: 1.0.0  
Download: https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/Mods3.zip/AGF-VP-BedrollPlus.zip
...
- "AGF-VP-BedrollPlus" is {{SAFETOINSTALL}} to install on an existing game.
- "AGF-VP-BedrollPlus" is {{SAFETOREMOVE}} to remove from an existing game.
