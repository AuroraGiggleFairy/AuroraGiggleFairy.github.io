VanillaPlus - MedicalTreatOthersTreatedInjuries
...
3.  INSTALLATION and REMOVAL NOTES
	*First, if you run into any conflicts, you may contact AuroraGiggleFairy via discord: https://discord.gg/Vm5eyW6N4r
	...
	-MedicalTreatOthersTreatedInjuries is SAFE to install on new or existing games.
	-MedicalTreatOthersTreatedInjuries is SAFE to remove from an existing game.


______________________________________________________________________________________________________________________
4.  FEATURES

	- With points in physician, you can't treat someone else's "treated" sprain or borken leg
	  - Now you can!
