...
public class XUiC_PlayerStats : XUiController
{
    ...
    {
        Log.Warning("[AGF DEBUG] XUiC_PlayerStats controller instantiated.");
    }
...
// ...existing code...
    ...
    public override bool GetBindingValueInternal(ref string value, string bindingName)
    {
        ...
        if (bindingName != null)
        {
            ...
            {
                if (bindingName.EqualsCaseInsensitive("PlayerIsDay") ||
                    bindingName.EqualsCaseInsensitive("PlayerIsNight") ||
                    bindingName.EqualsCaseInsensitive("PlayerCurrentAmmoVisible"))
                {
                    value = "false";
                }
                else
