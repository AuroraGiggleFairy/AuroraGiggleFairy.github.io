...
internal static class DateTimeUtils
{
	...
	internal static bool TryParseDateTime(StringReference s, DateTimeZoneHandling dateTimeZoneHandling, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] string dateFormatString, CultureInfo culture, out DateTime dt)
	{
		if (s.Length > 0)
		{
	...
	internal static bool TryParseDateTime(string s, DateTimeZoneHandling dateTimeZoneHandling, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] string dateFormatString, CultureInfo culture, out DateTime dt)
	{
		if (s.Length > 0)
		{
			if (s[0] == '/')
	...
	internal static bool TryParseDateTimeOffset(StringReference s, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] string dateFormatString, CultureInfo culture, out DateTimeOffset dt)
	{
		if (s.Length > 0)
		{
			int startIndex = s.StartIndex;
	...
	internal static bool TryParseDateTimeOffset(string s, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] string dateFormatString, CultureInfo culture, out DateTimeOffset dt)
	{
		if (s.Length > 0)
		{
			if (s[0] == '/')
	...
	internal static void WriteDateTimeString(TextWriter writer, DateTime value, DateFormatHandling format, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] string formatString, CultureInfo culture)
	{
	...
	internal static void WriteDateTimeOffsetString(TextWriter writer, DateTimeOffset value, DateFormatHandling format, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] string formatString, CultureInfo culture)
	{
		if (StringUtils.IsNullOrEmpty(formatString))
		{
			char[] array = new char[64];
