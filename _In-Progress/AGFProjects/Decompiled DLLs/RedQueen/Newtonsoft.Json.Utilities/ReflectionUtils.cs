...
internal static class ReflectionUtils
{
	...
	public static string GetTypeName(Type t, TypeNameAssemblyFormatHandling assemblyFormat, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] ISerializationBinder binder)
	{
	...
	private static string GetFullyQualifiedTypeName(Type t, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] ISerializationBinder binder)
	{
		if (binder != null)
		{
	...
	public static ConstructorInfo GetDefaultConstructor(Type t, bool nonPublic)
	{
		...
		return t.GetConstructors(bindingFlags).SingleOrDefault([_003C464f7c58_002D4ec4_002D4694_002Da30c_002D0ded4d74fb4d_003ENullableContext(0)] (ConstructorInfo c) => !c.GetParameters().Any());
	}
	...
	public static bool ImplementsGenericDefinition(Type type, Type genericInterfaceDefinition, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)][_003C49f72aa1_002Dca2e_002D4970_002D89f5_002D98556253c04f_003ENotNullWhen(true)] out Type implementingType)
	{
	...
	public static bool InheritsGenericDefinition(Type type, Type genericClassDefinition, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] out Type implementingType)
	{
		ValidationUtils.ArgumentNotNull(type, "type");
	...
	private static bool InheritsGenericDefinitionInternal(Type type, Type genericClassDefinition, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] out Type implementingType)
	{
		Type type2 = type;
		do
		{
	...
	[_003C464f7c58_002D4ec4_002D4694_002Da30c_002D0ded4d74fb4d_003ENullableContext(2)]
	public static void GetDictionaryKeyValueTypes([_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(1)] Type dictionaryType, out Type keyType, out Type valueType)
	{
	...
	public static void SetMemberValue(MemberInfo member, object target, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] object value)
	{
		ValidationUtils.ArgumentNotNull(member, "member");
		ValidationUtils.ArgumentNotNull(target, "target");
		switch (member.MemberType())
	...
	public static List<MemberInfo> GetFieldsAndProperties(Type type, BindingFlags bindingAttr)
	{
			...
			group m by m.Name)
		{
			...
			foreach (MemberInfo memberInfo in item)
			{
				...
				else if ((!IsOverridenGenericMember(memberInfo, bindingAttr) || memberInfo.Name == "Item") && !list3.Any([_003C464f7c58_002D4ec4_002D4694_002Da30c_002D0ded4d74fb4d_003ENullableContext(0)] (MemberInfo m) => m.DeclaringType == memberInfo.DeclaringType))
				{
					list3.Add(memberInfo);
				}
			}
	...
	[return: _003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)]
	public static T GetAttribute<[_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(0)] T>(object attributeProvider) where T : Attribute
	{
		return GetAttribute<T>(attributeProvider, inherit: true);
	}

	[return: _003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)]
	public static T GetAttribute<[_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(0)] T>(object attributeProvider, bool inherit) where T : Attribute
	{
	...
	public static T[] GetAttributes<[_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(0)] T>(object attributeProvider, bool inherit) where T : Attribute
	{
	...
	public static Attribute[] GetAttributes(object attributeProvider, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] Type attributeType, bool inherit)
	{
	...
	[return: _003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(new byte[] { 0, 2, 1 })]
		...
		while ((type2 = type2.BaseType()) != null)
		{
			...
			foreach (PropertyInfo propertyInfo in properties)
			{
				...
				if (!subTypeProperty.IsVirtual())
				{
					...
					{
						int num = initialProperties.IndexOf([_003C464f7c58_002D4ec4_002D4694_002Da30c_002D0ded4d74fb4d_003ENullableContext(0)] (PropertyInfo p) => p.Name == subTypeProperty.Name);
						if (num == -1)
						{
					...
					else if (initialProperties.IndexOf([_003C464f7c58_002D4ec4_002D4694_002Da30c_002D0ded4d74fb4d_003ENullableContext(0)] (PropertyInfo p) => p.Name == subTypeProperty.Name && p.DeclaringType == subTypeProperty.DeclaringType) == -1)
					{
						initialProperties.Add(subTypeProperty);
					}
				}
				else
				{
					...
					if (initialProperties.IndexOf([_003C464f7c58_002D4ec4_002D4694_002Da30c_002D0ded4d74fb4d_003ENullableContext(0)] (PropertyInfo p) => p.Name == subTypeProperty.Name && p.IsVirtual() && (p.GetBaseDefinition()?.DeclaringType ?? p.DeclaringType).IsAssignableFrom(subTypePropertyDeclaringType)) == -1)
					{
						initialProperties.Add(subTypeProperty);
					}
				}
	...
	{
		return currentType.GetMethods(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic).Any([_003C464f7c58_002D4ec4_002D4694_002Da30c_002D0ded4d74fb4d_003ENullableContext(0)] (MethodInfo info) => info.Name == method && info.DeclaringType != methodDeclaringType && info.GetBaseDefinition().DeclaringType == methodDeclaringType);
	}
