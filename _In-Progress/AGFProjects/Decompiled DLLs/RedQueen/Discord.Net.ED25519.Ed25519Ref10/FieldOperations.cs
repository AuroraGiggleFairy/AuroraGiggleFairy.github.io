...
internal static class FieldOperations
{
	...
	internal static void fe_frombytes(out FieldElement h, byte[] data, int offset)
	{
		...
		long num10 = (load_3(data, offset + 29) & 0x7FFFFF) << 2;
	...
	{
		fe_reduce(out var hr, ref f);
		return ((0 | hr.x0 | hr.x1 | hr.x2 | hr.x3 | hr.x4 | hr.x5 | hr.x6 | hr.x7 | hr.x8 | hr.x9) - 1 >>> 31) ^ 1;
	}
	...
	internal static void fe_mul(out FieldElement h, ref FieldElement f, ref FieldElement g)
	{
		...
		long num125 = num115 + 33554432 >> 26;
		num116 += num125;
		num115 -= num125 << 26;
		long num126 = num119 + 33554432 >> 26;
		num120 += num126;
		num119 -= num126 << 26;
		long num127 = num116 + 16777216 >> 25;
		num117 += num127;
		num116 -= num127 << 25;
		long num128 = num120 + 16777216 >> 25;
		num121 += num128;
		num120 -= num128 << 25;
		long num129 = num117 + 33554432 >> 26;
		num118 += num129;
		num117 -= num129 << 26;
		long num130 = num121 + 33554432 >> 26;
		num122 += num130;
		num121 -= num130 << 26;
		long num131 = num118 + 16777216 >> 25;
		num119 += num131;
		num118 -= num131 << 25;
		long num132 = num122 + 16777216 >> 25;
		num123 += num132;
		num122 -= num132 << 25;
		num126 = num119 + 33554432 >> 26;
		num120 += num126;
		num119 -= num126 << 26;
		long num133 = num123 + 33554432 >> 26;
		num124 += num133;
		num123 -= num133 << 26;
		long num134 = num124 + 16777216 >> 25;
		num115 += num134 * 19;
		num124 -= num134 << 25;
		num125 = num115 + 33554432 >> 26;
		num116 += num125;
		num115 -= num125 << 26;
		h.x0 = (int)num115;
		h.x1 = (int)num116;
	...
	public static void fe_mul121666(out FieldElement h, ref FieldElement f)
	{
		...
		int x9 = f.x8;
		int x10 = f.x9;
		long num = (long)x * 121666L;
		long num2 = (long)x2 * 121666L;
		long num3 = (long)x3 * 121666L;
		long num4 = (long)x4 * 121666L;
		long num5 = (long)x5 * 121666L;
		long num6 = (long)x6 * 121666L;
		long num7 = (long)x7 * 121666L;
		long num8 = (long)x8 * 121666L;
		long num9 = (long)x9 * 121666L;
		long num10 = (long)x10 * 121666L;
		long num11 = num10 + 16777216 >> 25;
		num += num11 * 19;
		num10 -= num11 << 25;
		long num12 = num2 + 16777216 >> 25;
	...
	internal static void fe_sq(out FieldElement h, ref FieldElement f)
	{
		...
		long num79 = num69 + 33554432 >> 26;
		num70 += num79;
		num69 -= num79 << 26;
		long num80 = num73 + 33554432 >> 26;
		num74 += num80;
		num73 -= num80 << 26;
		long num81 = num70 + 16777216 >> 25;
		num71 += num81;
		num70 -= num81 << 25;
		long num82 = num74 + 16777216 >> 25;
		num75 += num82;
		num74 -= num82 << 25;
		long num83 = num71 + 33554432 >> 26;
		num72 += num83;
		num71 -= num83 << 26;
		long num84 = num75 + 33554432 >> 26;
		num76 += num84;
		num75 -= num84 << 26;
		long num85 = num72 + 16777216 >> 25;
		num73 += num85;
		num72 -= num85 << 25;
		long num86 = num76 + 16777216 >> 25;
		num77 += num86;
		num76 -= num86 << 25;
		num80 = num73 + 33554432 >> 26;
		num74 += num80;
		num73 -= num80 << 26;
		long num87 = num77 + 33554432 >> 26;
		num78 += num87;
		num77 -= num87 << 26;
		long num88 = num78 + 16777216 >> 25;
		num69 += num88 * 19;
		num78 -= num88 << 25;
		num79 = num69 + 33554432 >> 26;
		num70 += num79;
		num69 -= num79 << 26;
		h.x0 = (int)num69;
		h.x1 = (int)num70;
