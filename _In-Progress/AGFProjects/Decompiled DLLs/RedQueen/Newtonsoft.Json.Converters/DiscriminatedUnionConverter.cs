...
internal class DiscriminatedUnionConverter : JsonConverter
{
	...
	public override void WriteJson(JsonWriter writer, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] object value, JsonSerializer serializer)
	{
		...
		UnionCase unionCase = union.Cases.Single([_003C464f7c58_002D4ec4_002D4694_002Da30c_002D0ded4d74fb4d_003ENullableContext(0)] (UnionCase c) => c.Tag == tag);
	...
	public override object ReadJson(JsonReader reader, Type objectType, [_003C9200ff2c_002Dc7a6_002D43ef_002Da776_002D3d61f59ba112_003ENullable(2)] object existingValue, JsonSerializer serializer)
	{
		...
		while (reader.TokenType == JsonToken.PropertyName)
		{
			...
			if (string.Equals(text, "Case", StringComparison.OrdinalIgnoreCase))
			{
				...
				unionCase = union.Cases.SingleOrDefault([_003C464f7c58_002D4ec4_002D4694_002Da30c_002D0ded4d74fb4d_003ENullableContext(0)] (UnionCase c) => c.Name == caseName);
				if (unionCase == null)
				{
