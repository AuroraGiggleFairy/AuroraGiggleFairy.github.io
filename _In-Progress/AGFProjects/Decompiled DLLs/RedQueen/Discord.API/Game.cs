...
internal class Game
{
	...
	[JsonProperty("assets")]
	public Optional<GameAssets> Assets { get; set; }

	[JsonProperty("party")]
	public Optional<GameParty> Party { get; set; }

	[JsonProperty("secrets")]
	public Optional<GameSecrets> Secrets { get; set; }

	[JsonProperty("timestamps")]
	public Optional<GameTimestamps> Timestamps { get; set; }
