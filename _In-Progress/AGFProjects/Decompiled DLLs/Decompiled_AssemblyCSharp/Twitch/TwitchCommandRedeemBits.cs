...
public class TwitchCommandRedeemBits : BaseTwitchCommand
{
	...
	public override string[] CommandText => new string[1] { "#redeem_bits" };

	public override string[] LocalizedCommandNames => new string[1] { Localization.Get("TwitchCommand_RedeemBits") };
	...
	public override void Execute(ViewerEntry entry, TwitchIRCClient.TwitchChatMessage message)
	{
		...
		if (array.Length == 2)
		{
			...
			{
				TwitchManager.Current.HandleBitRedeem(message.UserName, _result);
			}
		}
		else if (array.Length == 3)
		{
			...
			{
				TwitchManager.Current.HandleBitRedeem(text, _result2);
			}
		}
	}
	...
	public override void ExecuteConsole(List<string> arguments)
	{
		if (arguments.Count == 2)
		{
			...
			{
				TwitchManager.Current.HandleBitRedeem(TwitchManager.Current.Authentication.userName, _result);
			}
		}
