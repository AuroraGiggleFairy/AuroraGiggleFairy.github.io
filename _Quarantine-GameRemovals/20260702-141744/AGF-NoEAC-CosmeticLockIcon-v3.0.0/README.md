...
7d2d Version 3
**Version:** 3.0.0  
[Download](https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/04_DownloadZips/AGF-NoEAC-CosmeticLockIcon.zip)
...
- "AGF-NoEAC-CosmeticLockIcon" is TBD to remove from an existing game.
...
- Skips cosmetic icon and tint overrides for magnitude/star-indicator armor items.
...
<!-- CHANGELOG START -->
v3.0.0
- Added a magnitude/star guard so cosmetic icon/tint overrides are not applied to those armor entries.
