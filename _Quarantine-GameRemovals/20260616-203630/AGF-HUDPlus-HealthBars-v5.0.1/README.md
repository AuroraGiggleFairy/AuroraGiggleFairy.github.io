...
- AGF-style enemy health bars for improved readability.
- You enable seeing enemy health bars with the sandbox options.
...
- Works standalone.
- Provides an AGF-style visual for enemy health bars to improve combat readability.
...
<!-- CHANGELOG START -->
v5.0.2
- No longer overwrites the sandbox option.
