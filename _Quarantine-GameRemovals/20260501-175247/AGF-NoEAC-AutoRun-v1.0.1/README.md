...
Detailed:
- Double tap your Forward key: Auto-Run ON.
- Hold Sprint while double tapping Forward key: Auto-Run starts with Sprint ON.
- While Auto-Run is ON:
 - Double tap Sprint: Sprint ON.
 - Tap Sprint once: Sprint OFF.
- Press Forward key once: Auto-Run OFF and manual control resumes.
<!-- FEATURES END -->
