# AGF-HUDPlus-RemoveEnteringPopUp
7d2d Version 3
**Version:** 2.0.0  
[Download](https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/04_DownloadZips/AGF-HUDPlus-RemoveEnteringPopUp.zip)
...
>   - **Server** Ã¢â‚¬â€ where the game is hosted. This could be your own PC if you are hosting the game yourself, or a game hosting service like Pingperfect.
>   - **Client** Ã¢â‚¬â€ your own PC.
...
> - Mod Types 2Ã¢â‚¬â€œ6 require EAC to be turned off. These mods use custom code to deliver more advanced features.
...
> Ã¢Å¡Â Ã¯Â¸Â **IMPORTANT** Ã¢Å¡Â Ã¯Â¸Â Make a BACKUP!
...
> Ã¢Å¡Â Ã¯Â¸Â **IMPORTANT** Ã¢Å¡Â Ã¯Â¸Â Make a BACKUP First!
...
>    - *You can check your world name in the gameÃ¢â‚¬â„¢s "Continue Game" or "Join Server" menu.*
...
>    - *You can check your world name in the gameÃ¢â‚¬â„¢s "Join Server" menu or "Server Config".*
...
> - *Keep your backup until youÃ¢â‚¬â„¢re sure everything works!*
