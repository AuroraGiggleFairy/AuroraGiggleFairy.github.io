...
------------------------------------------------------------------------
  ...
  - Toolbelt is expanded from 10 slots to 12.
  - Slots 11 and 12 use - and = by default.
  - You can rebind both in Options for keyboard and controller.
...
v2.2.3
	- Removed unnecessary log files that was clogging logs.
	- Updated to inform this is server AND client required.
