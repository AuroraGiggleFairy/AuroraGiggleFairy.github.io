...
------------------------------------------------------------------------
  ...
  - WMM12SlotToolbelt 15SlotToolbelt
...
v5.1.0
    ...
    - Moved "pure" localization support to its own mod.

------------------------------------------------------------------------

v5.0.0
    - Updated SO FAR for 7d2d version 3.
...
v4.1.0
    - Added compatibility for vehicle stats stuff.
...
v4.0.0
    - Renamed to be AGF V2 Compatibilities, as it encompasses more than
      my
    - HUD.
