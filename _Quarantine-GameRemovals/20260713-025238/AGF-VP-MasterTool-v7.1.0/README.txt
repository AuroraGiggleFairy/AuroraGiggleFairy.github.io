...
------------------------------------------------------------------------
  ...
  - Adds the endgame Master Tool, an all-in-one harvesting item.
  - Has 6 mod slots, uses no fuel, and is affected by harvesting perks.
  - Deals minimal entity damage.
  - Unlocks after Tier 6 trader progression via a buried-supplies quest.
  - Crafting ingredients unlock at max Harvesting Tools, Electrician,
    Salvaging, and Blades magazines.
...
------------------------------------------------------------------------
  ...
  - How to unlock and find the Master Tool quest:
            ...
            - Talk to a trader and open the special mod-job dialogue
            option.
            - Select the Master Tool buried-supplies quest from that
              list.
...
v7.1.0
    ...
    - Reinserted purple book compatibility.

------------------------------------------------------------------------

v7.0.0
    - Updated for 7d2d version 3.
    - Reconfigured how harvesting tools are applied to the master tool.
    - Changed burst count to 0.
...
v6.1.1
    - Allowed side attachments for the nailgun per request.
