...
7d2d Version 2  
**Version:** 1.1.1  
[Download](https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/04_DownloadZips/AGF-NoEAC-ExpandedInteractionPrompts.zip)
...
v1.1.0
- Added compatibility for the lockable workstations, if you can't access the station, you do not see the extra stats.
...
- New localizations.
- Simply appends to existing localization, doesn't rewrite over original.
