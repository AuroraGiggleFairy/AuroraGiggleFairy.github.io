...
------------------------------------------------------------------------
  ...
  - Adds four burn-time fuel items: 10 minutes, 60 minutes, 600 minutes,
    and 6,000 minutes.
  - Simplifies fuel management with pre-sized burn-time items.
  - Craft each burn-time bundle from wood or coal.
  - Costs follow vanilla-equivalent fuel values.
...
v2.0.0
    ...
    - Updated Localization renamed from FuelPlus to FuelBurnPlus
