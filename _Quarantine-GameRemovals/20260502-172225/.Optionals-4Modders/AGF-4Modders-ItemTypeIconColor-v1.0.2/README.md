# AGF-4Modders-ItemTypeIconColor
7d2d Version 2  
**Version:** 1.0.2  
[Download](https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/04_DownloadZips/AGF-4Modders-ItemTypeIconColor.zip)
...
- "AGF-4Modders-ItemTypeIconColor" is SAFE to install on an existing game.
- "AGF-4Modders-ItemTypeIconColor" is TBD to remove from an existing game.
- Unique Details: May Change after update.
