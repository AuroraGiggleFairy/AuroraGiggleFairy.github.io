...
- agf-sa default <off|on|count>: Set the default mode for new joining players.
- agf-sa set <entityId|all> <off|on|count|default>: Set mode for one online player or all online players.
