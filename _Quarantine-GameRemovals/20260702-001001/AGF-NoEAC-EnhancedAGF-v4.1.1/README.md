# AGF-NoEAC-EnhancedAGF
7d2d Version 3
**Version:** 4.1.1  
[Download](https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/04_DownloadZips/AGF-NoEAC-EnhancedAGF.zip)
...
- "AGF-NoEAC-EnhancedAGF" is SAFE to install on an existing game.
- "AGF-NoEAC-EnhancedAGF" is SAFE to remove from an existing game.
...
- Provides client-side UI support for ScreamerAlert and PurpleBook.
...
- Has the UI processing aspects for client side Screamer Alert functions.
- For the purple book, creates the working paging header when purple book is open.
- Has special features for Dishong Tower Challenge when combined with compatibility patch.
...
<!-- CHANGELOG START -->
v4.2.0
- Now allows the use of ItemTypeIconColor in xml.
- Added further support for compatibilities patch.

v4.1.1
- Added enhanced paging header for purple book.

v4.1.0
- Added enhanced Screamer Alert features.
...
v3.2.0
- Name change, plus new features for the HUD like vehicle stats.

v3.1.1
- Minor update for use in Doom Survival mod.
