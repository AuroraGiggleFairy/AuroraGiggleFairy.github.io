...
7d2d Version 2  
Version: 1.0.1-BETA  
Download: https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/04DownloadZips/AGF-NoEAC-FlightAssist.zip
...
- "AGF-NoEAC-FlightAssist" is UNKNOWN to remove from an existing game.
- Unique Details: None
...
- Includes two flight assist patterns:
  - Gyrocopter: Press X to enable forward flight while maintaining current elevation.
  - Helicopter: Press X once to enable hover mode, then press X again to enable forward flight while maintaining current elevation.
- The current Flight Assist mode is shown on the HUD.
