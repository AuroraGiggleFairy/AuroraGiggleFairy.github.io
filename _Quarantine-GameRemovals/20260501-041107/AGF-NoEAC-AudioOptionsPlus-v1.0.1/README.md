...
7d2d Version 2  
**Version:** 1.0.1-BETA  
[Download](https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/04_DownloadZips/AGF-NoEAC-AudioOptionsPlus.zip)
...
- EAC Friendly: No
- Server Side (Player Host): No
- Server Side (Dedicated Host): No
- Client Side: Yes
- "AGF-NoEAC-AudioOptionsPlus" is SAFE to install on an existing game.
- "AGF-NoEAC-AudioOptionsPlus" is UNKNOWN to remove from an existing game.
- Unique Details: This has no affect if installed on a server as it is purely client side.
...
## 5. Features
<!-- FEATURES START -->
- Adds two new in-game audio tabs: Volume Controls and Sound Swaps.
- Volume Controls lets players fine-tune a wide range of sound categories, including:
  - equipment, looping sounds, traders, and more.
- Sound Swaps lets players replace animal injury sounds with non-injury sounds.
  - Includes an option to enable Silly Sounds from Twitch Integration.
<!-- FEATURES END -->
