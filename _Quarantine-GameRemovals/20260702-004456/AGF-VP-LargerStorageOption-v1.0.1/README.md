# AGF-VP-LargerStorageOption
7d2d Version 3
**Version:** 1.0.1  
[Download](https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/04_DownloadZips/AGF-VP-LargerStorageOption.zip)
...
- "AGF-VP-LargerStorageOption" is SAFE to install on an existing game.
- "AGF-VP-LargerStorageOption" is DANGEROUS to remove from an existing game.
- Unique Details: None
...
- Works standalone.
- Adds extra-large craftable storage.
- Multiple shapes, 3x block health, break to pick up.
- Even larger when paired with AGF backpack sizes 72+.
...
- Works standalone.
- Adds craftable extra-large storage.
- Includes multiple storage shapes:
	- Writable Crate
	- Cube
	- Bevel
	- Half
	...
	- Bookcase
	- Mortician Drawer
- Each storage block has 3x block health.
- Break storage to pick it back up.
- Storage sizes for vanilla use:
	- Wood = 60 slots
	- Iron = 80 slots
	- Steel = 100 slots
- Storage capacity becomes even larger when paired with AGF backpack sizes 72+:
	- Wood = 120 slots
	- Iron = 144 slots
	- Steel = 168 slots
...
<!-- CHANGELOG START -->
v1.0.1
- Sorting buttons now show on all loot, as expected from vanilla.

v1.0.0
- Updated old code to work for 7d2d version 3.
- Fixed old issues of description not showing for variant blocks.
- Updated localization description in all languages.

v0.0.1
- Mod first created.
- Pulled files from v2.6 backpack mods.
<!-- CHANGELOG END -->
