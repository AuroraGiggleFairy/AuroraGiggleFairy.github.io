...
7d2d Version 2  
**Version:** 3.0.1  
[Download](https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/04_DownloadZips/AGF-VP-TraderSellsMoreBooks.zip)
...
- Client Side: None
- "AGF-VP-TraderSellsMoreBooks" is SAFE to install on an existing game.
- "AGF-VP-TraderSellsMoreBooks" is SAFE to remove from an existing game.
- Unique Details: None
