...
7d2d Version 2  
**Version:** 2.0.2  
[Download](https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/04_DownloadZips/AGF-VP-ZombieLargerHordes.zip)
...
- Client Side: None
- "AGF-VP-ZombieLargerHordes" is SAFE to install on an existing game.
- "AGF-VP-ZombieLargerHordes" is SAFE to remove from an existing game.
- Unique Details: None
