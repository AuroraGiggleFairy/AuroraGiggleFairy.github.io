...
------------------------------------------------------------------------
  ...
  - Two-wheel vehicles now seat 3 players. Expanded Seating does not
    increase seat count (cosmetic only).
  - The 4x4 now seats 5 players, or up to 8 with Expanded Seating
    installed.
...
v1.0.0
    - Revamped from Version 1 VehiclesPerformance Mod, now for 7d2d
    version 2.
