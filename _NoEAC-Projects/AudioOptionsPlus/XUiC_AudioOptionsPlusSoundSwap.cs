...
public class XUiC_AudioOptionsPlusSoundSwap : XUiController
{
    ...
    private void RefreshFromConfig()
    {
        ...
        try
        {
            ...
            Set(_sillySoundsEnabled, AudioOptionsPlusConfig.SillySoundsEnabled ? ToggleOn : ToggleOff);
            ...
            CanonicalizeToggle(_sillySoundsEnabled);
    ...
    private void ResolveControls()
    {
        ...
        _sillySoundsEnabled = ResolveStringListCombo("AOPSoundSwapSillySoundsEnabled");
