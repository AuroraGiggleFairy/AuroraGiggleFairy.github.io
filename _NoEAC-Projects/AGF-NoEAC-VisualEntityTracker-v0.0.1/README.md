...
- "AGF-NoEAC-VisualEntityTracker" is MISSINGDATA to install on an existing game.
- "AGF-NoEAC-VisualEntityTracker" is MISSINGDATA to remove from an existing game.
