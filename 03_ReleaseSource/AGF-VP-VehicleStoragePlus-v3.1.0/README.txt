...
------------------------------------------------------------------------
  ...
  - Increased vehicle storage (except the 4x4, which is hard capped).
  - Bicycle: 10 -> 30
  - Minibike: 30 -> 50
  - Motorcycle: 40 -> 70
  - Gyrocopter: 50 -> 70 4x4 Truck: 90 -> 90
...
v2.1.1
    - Works with 2.5 (continues to work with older 2.0 versions as
      well.)

------------------------------------------------------------------------

v2.1.0
    - Modified how storage progression per vehicle is +2 rows of
      storage.
