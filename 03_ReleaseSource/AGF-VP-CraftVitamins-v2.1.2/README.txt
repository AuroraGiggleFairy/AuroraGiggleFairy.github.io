...
------------------------------------------------------------------------
  ...
  - Vitamins unlock at Medical level 30, matching herbal antibiotics.
  - Craft at a campfire with a cooking pot, or use a chemistry station
    for reduced crop ingredient costs.
...
v2.1.0
    ...
    - Re-implemented purple book insertion.
