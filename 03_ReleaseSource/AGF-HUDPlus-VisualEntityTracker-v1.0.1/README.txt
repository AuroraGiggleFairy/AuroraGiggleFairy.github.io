========================================================================
                    AGF-HUDPLUS-VISUALENTITYTRACKER                     
========================================================================
...
------------------------------------------------------------------------
  ...
  - Provides visual compass cues for nearby entities within 25m.
  - Makes entities more noticeable without relying on audio cues.
  - Uses red markers for hostiles and green for timid entities.
  - Does not interfere with the Animal Tracker perk.
...
v1.0.1
    - Removed erroneous code causing yellow errors in console/log.

------------------------------------------------------------------------

v1.0.0
    - Finalized update for 7d2d version 3.
    - Server side mod once again.
    - Fixed how the tracking would interfere with animal tracking.

------------------------------------------------------------------------

v0.2.0
    - Updated for 7d2d version 3.0.
    - Returned draft folder to XML-only/server-side baseline.
    - Removed DLL-only tracker/UI artifacts from the mod folder.
