# AGF-NoEAC-SignErrorGuard
7d2d Version 3
**Version:** 1.0.0  
[Download](https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/04_DownloadZips/AGF-NoEAC-SignErrorGuard.zip)
...
- "AGF-NoEAC-SignErrorGuard" is SAFE to install on an existing game.
- "AGF-NoEAC-SignErrorGuard" is TBD to remove from an existing game.
- Unique Details: TBD
...
- Blocks the sign error from interrupting players.
- This is a temp gameplay fix.
...
<!-- CHANGELOG START -->
v1.0.0
- Tested and publish ready.

v0.0.2
- Updated mod info
- Created first attempt .dll.
