...
------------------------------------------------------------------------
  ...
  - Block Replace Tool is faster and allows holding the trigger.
  - Dev-only XP books that give 100k or 1M XP (scales with XP settings).
  - Dev-only harvest test blocks to check that harvesting behaves as
    expected (baseline drops of 10 with no perks).
