...
------------------------------------------------------------------------
  ...
  - Adds a new spawn-point block called Bedroll+.
  - Bedroll+ includes every vanilla bed model as a shape option.
  - It has 500 HP and can be picked up again.
  - Recipe cost: 20 cloth, 10 wood, 10 scrap iron.
