...
------------------------------------------------------------------------
  ...
  - Break it, get it: break supported stations, storage, signs, and
    electrical blocks to get it back into your inventory.
  - No need to empty the forge first: break it and pick up its smelted
    contents from the dropped backpack.
...
v1.0.2
    - Destroying a table saw will no longer give you a cement mixer.
      LOL!

------------------------------------------------------------------------

v1.0.1
    - removed tablesaw added power banks (generator, battery, solar)
