...
------------------------------------------------------------------------
  ...
  - Adds two audio menu tabs: Custom Volumes and Sound Swap.
  - Custom Volumes provides volume sliders for sound categories like
    vehicles, weather, motor tools, and trader voices.
  - Sound Swap lets you replace animal pain and death sounds with other
    sounds from those animals.
...
v2.0.0
    ...
    - Added weather, thunder, and storm alert volume sliders
