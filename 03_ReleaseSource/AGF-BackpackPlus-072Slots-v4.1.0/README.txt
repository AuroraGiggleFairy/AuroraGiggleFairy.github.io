...
------------------------------------------------------------------------
  ...
  - Backpack size is now 72 slots instead of 45, with 16% smaller UI
    cells.
  - Carry capacity starts at 36 with 36 encumbrance slots.
...
------------------------------------------------------------------------
  ...
  - All windows above the backpack are sized to match the backpack
    width.
  - Pack Mule encumbrance relief per rank: 7, 14, 21, 28, 36 (full
    encumbrance unlock at max rank).
  - Encumbrance movement penalty multiplier is set to 0.01297 (default
