...
------------------------------------------------------------------------
  ...
  - Prevents red sign errors near new signs from interrupting gameplay.
  - Temporary workaround while the new 3.0 sign system is stabilized.
  - Client-side only; install on each player PC.
