...
1. One-line summary & key labels (Version · Tested · EAC/Type · Safe)
2. Quick compatibility (tested game version, EAC/mod-type, SAFE flags)
3. Quick Install (1–2 steps + critical warnings)
4. Features — Summary (<!-- FEATURES-SUMMARY -->)
5. Changelog — latest (<!-- CHANGELOG -->)
6. Features — Detailed (<!-- FEATURES-DETAILED -->)
7. Removal / Safe removal notes
8. Full Guides — Installation / Update / Backup / Removal
9. Technical & compatibility table (MOD_TYPE_ID, dependencies, localization files)
10. Localization notes
11. Per-platform snippets (Nexus / GitHub / Steam)
12. Support & Credits (About Author, Mod Philosophy, contact links)
13. Automation & Markers — preserve placeholders and template markers
