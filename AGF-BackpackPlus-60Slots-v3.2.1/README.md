...
- "AGF BackpackPlus 60 Slots" is SAFE to install on an existing game.
- "AGF BackpackPlus 60 Slots" is DANGEROUS to remove from an existing game.
- Unique Details: You may upgrade to the others but not swap down to this one.
