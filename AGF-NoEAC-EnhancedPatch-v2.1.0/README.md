...
- "AGF-HUDPlus-EnhancedPatch-ClientSideNoEAC" is SAFE to install on an existing game.
- "AGF-HUDPlus-EnhancedPatch-ClientSideNoEAC" is SAFE to remove from an existing game.
- Unique Details: None
