VanillaPlus - PlayerResetQuests
7d2d Version 2 - v2.0.1
...
3.  INSTALLATION and REMOVAL NOTES
	*First, if you run into any conflicts, you may contact AuroraGiggleFairy via discord: https://discord.gg/Vm5eyW6N4r
	...
	-PlayerResetQuests is SAFE to install on new game or existing game.
	-PlayerResetQuests is SAFE to remove from an existing game.
