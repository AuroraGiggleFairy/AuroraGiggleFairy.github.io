...
public class XUiC_AudioOptions : XUiController
{
    ...
    private XUiC_ComboBoxFloat _weatherStorm;
    private XUiC_ComboBoxFloat _thunder;
    private XUiC_ComboBoxFloat _weatherAlert;
    ...
    private void RefreshFromConfig()
    {
        ...
        try
        {
            ...
            Set(_weatherStorm, AudioOptionsPlusConfig.WeatherStormMultiplier);
            Set(_thunder, AudioOptionsPlusConfig.ThunderMultiplier);
            Set(_weatherAlert, AudioOptionsPlusConfig.WeatherAlertMultiplier);
    ...
    private XUiC_ComboBoxFloat[] GetCategoryCombos()
    {
        ...
        return _categoryCombos;
    }

    private XUiC_ComboBoxList<string>[] GetAnimalSwapCombos()
    {
        if (_animalSwapCombos == null)
        {
            _animalSwapCombos = new[]
            {
                _bearSwap,
                _boarSwap,
                _caninesSwap,
    ...
    private bool HasPendingChangeForOption(string optionName)
    {
        ...
        switch (optionName)
        {
            ...
            case "AOPVolumeProfilesWeather":
                return !Nearly(GetValue(_weatherStorm), NormalizeConfigUiValue(AudioOptionsPlusConfig.WeatherStormMultiplier));
            case "AOPVolumeProfilesThunder":
                return !Nearly(GetValue(_thunder), NormalizeConfigUiValue(AudioOptionsPlusConfig.ThunderMultiplier));
            case "AOPVolumeProfilesWeatherAlert":
                return !Nearly(GetValue(_weatherAlert), NormalizeConfigUiValue(AudioOptionsPlusConfig.WeatherAlertMultiplier));
    ...
    private static string ResolvePresetFromConfigValues()
    {
        ...
        float weather = NormalizeConfigUiValue(AudioOptionsPlusConfig.WeatherStormMultiplier);
        float thunder = NormalizeConfigUiValue(AudioOptionsPlusConfig.ThunderMultiplier);
        float weatherAlert = NormalizeConfigUiValue(AudioOptionsPlusConfig.WeatherAlertMultiplier);
    ...
    private void ApplyAllUiValuesToConfig()
    {
        ...
        AudioOptionsPlusConfig.SetUiVolumeOverrides(
            ...
            GetValue(_twitch),
            GetValue(_weatherStorm),
            GetValue(_thunder),
            GetValue(_weatherAlert),
    ...
    private bool HasPendingChangesAgainstConfig()
    {
        ...
        bool volumeChanged =
            ...
            !Nearly(GetValue(_weatherStorm), NormalizeConfigUiValue(AudioOptionsPlusConfig.WeatherStormMultiplier)) ||
            !Nearly(GetValue(_thunder), NormalizeConfigUiValue(AudioOptionsPlusConfig.ThunderMultiplier)) ||
            !Nearly(GetValue(_weatherAlert), NormalizeConfigUiValue(AudioOptionsPlusConfig.WeatherAlertMultiplier)) ||
    ...
    private void ResolveControls()
    {
        ...
        _weatherStorm = ResolveFloatCombo("AOPVolumeProfilesWeather");
        _thunder = ResolveFloatCombo("AOPVolumeProfilesThunder");
        _weatherAlert = ResolveFloatCombo("AOPVolumeProfilesWeatherAlert");
        ...
        LogMissingControl("AOPVolumeProfilesWeather", _weatherStorm);
        LogMissingControl("AOPVolumeProfilesThunder", _thunder);
        LogMissingControl("AOPVolumeProfilesWeatherAlert", _weatherAlert);
