...
Scope:
- Source folder: 00_DLL-Projects/Projects/DLL_NoEAC-ScreamerAlert
...
- Built `ScreamerAlert.dll` from `00_DLL-Projects/Projects/DLL_NoEAC-ScreamerAlert` and deployed only these files to live game mod `AGF-NoEAC-ScreamerAlert-v2.2.0`:
   - `ScreamerAlert.dll`
...
1. Edit source
   - Update C# files in 00_DLL-Projects/Projects/DLL_NoEAC-ScreamerAlert.
