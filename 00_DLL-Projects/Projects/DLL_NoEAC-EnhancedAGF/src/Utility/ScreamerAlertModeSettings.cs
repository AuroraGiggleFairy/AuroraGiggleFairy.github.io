...
public static class ScreamerAlertModeSettings
{
    ...
    private static void EnsureLoaded()
    {
        ...
        {
            Logging.Warning("ScreamerAlertModeSettings", "Failed to load mode settings: " + ex.Message);
        }
    }
    ...
    private static void Save_NoLock()
    {
        ...
        {
            Logging.Warning("ScreamerAlertModeSettings", "Failed to save mode settings: " + ex.Message);
        }
    }
    ...
    private static bool TryParseMode(string value, out ScreamerAlertMode mode)
    {
        ...
        if (trimmed.Equals("numbers", StringComparison.OrdinalIgnoreCase)
            ...
            || trimmed.Equals("counts", StringComparison.OrdinalIgnoreCase)
