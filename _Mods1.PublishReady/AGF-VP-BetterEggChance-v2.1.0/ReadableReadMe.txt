...
7d2d Version 2  
Version: 2.1.0  
Download: https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/Mods3.zip/AGF-VP-BetterEggChance.zip
...
- "AGF-VP-BetterEggChance" is {{SAFETOINSTALL}} to install on an existing game.
- "AGF-VP-BetterEggChance" is {{SAFETOREMOVE}} to remove from an existing game.
