...
7d2d Version 2  
Version: 3.0.0  
Download: https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/Mods3.zip/AGF-VP-TraderSellsMoreBooks.zip
...
- "AGF-VP-TraderSellsMoreBooks" is {{SAFETOINSTALL}} to install on an existing game.
- "AGF-VP-TraderSellsMoreBooks" is {{SAFETOREMOVE}} to remove from an existing game.
