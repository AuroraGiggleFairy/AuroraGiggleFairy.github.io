...
7d2d Version 2  
Version: 2.1.0  
Download: https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/Mods3.zip/AGF-VP-TacticalRiflePlus.zip
...
- "AGF-VP-TacticalRiflePlus" is {{SAFETOINSTALL}} to install on an existing game.
- "AGF-VP-TacticalRiflePlus" is {{SAFETOREMOVE}} to remove from an existing game.
