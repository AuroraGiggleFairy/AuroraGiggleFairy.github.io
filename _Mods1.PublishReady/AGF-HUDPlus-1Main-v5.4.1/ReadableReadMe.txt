...
7d2d Version 2  
Version: 5.4.1  
Download: https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/Mods3.zip/AGF-HUDPlus-1Main.zip
...
- "AGF-HUDPlus-1Main" is {{SAFETOINSTALL}} to install on an existing game.
- "AGF-HUDPlus-1Main" is {{SAFETOREMOVE}} to remove from an existing game.
