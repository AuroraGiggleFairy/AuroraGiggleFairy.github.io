...
7d2d Version 2  
Version: 5.6.0  
Download: https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/Mods3.zip/AGF-VP-FarmingPlus.zip
...
- "AGF-VP-FarmingPlus" is {{SAFETOINSTALL}} to install on an existing game.
- "AGF-VP-FarmingPlus" is {{SAFETOREMOVE}} to remove from an existing game.
