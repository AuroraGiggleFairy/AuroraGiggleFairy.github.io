...
7d2d Version 2  
Version: 2.0.1  
Download: https://github.com/AuroraGiggleFairy/AuroraGiggleFairy.github.io/raw/main/Mods3.zip/AGF-VP-ZombieLargerHordes.zip
...
- "AGF-VP-ZombieLargerHordes" is {{SAFETOINSTALL}} to install on an existing game.
- "AGF-VP-ZombieLargerHordes" is {{SAFETOREMOVE}} to remove from an existing game.
