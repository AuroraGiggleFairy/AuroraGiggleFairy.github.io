...
public class XUiC_AudioOptions : XUiController
{
    ...
    private bool HasPendingChangeForOption(string optionName)
    {
        ...
        switch (optionName)
        {
            ...
            case "AOPVolumeProfilesWeatherStorm":
    ...
    private static string ResolvePresetFromConfigValues()
    {
        ...
        if (NearlyAll(0f, auger, impact, gun, explosions, vehicles, electrical, crafting, spider, animal, place, ding, interaction, twitch, weather, doors, bob, hugh, jen, joel, rekt, player)) return PresetOff;
        if (NearlyAll(0.25f, auger, impact, gun, explosions, vehicles, electrical, crafting, spider, animal, place, ding, interaction, twitch, weather, doors, bob, hugh, jen, joel, rekt, player)) return PresetLow;
        if (NearlyAll(0.5f, auger, impact, gun, explosions, vehicles, electrical, crafting, spider, animal, place, ding, interaction, twitch, weather, doors, bob, hugh, jen, joel, rekt, player)) return PresetMedium;
        if (NearlyAll(0.75f, auger, impact, gun, explosions, vehicles, electrical, crafting, spider, animal, place, ding, interaction, twitch, weather, doors, bob, hugh, jen, joel, rekt, player)) return PresetHigh;
        if (NearlyAll(1f, auger, impact, gun, explosions, vehicles, electrical, crafting, spider, animal, place, ding, interaction, twitch, weather, doors, bob, hugh, jen, joel, rekt, player)) return PresetDefault;
        return PresetCustom;
    }
    ...
    private void ResolveControls()
    {
        ...
        _weatherStorm = ResolveFloatCombo("AOPVolumeProfilesWeatherStorm");
        ...
        LogMissingControl("AOPVolumeProfilesWeatherStorm", _weatherStorm);
