...
public class XUiC_AudioOptions : XUiController
{
    ...
    private void RefreshFromConfig()
    {
        ...
        try
        {
            ...
            if (_animalSwapPreset != null)
            {
                _bearSwap.Value = ToSwapValue(AudioOptionsPlusConfig.SoundSwapBearMode);
                _boarSwap.Value = ToSwapValue(AudioOptionsPlusConfig.SoundSwapBoarMode);
                _chickenSwap.Value = ToSwapValue(AudioOptionsPlusConfig.SoundSwapChickenMode);
                _rabbitSwap.Value = ToSwapValue(AudioOptionsPlusConfig.SoundSwapRabbitMode);
                _snakeSwap.Value = ToSwapValue(AudioOptionsPlusConfig.SoundSwapSnakeMode);
                _stagSwap.Value = ToSwapValue(AudioOptionsPlusConfig.SoundSwapStagMode);
                _vultureSwap.Value = ToSwapValue(AudioOptionsPlusConfig.SoundSwapVultureMode);
                _caninesSwap.Value = ResolveCaninesSwapValue();
                _mountainLionSwap.Value = ToSwapValue(AudioOptionsPlusConfig.SoundSwapMountainLionMode);
