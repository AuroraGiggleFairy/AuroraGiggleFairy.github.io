...
internal static class AudioOptionsPlusRuntime
{
    ...
    private static bool TryResolveCategoryOverride(string clipName, string sourceName, string groupName, Entity contextEntity, out float absoluteVolume, AudioSource sourceObject = null)
    {
        ...
        // 14) Weather / Storm ambience.
        if (AudioOptionsPlusConfig.WeatherStormMultiplier >= 0f
            && MatchesAny(clip, source, group, "weather", "storm", "thunder", "lightning", "rain", "wind", "gust", "blizzard", "snowstorm", "sandstorm", "duststorm", "ui_weather_alert")
        ...
        // 15) Doors / Hatches / Vaults / Cellars / Bridge.
        ...
        // 16-20) Trader-specific categories.
...
internal static class Patch_XUiC_OptionsAudio_Init_AudioOptionsPlusCustom
{
    ...
    private static void BindCustomOption(XUiC_OptionsAudio instance, string name, Dictionary<string, XUiC_OptionEntryCustom> optionMap)
    {
        ...
        option.IsChangedDelegate = () => XUiC_AudioOptions.HasPendingChangeForOption(instance, name);
