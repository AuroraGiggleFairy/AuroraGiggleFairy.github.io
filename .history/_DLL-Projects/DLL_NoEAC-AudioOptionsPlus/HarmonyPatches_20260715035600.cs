...
internal static class Patch_XUiC_OptionsAudio_Init_AudioOptionsPlusCustom
{
    ...
    private static void Postfix(XUiC_OptionsAudio __instance)
    {
        ...
        {
            BindCustomOption(__instance, AopCustomOptionNames[i]);
        }
    }

    private static void BindCustomOption(XUiC_OptionsAudio instance, string name)
    {
        XUiController controller = instance.GetChildById("Option" + name);
        ...
        {
            return XUiC_AudioOptions.IsAtDefaultsUsingOptionsAudio(instance) && XUiC_AudioOptions.AreAllOpenControllersAtDefaults();
        };
    }
}
