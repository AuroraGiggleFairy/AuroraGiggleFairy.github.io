VanillaPlus - Mod988     ***Suicide Hotline is 988***
7d2d V2 - Version 2.0.1
...
3.  INSTALLATION and REMOVAL NOTES
	*First, if you run into any conflicts, you may contact AuroraGiggleFairy via discord: https://discord.gg/Vm5eyW6N4r
	...
	-Mod988 is SAFE to install on new game or existing game.
	-Mod988 is SAFE to remove from an existing game.
